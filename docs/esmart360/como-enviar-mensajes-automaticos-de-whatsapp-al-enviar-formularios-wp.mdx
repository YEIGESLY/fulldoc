...
<Step title="Webhooks Addon de WP Forms">
...
<Step title="Plantilla de Mensaje Aprobada por Meta">
...
<Update title="Actualización importante" date="2025-06-23">
...
<Tabs>
<Tab title="Tiempo de Aprobación">
...
<Tab title="Causas de Rechazo Comunes">
...
<Tab title="Cómo Verificar el Estado">
...
<Expandable title="¿Qué es exactamente un Webhook Workflow?">
...
<Tabs>
<Tab title="Mapeo de Campos Recomendado">
...
<Tab title="Cuerpo de Solicitud en JSON">
...
<Expandable title="¿Puedo agregar más campos personalizados?">
...
<Steps>
<Step title="Prueba con tu propio número">
...
<Step title="Verifica las variables">
...
<Step title="Prueba con diferentes navegadores">
...
<Step title="Prueba con datos inválidos">
...
<Expandable title="¿Y si el mensaje no llega? (Solución de problemas)">
...
<Columns cols="2">
<Card title="Confirmación de Contacto para Servicios Profesionales">
...
<Card title="Notificación de Registro para Webinars y Eventos">
...
<Card title="Captación de Leads Inmobiliarios">
...
<Card title="Soporte Técnico Post-Venta">
...
<Step title="Incluye siempre una opción para darse de baja">
...
<Step title="Mantén un tono profesional pero cercano">
...
<Step title="Incluye un CTA claro">
...
<Expandable title="¿Necesito la versión Pro de WP Forms obligatoriamente?">
...
<Expandable title="¿Cuánto tarda Meta en aprobar una plantilla de mensaje?">
...
<Expandable title="¿Qué hago si el webhook falla o no recibe los datos?">
...
<Expandable title="¿Puedo usar otros formularios diferentes a WP Forms?">
...
<Expandable title="¿El mensaje automático cuenta como una conversación facturable?">
...
<Expandable title="¿Qué pasa si el usuario responde a mi mensaje automático?">
...
<Expandable title="¿Puedo tener múltiples formularios con diferentes mensajes?">
...
<Expandable title="¿Cómo soluciono el error 131042 de método de pago?">
...
<Expandable title="Configuración de Headers y Autenticación">
...
<Expandable title="¿Qué hacer si mi cuenta tiene calificación de calidad baja?">
...
<Expandable title="¿Puedo enviar archivos multimedia (imágenes, PDFs) en el mensaje automático?">
...
<Expandable title="¿Qué límites de mensajes tengo según mi tier de WhatsApp?">
...
<Expandable title="¿Cómo migro desde otra plataforma (BSP) a E-SMART360?">
...
<Expandable title="¿Puedo usar esto para enviar mensajes a números internacionales?">
...
<Expandable title="¿Cómo configuro el botón CTA en la plantilla para agendar una cita?">
