...
<Steps>
  <Step title="Accede a las integraciones">
  ...
  <Step title="Configura la API de WooCommerce">
  ...
  <Step title="Ingresa las credenciales en E-SMART360">
...
<Steps>
  ...
  <Step title="Selecciona la cuenta de WhatsApp">
  ...
  <Step title="Elige la opción de automatización WooCommerce/Shopify">
...
<Columns cols="2">
  <Card title="Campos obligatorios">
  ...
  <Card title="Campos opcionales y avanzados">
...
<Steps>
  <Step title="Crea un webhook en WooCommerce">
  ...
  <Step title="Configura el webhook en E-SMART360">
  ...
  <Step title="Captura y mapea los datos del webhook">
...
<Steps>
  <Step title="Descarga e instala el plugin de carrito abandonado">
  ...
  <Step title="Configura la URL del webhook en el plugin">
  ...
  <Step title="Crea una plantilla de mensaje atractiva">
  ...
  <Step title="Mapea los datos del webhook">
  ...
  <Step title="Elimina el signo + de los números de teléfono">
...
<Columns cols="2">
  <Card title="Beneficios de la verificación COD">
  ...
  <Card title="Estados que puedes gestionar">
...
<Tabs>
  <Tab title="Información del pedido">
  ...
  <Tab title="Información del cliente">
...
<Steps>
  <Step title="Crea plantillas por idioma">
  ...
  <Step title="Asigna el locale al cliente">
  ...
  <Step title="Configura el envío dinámico">
...
<Expandable title="¿Puedo enviar notificaciones de múltiples tiendas WooCommerce a un solo número de WhatsApp?">
...
<Expandable title="¿Qué hago si no recibo la notificación de prueba después de configurar la campaña?">
...
<Expandable title="¿Puedo personalizar el mensaje de notificación más allá de la plantilla predeterminada?">
...
<Expandable title="¿Cuánto tiempo tarda en aprobarse una plantilla de mensaje para notificaciones de pedidos?">
...
<Expandable title="¿E-SMART360 soporta otros sistemas de e-commerce además de WooCommerce?">
...
<Expandable title="¿Qué costos tiene enviar notificaciones de pedidos por WhatsApp?">
...
<Expandable title="¿Puedo programar el envío de notificaciones para horarios específicos?">
...
<Expandable title="¿Cómo manejo el consentimiento del cliente para recibir notificaciones por WhatsApp?">
...
<Expandable title="¿Puedo enviar imágenes de productos en las notificaciones?">
...
<Expandable title="¿Qué sucede si el número de teléfono del cliente no está registrado en WhatsApp?">
...
<Steps>
  ...
  <Step title="Conecta tu tienda WooCommerce">
  ...
  <Step title="Configura la acción en E-SMART360">
  ...
  <Step title="Prueba y activa el Zap">
...
<Steps>
  ...
  <Step title="Agrega los detalles de la API">
  ...
  <Step title="Usa en el Flow Builder">
...
<Expandable title="Error de conexión con WooCommerce API">
...
<Expandable title="Los mensajes no se entregan a pesar de que la campaña está activa">
...
<Expandable title="El webhook no captura datos de WooCommerce">
...
<Expandable title="Error 130472: El número está en un experimento de Meta">
...
<Update title="Soporte para múltiples estados de WooCommerce" date="15 Abril 2026">
...
<Update title="Nuevo: Seguimiento en tiempo real" date="10 Marzo 2026">
