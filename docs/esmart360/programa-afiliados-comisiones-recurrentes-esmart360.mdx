...
description: "Descubre el programa de afiliados de E-SMART360. Únete como socio, promociona nuestra plataforma de chatbots y marketing conversacional, y gana comisiones recurrentes del 25% por cada referido que se suscriba a un plan premium o de revendedor."
---

<Update title="Lanzamiento del Programa de Afiliados" date="2026-05-08">
...
<Steps>
  <Step title="Comparte tu enlace en comunidades activas">
  ...
  <Step title="Aprovecha el email marketing">
  ...
  <Step title="Incluye el enlace en tu sitio web o blog">
  ...
  <Step title="Colabora con otros creadores">
...
<Columns cols="2">
  <Card title="Apuesta por contenido educativo">
  ...
  <Card title="Segmenta tu audiencia">
  ...
  <Card title="Usa múltiples canales">
  ...
  <Card title="Mide y optimiza constantemente">
...
<Expandable title="Spamear tu enlace en todas partes">
...
<Expandable title="No diversificar tus canales">
...
<Expandable title="Promocionar sin conocer la plataforma">
...
<Expandable title="Ignorar las políticas de afiliados">
...
<Expandable title="Rendirte demasiado pronto">
...
<Columns cols="3">
  <Card title="La bloguera de marketing">
  ...
  <Card title="El YouTuber de tecnología">
  ...
  <Card title="La agencia de marketing">
...
<Columns cols="2">
  ...
  <Card title="Facebook Messenger e Instagram">
...
<Expandable title="¿Cómo recibo mi pago como afiliado?">
...
<Expandable title="¿Puedo promocionar E-SMART360 en mis redes sociales?">
...
<Expandable title="¿Puedo usar mi enlace de afiliado en anuncios de pago?">
...
<Expandable title="¿Qué sucede si un cliente que referí cancela su suscripción?">
...
<Expandable title="¿Puedo ser afiliado y también cliente premium de E-SMART360?">
...
<Expandable title="¿Hay soporte para afiliados?">
...
```mermaid
flowchart TD
    A[Te registras como afiliado] --> B[Solicitas tu enlace]
    B --> C{Aprobación en 24h}
    C -->|Sí| D[Recibes tu enlace de afiliado]
    C -->|No| E[Contacta a soporte]
    D --> F[Compartes tu enlace]
    F --> G[Usuario hace clic]
    G --> H{Cookie de 1 año activa}
    H -->|Sí| I[Usuario se registra]
    H -->|No| J[Clic expiró, nuevo clic necesario]
    I --> K[Usuario se convierte en premium]
    K --> L[Recibes 25% comisión mensual]
    L --> M[Acumulas comisiones]
    M --> N{Saldo >= $50?}
    N -->|Sí| O[Solicitas retiro]
    N -->|No| P[Sigue acumulando]
    O --> Q[Recibes pago en 5 días hábiles]
```
...
<Expandable title="¿Puedo referirme a mí mismo como afiliado?">
...
<Expandable title="¿Las comisiones se pagan sobre el valor total de la suscripción?">
...
<Expandable title="¿Qué sucede si un cliente cambia de plan?">
...
<Expandable title="¿Ofrecen materiales promocionales como banners o textos?">
...
<Expandable title="¿Puedo promocionar E-SMART360 en eventos o webinars?">
...
<Expandable title="Plantilla para redes sociales (LinkedIn / Twitter)">
...
<Expandable title="Plantilla para email marketing">
...
<Expandable title="Plantilla para grupos de WhatsApp / Telegram">
