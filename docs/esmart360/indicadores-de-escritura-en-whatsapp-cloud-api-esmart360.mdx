...
<Steps>
  ...
  <Step title="Configura el tiempo de retardo">
...
<Steps>
  <Step title="Activar indicador de escritura en IA">
  ...
  <Step title="Funciona con respuestas de respaldo">
    Funciona incluso cuando la IA está configurada como respaldo o manejando todas las consultas.
  </Step>
  <Step title="Combínalo con retardos de respuesta">
...
<Steps>
  ...
  <Step title="Navega al Gestor de Bots">
  ...
  <Step title="Selecciona el bot o flujo a configurar">
    Puedes tener múltiples bots y flujos. Selecciona aquel al que deseas agregar el indicador de escritura.
  </Step>
  <Step title="Configura el indicador por bloque de mensaje">
...
<Steps>
  <Step title="Ve a Configuración del Asistente de IA">
  ...
  <Step title="Elige el modo de operación de la IA">
  ...
  <Step title="Ajusta el retardo de respuesta">
...
<Steps>
  ...
  <Step title="Entrena con archivos">
...
<Expandable title="Configuración de respuesta sin coincidencia con indicador de escritura">
...
<Tabs>
  ...
  <Tab title="Con indicador activado">
...
<Expandable title="Ejemplo práctico: consulta de saldo">
...
<Expandable title="¿Cuánto dura el indicador de escritura en WhatsApp Cloud API?">
...
<Expandable title="¿El indicador de escritura consume más recursos de la API?">
...
<Expandable title="¿Se puede desactivar el indicador de escritura para mensajes específicos?">
...
<Expandable title="¿Funciona el indicador con todos los tipos de mensaje?">
...
<Expandable title="¿El indicador de escritura funciona si la IA está configurada como respaldo?">
...
<Expandable title="¿Pueden ver los agentes humanos que el bot está 'escribiendo'?">
...
<Columns cols="2">
  <Card title="🛒 E-commerce: Consultas de inventario">
  ...
  <Card title="🏥 Salud: Verificación de citas">
...
<Columns cols="2">
  <Card title="🏦 Finanzas: Consulta de movimientos">
  ...
  <Card title="🎓 Educación: Información de cursos">
...
<Columns cols="2">
  ...
  <Card title="Notificaciones de seguimiento">
...
<Steps>
  <Step title="El bot atiende la consulta inicial">
  ...
  <Step title="El cliente solicita atención humana">
  ...
  <Step title="El bot transfiere la conversación">
  ...
  <Step title="El agente humano toma el control">
  ...
  <Step title="El agente puede pausar o reanudar respuestas del bot">
...
<Expandable title="El indicador de escritura parpadea o aparece y desaparece rápidamente">
...
<Expandable title="El bot responde demasiado lento incluso sin indicador de escritura">
  **Posibles causas:**
...
<Expandable title="Error 130472: el número del usuario es parte de un experimento">
...
<Expandable title="Ejemplo: Consulta de estado de pedido en WooCommerce">
  **Flujo completo:**
...
<Columns cols="2">
  <Card title="📚 Consulta de calificaciones">
    **Flujo:**
  ...
  <Card title="📅 Información de cursos">
    **Flujo:**
...
<Expandable title="Recomendaciones para bots de palabras clave">
...
<Expandable title="Ejemplo de secuencia de ventas con indicadores de escritura">
...
<Expandable title="¿Puedo usar el indicador de escritura con mensajes broadcast o campañas masivas?">
...
<Expandable title="¿El indicador de escritura afecta la calificación de calidad de mi número de WhatsApp?">
...
<Expandable title="¿Puedo tener diferentes configuraciones de indicador para diferentes canales (WhatsApp, Instagram, Messenger)?">
...
<Expandable title="¿El indicador de escritura funciona si uso la Bandeja Compartida Multicanal?">
...
<Expandable title="¿Cómo afecta el indicador de escritura al consumo de tokens de IA?">
