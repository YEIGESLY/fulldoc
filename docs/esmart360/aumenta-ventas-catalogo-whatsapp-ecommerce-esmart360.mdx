---
title: "Aumenta tus Ventas con el Catálogo de WhatsApp para E-commerce"
description: "Aprende a configurar y vender productos a través del Catálogo de WhatsApp en E-SMART360. Descubre cómo crear tu catálogo, integrar pasarelas de pago, automatizar ventas con chatbots y brindar atención al cliente 24/7 para impulsar tu negocio de comercio electrónico."
---
...
<Steps>
<Step title="Agrega tus productos de dos formas">
...
<Step title="Configura precios y estado">
...
<Step title="Publica tu producto">
...
<Step title="Conecta con WhatsApp">
...
<Update title="Nueva función: Pagos con criptomonedas" date="2025-06-15">
...
<Step title="Abre la configuración de pago">
...
<Step title="Agrega el método de pago">
...
<Step title="Completa la información comercial faltante">
...
<Columns cols="2">
<Card title="Atención en Vivo 24/7">
...
<Card title="Chatbot Automatizado">
...
<Card title="Mayores Conversiones">
...
<Card title="Escalabilidad Total">
...
<Card title="Experiencia de Compra Unificada">
...
```mermaid
graph TD
    A[Cliente saluda] --> B[Chatbot responde con bienvenida]
    B --> C[¿Qué desea hacer?]
    C --> D[Ver catálogo de productos]
    C --> E[Hablar con un agente]
    C --> F[Seguimiento de pedido]
    D --> G[Mostrar categorías]
    G --> H[Cliente selecciona producto]
    H --> I[Mostrar detalles y precio]
    I --> J[¿Desea comprar?]
    J --> K[Sí - Ir a pago]
    J --> L[No - Ofrecer alternativa]
    K --> M[Seleccionar método de pago]
    M --> N[Confirmar pedido]
    N --> O[Notificación de confirmación]
    L --> G
    E --> P[Agente atiende en vivo]
    P --> Q[Resuelve consulta]
    Q --> J
    F --> R[Buscar pedido por ID]
    R --> S[Mostrar estado del envío]
    S --> C
```
...
<Expandable title="Venta cruzada y upsell automatizado">
...
<Expandable title="Recuperación de carritos abandonados">
...
<Expandable title="Notificaciones de reposición de stock">
...
<Expandable title="Segmentación de clientes para ofertas especiales">
...
<Expandable title="¿Puedo tener varios catálogos de productos en una misma cuenta de WhatsApp?">
...
<Expandable title="¿Qué tipos de pago puedo integrar en el catálogo de WhatsApp?">
...
<Expandable title="¿Cómo manejo el inventario si vendo por WhatsApp y también en mi tienda web?">
...
<Expandable title="¿Es necesario tener conocimientos técnicos para configurar el catálogo?">
...
<Expandable title="¿Puedo ofrecer descuentos o promociones exclusivas a través del catálogo?">
...
<Expandable title="¿Cómo gestiono las devoluciones y cambios a través del catálogo?">
...
<Expandable title="¿El catálogo de WhatsApp funciona en todos los países?">
...
<Expandable title="Mi catálogo no aparece sincronizado en E-SMART360">
...
<Expandable title="Los pagos no se procesan correctamente">
...
<Expandable title="Mis clientes no ven el catálogo en el chat">
...
<CodeGroup>
<CodeGroupItem title="Flujo de bienvenida">
```
...
<Tabs>
<Tab title="Notificaciones de compra">
...
<Tab title="Notificaciones de envío">
...
<Tab title="Notificaciones post-venta">
...
<Columns cols="2">
<Card title="Cómo Configurar un Catálogo de Productos en WhatsApp">
...
<Card title="Cómo Agregar WhatsApp Pay al Catálogo">
...
<Card title="Enviar Información de Compra a Google Sheets">
...
<Card title="Integración con Shopify y WooCommerce">
...
<Expandable title="¿Cómo afectan los límites de mensajería de WhatsApp a mi catálogo?">
...
<Expandable title="¿Puedo usar el mismo catálogo en varios números de WhatsApp?">
...
<Expandable title="¿Qué requisitos debo cumplir para que mi catálogo sea aprobado por WhatsApp?">
...
<Expandable title="¿Puedo usar el catálogo de WhatsApp para ventas B2B?">
...
<Expandable title="¿Puedo vender servicios a través del catálogo de WhatsApp?">
...
<Update title="Última actualización del catálogo de WhatsApp" date="2025-06-24">
