...
<Steps>
<Step title="La ventana comienza con la última interacción del usuario">
...
<Step title="Dentro de la ventana puedes enviar cualquier mensaje">
...
<Step title="Fuera de la ventana solo puedes usar plantillas aprobadas">
...
<Expandable title="Costos de conversación por región">
...
<Step title="Agrega variables personalizadas (opcional)">
...
<Step title="Crea la plantilla de mensaje">
...
<Step title="Guarda y espera aprobación de WhatsApp">
...
<Expandable title="Ver detalles sobre límites de transmisión">
...
<Card title="Gimnasios y Fitness">
...
<Expandable title="¿Qué cuenta como interacción del usuario para iniciar la ventana de 24 horas?">
...
<Expandable title="¿Puedo enviar mensajes promocionales después de que expire la ventana de 24 horas?">
...
<Expandable title="¿Las plantillas necesitan aprobación antes de usarse?">
...
<Expandable title="¿La regla de 24 horas aplica a mensajes salientes iniciados por la empresa?">
...
<Expandable title="¿Qué consecuencias tiene enviar un mensaje sin plantilla fuera de la ventana?">
...
<Expandable title="¿Puedo usar la misma plantilla para múltiples conversaciones?">
...
<Expandable title="¿Cómo afecta la calidad del número a la regla de 24 horas?">
...
<Expandable title="¿Qué es una conversación y cómo se cobra?">
...
<Expandable title="¿Cómo veo el tiempo restante en E-SMART360?">
...
<Expandable title="¿Qué hago si una plantilla es rechazada por WhatsApp?">
...
<Steps>
<Step title="Maximiza las conversaciones de servicio">
...
<Step title="Agrupa mensajes de utilidad">
...
<Step title="Segmenta campañas de marketing">
...
<Step title="Monitorea conversaciones duplicadas">
...
<Expandable title="Más información sobre coexistencia">
