...
<Step title="Configura los alcances de la API de administración">
...
<Step title="Revela el token de acceso">
...
<Steps>
<Step title="Pega el token en el campo correspondiente">
...
<Steps>
<Step title="Crea una plantilla de mensaje para WhatsApp">
...
<Step title="Configura un Webhook Workflow">
...
<Step title="Captura y mapea la respuesta del webhook">
...
<Tabs>
<Tab title="Ejemplo de plantilla de notificación">
```
...
<Tab title="Ejemplo de plantilla para COD">
```
🛵 ¡Hola {{CustomerName}}!
...
<Steps>
<Step title="Ve a la automatización de carritos abandonados">
En el panel de E-SMART360, dirígete a **WC/Shopify Automation** y haz clic en **Crear**.
</Step>

<Step title="Configura los parámetros de la campaña">
...
<Step title="Define el tiempo de espera y la plantilla">
...
<Step title="Configura seguimiento adicional (opcional)">
...
<Columns cols="2">
<Card title="📈 Ejemplo práctico: Recuperación de carrito">
...
<Card title="🚀 Ejemplo práctico: Verificación COD">
...
<Expandable title="Enviar notificaciones de cambio de estado de pedido">
...
<Expandable title="Vender productos del catálogo de Shopify en WhatsApp">
...
<Expandable title="Automatización con secuencias de mensajes">
...
<Expandable title="Verificación de pedidos contra entrega (COD)">
...
<Expandable title="Integración con Google Sheets">
...
<Steps>
<Step title="Crea un nuevo Workflow Webhook">
...
<Step title="Selecciona la plantilla y obtén la URL">
...
<Step title="Captura y mapea la respuesta">
...
<Step title="Diseña la plantilla de mensaje">
...
<Step title="Mapea los campos de envío">
...
<Steps>
<Step title="Crea el Workflow de post-entrega">
Crea un Workflow llamado "Pedido entregado - solicitud de reseña".
</Step>

<Step title="Crea la plantilla de reseña">
...
<Tab title="Productos del pedido">
```json
{
  "line_items": [
    {
...
<Columns cols="3">
<Card title="⏰ Mensaje 1: 30 min después">
...
<Card title="💪 Mensaje 2: 24 h después">
...
<Card title="🎁 Mensaje 3: 72 h después">
...
<Expandable title="¿Cuál es el beneficio principal de integrar Shopify con E-SMART360?">
...
<Expandable title="¿Qué funcionalidades están disponibles después de la integración?">
...
<Expandable title="¿Es necesario crear una aplicación en Shopify para la conexión?">
...
<Expandable title="¿Qué permisos necesita la API de administración de Shopify?">
...
<Expandable title="¿Para qué se usa el Token de acceso de administrador?">
...
<Expandable title="¿Dónde ingreso los datos de Shopify en E-SMART360?">
...
<Expandable title="¿Se necesita programación para completar la integración?">
...
<Expandable title="¿Esta integración funciona con WhatsApp Cloud API?">
...
<Expandable title="¿Puedo desactivar o actualizar la integración después de activarla?">
...
<Expandable title="¿Qué hago si el webhook no captura la respuesta de Shopify?">
...
<Expandable title="¿Puedo usar otros eventos de Shopify además de la creación de pedidos?">
...
<Expandable title="¿El carrito abandonado funciona si el cliente no proporciona número de teléfono?">
...
<Expandable title="¿Cómo configuro mensajes de prueba sin afectar a clientes reales?">
...
<Expandable title="¿La integración funciona con tiendas Shopify en múltiples países?">
...
<Expandable title="Error: El mensaje no se envía a WhatsApp">
...
<Expandable title="Error: La respuesta del webhook no se captura">
...
<Expandable title="Error: El token de acceso de administrador no funciona">
