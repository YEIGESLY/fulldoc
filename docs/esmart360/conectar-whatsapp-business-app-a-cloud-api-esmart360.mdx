...
<Steps>
<Step title="Conectar sin crear un número nuevo">
...
<Step title="Gestionar desde un solo lugar">
...
<Step title="Usar tu móvil en paralelo">
...
<Columns cols="3">
<Card title="Crear nuevo WABA y perfil">
...
<Steps>
<Step title="Automatizar respuestas al cliente">
...
<Step title="Crear campañas de marketing">
...
<Step title="Configurar notificaciones promocionales">
...
<Step title="Usar WhatsApp en tu móvil simultáneamente">
...
<Expandable title="El número de teléfono no es elegible para incorporación">
...
<Expandable title="El botón 'Iniciar verificación' de Facebook está atenuado o no es visible">
...
<Expandable title="Mensajes que no se envían">
...
<Expandable title="Error 'número ya registrado'">
...
<Expandable title="¿Puedo responder mensajes desde E-SMART360 y desde la app móvil?">
...
<Expandable title="Si envío un mensaje desde la aplicación móvil de WhatsApp Business, ¿estará disponible en la bandeja de entrada de E-SMART360?">
...
<Expandable title="Cuando conecto mi número de WhatsApp Business a E-SMART360, ¿se sincronizarán mis contactos antiguos y mi historial de chat?">
...
<Expandable title="Si desinstalo la aplicación WhatsApp Business de mi teléfono, ¿E-SMART360 seguirá funcionando?">
...
<Expandable title="¿Mi chatbot manejará todos los mensajes automáticamente?">
...
<Columns cols="2">
<Card title="Tienda de comercio electrónico">
...
<Tabs>
<Tab title="WhatsApp Business App (Móvil)">
...
<Tab title="WhatsApp Cloud API (E-SMART360)">
...
<Steps>
<Step title="Configurar tu primer chatbot">
...
<Step title="Importar tus contactos">
...
<Step title="Configurar tu primera campaña">
...
<Expandable title="¿Necesito un número de teléfono completamente nuevo?">
...
<Expandable title="¿Puedo usar el mismo número en varios dispositivos móviles?">
...
Si vienes de otra plataforma como WATI, Twilio, MessageBird u otro BSP:
...
<Columns cols="2">
<Card title="Conversaciones iniciadas por el cliente">
...
<Card title="Conversaciones iniciadas por la empresa">
...
<Columns cols="2">
<Card title="Flujo automatizado de recuperación">
...
<Card title="Configuración técnica">
...
<Expandable title="¿Qué sucede si alcanzo mi límite de mensajería diario?">
...
<Expandable title="¿Puedo tener múltiples números de WhatsApp conectados a una sola cuenta de E-SMART360?">
...
<Expandable title="¿E-SMART360 cobra algún recargo adicional sobre las tarifas de conversación de WhatsApp?">
...
<Expandable title="¿Qué tipos de archivos puedo enviar a través de WhatsApp usando E-SMART360?">
...
<Expandable title="¿Qué debo hacer si mi solicitud de verificación empresarial es rechazada?">
