...
<Update title="Actualización importante" date="3 de marzo de 2026">
...
<Columns cols="2">
  <Card title="✅ Números Recomendados">
...
<Expandable title="¿Puedo migrar mi número de WhatsApp existente a WhatsApp Business Cloud API?">
...
<Expandable title="¿Pierdo mis chats de WhatsApp al migrar a Cloud API?">
...
<Expandable title="¿Por qué las empresas deberían cambiarse a WhatsApp Cloud API?">
...
<Expandable title="¿Es WhatsApp Cloud API mejor que la app estándar de WhatsApp Business?">
...
<Expandable title="¿Puedo conectar WhatsApp Cloud API con mi CRM?">
...
<Expandable title="¿Qué pasa si mi número está detrás de un sistema IVR?">
...
<Expandable title="¿Puedo registrar múltiples números en la Cloud API?">
...
<Expandable title="¿Una vez registrado, el número queda bloqueado permanentemente?">
...
<Expandable title="¿Qué beneficios ofrece una API unificada para integraciones B2B?">
...
<Expandable title="¿Cuánto tiempo toma la aprobación de plantillas de mensajes?">
...
<Expandable title="¿Qué hago si mi número es bloqueado después de la migración?">
...
<Expandable title="¿Puedo migrar un número que ya está en la Cloud API desde otro proveedor?">
...
<Expandable title="¿Puedo recuperar mi número después de migrarlo a la Cloud API?">
...
<Expandable title="¿Cómo afecta la migración a mis contactos guardados?">
