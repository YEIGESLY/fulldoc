...
<Update title="Actualización de guía de plantillas" date="2026-05-06">
...
<Expandable title="Ver ejemplos completos de plantillas de utilidad">
...
<Expandable title="Ver ejemplos completos de plantillas de marketing">
...
<Columns cols="2">
  <Card title="❌ Variables mal ubicadas">
  ...
  <Card title="❌ Categoría incorrecta">
  ...
  <Card title="❌ Plantillas duplicadas">
  ...
  <Card title="❌ Sin opción de baja (opt-out)">
  ...
  <Card title="❌ Exceso de variables">
  ...
  <Card title="❌ Errores ortográficos o jerga">
...
<CodeGroup>
  <CodeGroupItem title="Plantilla de ejemplo">
```text
¡Hola {{1}}! 👋
...
<CodeGroup>
  <CodeGroupItem title="Ejemplo con variables">
```text
Hola {{nombre_cliente}},
...
<Expandable title="¿Puedo actualizar una plantilla sin perder su estado de aprobación?">
...
<Expandable title="¿Qué hago si el botón 'Sincronizar Plantilla' no muestra las actualizaciones?">
...
<Expandable title="¿Puedo usar una misma plantilla para WhatsApp, Instagram y Facebook?">
...
<Expandable title="¿Cuánto tiempo tarda WhatsApp en aprobar una plantilla?">
...
<Expandable title="¿Qué son las plantillas de carrusel y cómo funcionan?">
...
<Expandable title="¿Puedo enviar plantillas con videos?">
...
<Expandable title="¿Qué diferencia hay entre los botones 'Respuesta Rápida' y 'CTA'?">
...
<Expandable title="¿Cómo afecta la calidad de mi plantilla a mi calificación de cuenta?">
...
<Columns cols="2">
  <Card title="🛍️ Tienda de comercio electrónico">
  ...
  <Card title="🏨 Hotel y hospitalidad">
...
<Columns cols="2">
  <Card title="⚠️ Error 131051: Plantilla no encontrada">
  ...
  <Card title="⚠️ Error 132001: Límite de plantillas alcanzado">
  ...
  <Card title="⚠️ Error 130401: Error de autenticación">
  ...
  <Card title="⚠️ Error 131049: Variable no válida">
