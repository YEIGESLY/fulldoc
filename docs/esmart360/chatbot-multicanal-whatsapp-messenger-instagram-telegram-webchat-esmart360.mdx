...
<Update title="Actualización de plataforma" date="2026-05-07">
...
<Steps>
<Step title="Conexión recomendada con o sin permiso de catálogo">
...
<Step title="Conexión manual alternativa">
...
<Columns cols="2">
<Card title="Ventajas del Chat Widget">
...
<Card title="Personalización disponible">
...
<Expandable title="Pasos para configurar un Webhook Workflow">
...
<Columns cols="2">
<Card title="Beneficios del Catálogo">
...
<Card title="Casos de uso frecuentes">
...
<Expandable title="¿Qué son exactamente los RCN-Suscriptores?">
...
<Expandable title="¿Cómo entrenar al AI Assistant del WebChat?">
...
<Step title="Añade los detalles de conexión">
...
<Step title="Configura los encabezados de solicitud">
...
<Step title="Usa la API en el Flow Builder">
...
<Steps>
<Step title="Define tu objetivo de secuencia">
...
<Columns cols="2">
<Card title="🎯 Ejemplo 1: Tienda de Ropa y Accesorios">
...
<Card title="📱 Ejemplo 2: Agencia de Marketing Digital">
...
<Expandable title="¿Qué es un chatbot multicanal?">
...
<Expandable title="¿Qué plataformas soporta E-SMART360?">
...
<Expandable title="¿Necesito conocimientos de programación para usar E-SMART360?">
...
<Expandable title="¿Qué es el AI Agent y cómo funciona?">
...
<Expandable title="¿Puedo enviar mensajes promocionales masivos?">
...
<Expandable title="¿Qué es el mensaje de secuencia y para qué sirve?">
...
<Expandable title="¿E-SMART360 es compatible con Shopify y WooCommerce?">
...
<Expandable title="¿Qué es el Webhook Workflow?">
...
<Expandable title="¿E-SMART360 permite gestionar grupos de Telegram?">
...
<Expandable title="¿E-SMART360 es adecuado para negocios de eCommerce?">
...
<Expandable title="¿Cómo se maneja la ventana de 24 horas de WhatsApp?">
...
<Expandable title="¿Qué son los RCN-Suscriptores en Facebook Messenger?">
...
<Expandable title="¿Se pueden programar respuestas fuera del horario laboral?">
...
<Step title="Asignación al equipo">
...
<Step title="Secuencia de seguimiento">
...
<Step title="Reactivación de leads fríos">
...
<Expandable title="¿Puedo importar contactos desde Google Sheets a E-SMART360?">
