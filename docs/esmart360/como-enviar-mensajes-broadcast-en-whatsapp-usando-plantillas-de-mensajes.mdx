...
<Update title="Actualización de funcionalidades de broadcast" date="Febrero 2026">
...
<Steps>
<Step title="Importar Suscriptores mediante CSV">
...
<Step title="Importar Suscriptores mediante Google Sheets">
...
<Expandable title="Causas de caída en la calificación">
...
<Step title="Guardar y enviar a revisión">
Haz clic en **Guardar**. Meta revisa la plantilla (minutos a 48 horas).
</Step>

<Step title="Verificar aprobación">
Estados: Pendiente, Aprobada, Rechazada, Pausada.
</Step>
</Steps>

<Expandable title="¿Qué hacer si rechazan tu plantilla?">
...
<Expandable title="Comparativa dentro vs. fuera de 24h">
...
<Card title="🛡️ Protección del número">
...
<Steps>
<Step title="Validación de lista">
...
<Step title="Plantilla de mensaje">
...
<Step title="Configuración de campaña">
...
<Columns cols="2">
<Card title="📖 Broadcasting con Datos Personalizados">
...
<Card title="📥 Importación desde Google Sheets">
