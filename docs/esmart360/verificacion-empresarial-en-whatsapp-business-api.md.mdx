...
<Expandable title="¿Por qué son importantes múltiples números de teléfono?">
...
<Steps>
<Step title="¿Cómo se muestra tu nombre comercial?">
...
<Step title="Reglas clave para el nombre comercial">
...
<Step title="Agrega la Información Empresarial">
...
<Expandable title="3. Idioma no compatible">
...
<Steps>
<Step title="WhatsApp API configurado">
...
<Step title="Meta Business Account verificado">
...
<Step title="Verificación en dos pasos habilitada">
...
<Card title="Mantén una calificación de alta calidad">
...
<Card title="Aumenta el reconocimiento de marca">
...
<Columns cols="2">
<Card title="✅ Conviene verificar SI:">
...
<Expandable title="¿Cuánto tiempo toma la verificación empresarial en WhatsApp?">
...
<Expandable title="¿Puedo usar el mismo número de teléfono para la API y la app de WhatsApp Business?">
...
<Expandable title="¿Cuántos intentos de verificación tengo?">
...
<Expandable title="¿El Green Tick de WhatsApp da funciones adicionales?">
...
<Columns cols="3">
<Card title="Pequeño negocio local">
...
<Card title="E-commerce en crecimiento">
...
<Card title="Empresa multi-región">
