...
<Steps>
<Step title="WordPress con Elementor Pro">
...
<Step title="Cuenta activa en E-SMART360">
...
<Step title="Acceso de administrador a WordPress">
...
<Step title="Conocimientos básicos de las herramientas">
...
<Step title="Número de teléfono de prueba">
...
<Step title="Navega a la sección de Plantillas de Mensaje">
...
<Step title="Configura los detalles básicos de la plantilla">
...
<Step title="Agrega variables de personalización">
...
<Steps>
<Step title="Accede a la sección Webhook Workflow">
...
<Step title="Inicia un nuevo workflow">
...
<Step title="Asigna un nombre descriptivo al workflow">
...
<Step title="Selecciona la cuenta de WhatsApp Business">
...
<Step title="Agrega el widget de Formulario">
...
<Step title="Configura las acciones posteriores al envío">
...
<Tabs>
<Tab title="Confirmación de contacto (Servicios)">
```text
Hola {{nombre}},
...
<Tab title="Lead calificado para ventas (E-commerce)">
```text
¡Hola {{nombre}}! 🎉
...
<Tab title="Notificación interna para el equipo de ventas">
```text
...
<Tab title="Confirmación de cita (Salud/Profesionales)">
```text
Estimado(a) {{nombre}},
...
<Steps>
<Step title="Crea un segundo workflow webhook">
...
<Step title="Configura dos acciones en Elementor">
...
<Step title="Prueba el envío dual">
...
<Step title="Configura los encabezados HTTP (Headers)">
...
<Step title="Define el cuerpo de la solicitud (Request Body)">
...
<Step title="Verifica la conexión con la API externa">
...
<Step title="Mapea los datos de respuesta de la API">
...
<Step title="Integra el HTTP API en tu flujo de trabajo">
...
<Expandable title="El formulario no envía datos al webhook de E-SMART360">
...
<Expandable title="Los mensajes de WhatsApp no llegan al destinatario">
...
<Expandable title="Error en el mapeo de campos: las variables no se reemplazan">
...
<Expandable title="El webhook muestra datos vacíos o incompletos">
**Posibles causas:**
...
<Expandable title="El webhook falla silenciosamente sin error aparente">
...
<Expandable title="Problemas al configurar múltiples acciones After Submit en Elementor">
...
<Expandable title="La plantilla de mensaje fue rechazada por Meta">
...
<Expandable title="Error 130472 - Número en experimento de Meta">
...
<Columns cols="3">
<Card title="Cumple con las políticas">
...
<Card title="Mantén los mensajes simples">
...
<Card title="Protege los datos del usuario">
...
<Update title="Actualización: Nuevas capacidades de webhook en 2026" date="Febrero 2026">
...
<Expandable title="¿Necesito Elementor Pro para los webhooks?">
...
<Expand<Expandable title="¿Cuánto tarda Meta en aprobar una plantilla de mensaje?">
...
<Expandable title="¿Qué hago si el webhook falla?">
...
<Expandable title="¿Puedo usar esto para formularios de contacto de terceros?">
...
<Expandable title="¿Los mensajes enviados por webhook cuentan contra mi límite de mensajes?">
...
<Expandable title="¿Puedo configurar múltiples formularios con diferentes mensajes?">
...
<Expandable title="¿Qué diferencia hay entre webhook workflow y HTTP API en E-SMART360?">
...
<Expandable title="¿Necesito WPForms Pro además de Elementor Pro?">
...
<Columns cols="2">
<Card title="🛒 E-commerce: Confirmación de pedido y seguimiento">
...
<Card title="🏥 Clínica o consultorio: Confirmación de citas">
...
<Columns cols="2">
<Card title="🏨 Hotelería: Gestión de reservas y consultas">
...
<Card title="🔧 Soporte técnico: Tickets automatizados">
...
<Columns cols="2">
<Card title="🎓 Educación: Inscripción a cursos">
...
<Card title="🚗 Automotriz: Solicitud de prueba de manejo">
...
<Expandable title="¿Puedo usar WhatsApp Web para recibir las notificaciones?">
...
<Expandable title="¿Cómo manejo la regla de 24 horas de WhatsApp?">
...
<Expandable title="¿Puedo incluir imágenes o videos en los mensajes automatizados?">
...
<Expandable title="¿Qué ocurre si el número de teléfono del formulario no está registrado en WhatsApp?">
...
<Expandable title="¿Cómo puedo hacer pruebas sin enviar mensajes reales?">
...
<Expandable title="¿Puedo configurar un solo formulario para notificar a múltiples departamentos?">
