...
<Update title="Última actualización" date="1 de abril de 2026">
...
<Columns cols="2">
<Card title="En Meta Business Manager">
...
<Card title="Para WhatsApp Business">
...
<Steps>
<Step title="Accede a la página de registro de Business Manager">
...
<Step title="Inicia sesión con tu cuenta de Facebook">
...
<Step title="Ingresa los datos de tu negocio">
...
<Step title="Configura los ajustes iniciales del negocio">
...
<Steps>
<Step title="Accede al Centro de Seguridad">
...
<Step title="Haz clic en Iniciar Verificación">
...
<Step title="Proporciona los datos de tu negocio">
...
<Steps>
<Step title="Accede a la Configuración de tu Página de Facebook">
...
<Step title="Abre la sección de Cuentas Vinculadas">
...
<Step title="Ingresa tu Número de WhatsApp Business">
...
<Step title="Verifica tu Número con el Código OTP">
...
<Step title="Envía la Solicitud de Conexión">
...
<Step title="Accede al Panel de Control y haz clic en Gestionar">
...
<Step title="Ve a WhatsApp Manager en Meta Business Manager">
...
<Step title="Revisa la Notificación de Solicitud">
...
<Step title="Aprueba la Solicitud de Conexión">
...
<Step title="Verifica que el Número esté Conectado Correctamente">
...
<Step title="Prueba la Conexión en un Navegador Diferente">
...
<Tabs>
<Tab title="Configuración en WhatsApp Manager">
...
<Tab title="Costos por Tipo de Conversación">
...
<Columns cols="2">
<Card title="Información Requerida">
...
<Card title="Información Recomendada">
...
<Columns cols="3">
<Card title="Botón WhatsApp en tu Página">
...
<Card title="Automatización de Conversaciones 24/7">
...
<Card title="Ejemplo 2: Consultoría Financiera">
...
<Expandable title="¿Cómo conecto mi WhatsApp Business a una página de Facebook?">
...
<Expandable title="¿Puedo vincular un mismo número de WhatsApp a varias páginas de Facebook?">
...
<Expandable title="¿Necesito la WhatsApp Business API para conectarlo a Facebook?">
...
<Expandable title="¿Por qué debería conectar WhatsApp Business a mi página de Facebook?">
...
<Expandable title="¿Cuánto tiempo toma conectar WhatsApp a una página de Facebook?">
...
<Expandable title="¿Puedo tener más de 25 números en mi cuenta de WhatsApp Business?">
...
<Expandable title="¿Qué tipos de conversación existen en WhatsApp Business API y cómo afectan los costos?">
...
<Expandable title="¿Qué es la ventana de servicio de 24 horas?">
...
<Expandable title="¿Puedo compartir mi cuenta WABA entre varios socios o agencias?">
...
<Expandable title="¿Qué documentos necesito para la verificación empresarial de Meta?">
...
<Expandable title="¿Cuánto cuesta mantener la conexión entre WhatsApp Business y Facebook?">
...
<Columns cols="3">
<Card title="Inmediato (Día 1 después de la conexión)">
...
<Card title="Corto Plazo (Semana 1-2)">
...
<Card title="Mediano Plazo (Mes 1-3)">
