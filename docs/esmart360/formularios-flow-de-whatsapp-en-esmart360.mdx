---
title: "Formularios Flow de WhatsApp en E-SMART360: Guía Completa 2025"
description: "Aprende a crear y usar formularios interactivos de WhatsApp Flow en E-SMART360. Guía paso a paso para recolectar datos, automatizar procesos y mejorar la experiencia del cliente directamente desde el chat de WhatsApp."
---
...
<Steps>
  ...
  <Step title="Respuestas automáticas">
...
<Tabs>
  ...
  <Tab title="Recomendaciones de Productos">
  ...
  <Tab title="Solicitudes de Soporte">
...
<Steps>
  ...
  <Step title="Seleccionar HTTP API (opcional)">
  ...
  <Step title="Guardar datos en campos personalizados">
...
<Columns cols="3">
  ...
  <Card title="APIs Personalizadas">
...
<Steps>
  <Step title="Mantén los formularios cortos">
  ...
  <Step title="Monitorea las tasas de finalización">
...
<Columns cols="2">
  <Card title="Pedidos Anticipados">
  ...
  <Card title="Depósitos y Señales">
...
<Expandable title="¿Qué es WhatsApp Flow exactamente?">
...
<Expandable title="¿Se necesita programación para crear formularios Flow en E-SMART360?">
...
<Expandable title="¿Puedo usar WhatsApp Flow sin un chatbot?">
...
<Expandable title="¿Qué tipos de negocio pueden beneficiarse de WhatsApp Flow?">
...
<Expandable title="¿Se puede integrar WhatsApp Flow con mi CRM?">
...
<Expandable title="¿Qué sucede si un cliente no completa el formulario?">
...
<Expandable title="¿Los formularios Flow pueden manejar pagos directamente?">
...
<Tabs>
  <Tab title="Estructura del Formulario">
    ```
  ...
  <Tab title="Configuración Adicional">
  ...
  <Tab title="Análisis y Optimización">
...
```mermaid
graph TD
    A[Cliente recibe producto] --> B[Bot envía formulario de satisfacción]
    B --> C{Cliente completa formulario?}
    C -->|Sí| D[Califica experiencia]
    D --> E{Calificación > 3?}
    E -->|Sí| F[Mensaje de agradecimiento + cupón descuento]
    E -->|No| G[Mensaje de disculpa + oferta especial]
    C -->|No| H[Recordatorio a las 24h]
    H --> I[2do recordatorio a las 48h]
    I --> J[Si no responde: marcar como pendiente]
...
<Expandable title="Resumen rápido: Lo que necesitas recordar">
...
```mermaid
graph LR
    A[Formulario 1: Citas] --> D[Dashboard Central]
    B[Formulario 2: Ventas] --> D
    C[Formulario 3: Soporte] --> D
    D --> E[Métricas en Tiempo Real]
    D --> F[Informes Semanales]
    D --> G[Alertas de Rendimiento]
...
<Columns cols="2">
  <Card title="Formularios WhatsApp Flow">
  ...
  <Card title="Métodos Tradicionales">
