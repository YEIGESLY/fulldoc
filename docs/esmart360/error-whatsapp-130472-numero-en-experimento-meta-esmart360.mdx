---
title: "Error 130472 de WhatsApp: Por qué ocurre y cómo solucionarlo"
description: "Guía completa sobre el error 130472 de WhatsApp. Aprende qué significa cuando el número de un usuario forma parte de un experimento de Meta, cómo identificar este error, por qué no se te cobrará por mensajes no entregados y las mejores estrategias para seguir haciendo marketing sin afectar tu tasa de entrega."
---
...
<Steps>
<Step title="Pide al cliente que te escriba primero">
...
<Step title="Espera la ventana de servicio de 24 horas">
...
<Step title="Reenvía tu mensaje original">
...
<Columns cols="2">
<Card title="Estrategias de consentimiento">
...
<Card title="Optimización de campañas">
...
<Steps>
<Step title="Identifica el número que no recibió el mensaje">
Revisa el reporte de tu campaña de broadcasting. Busca los números de teléfono que aparecen con estado "Fallido".
</Step>
<Step title="Confirma el número desde el que estás enviando">
...
<Step title="Consulta el catálogo oficial de errores de Meta">
...
<Expandable title="¿Cómo consultar el directorio de errores de Meta?">
...
<Columns cols="2">
<Card title="Opción A: Recordatorio por email">
...
<Card title="Opción B: Anuncio retargeting">
...
<Expandable title="Tipos de mensajes en WhatsApp Business API">
...
<Expandable title="¿El error 130472 afecta a todas mis campañas de WhatsApp?">
...
<Expandable title="¿Cómo sé qué clientes están en el experimento?">
...
<Expandable title="¿Este experimento terminará algún día?">
...
<Expandable title="¿Debería dejar de hacer marketing en WhatsApp por este error?">
...
<Expandable title="¿El error 130472 puede aparecer en cualquier momento o solo al inicio de campañas?">
...
<Expandable title="¿Afecta también a mensajes enviados desde chatbots automatizados?">
...
<Expandable title="¿Puedo apelar o contactar a Meta para que saquen a un cliente del experimento?">
...
<Expandable title="¿El frequency capping y el error 130472 son lo mismo?">
...
<Steps>
<Step title="Día 1: Envío inicial por WhatsApp">
...
<Step title="Día 2: Email de respaldo">
...
<Step title="Día 3: SMS de respaldo">
...
<Step title="Día 4-7: Ventana de oportunidad">
...
<CodeGroup>
<CodeGroupItem title="Ejemplo de webhook">
```javascript
...
<Step title="Verifica tu Business Manager">
...
<Expandable title="Ventana de servicio de 24 horas">
...
<Expandable title="Plantilla de mensaje">
...
<Expandable title="Punto de entrada abierto">
...
<Expandable title="Reporte de entrega (delivery report)">
...
<Expandable title="¿Qué pasa si el cliente sale del experimento? ¿Recibirá los mensajes automáticamente?">
...
<Expandable title="¿El error 130472 puede afectar a usuarios de otros países de manera diferente?">
...
<Expandable title="¿Cómo afecta la calidad de mi plantilla al error 130472?">
...
<Expandable title="¿Puedo usar mensajes de marketing sin plantilla para evitar el error 130472?">
...
<Expandable title="¿El error 130472 también afecta a los mensajes de tipo utility o service?">
...
<Expandable title="¿Cuánto tiempo debo esperar antes de intentar enviar el mensaje de nuevo?">
...
<Expandable title="¿El error 130472 es permanente para un usuario específico?">
...
<Expandable title="¿Cómo puedo monitorear la tasa de error 130472 en mis campañas?">
...
<Expandable title="¿Es recomendable usar números alternativos de WhatsApp para evitar el experimento?">
...
```mermaid
timeline
    title Ciclo de vida de un experimento de Meta
    Fase 1 : Meta selecciona un grupo pequeño de usuarios
            : Define objetivos del experimento
            : Configura métricas de evaluación
    Fase 2 : Comienza el experimento
            : Los mensajes de marketing fallan con error 130472
            : Meta monitorea el comportamiento de usuarios
    Fase 3 : Meta analiza los resultados
            : Decide si expande, modifica o finaliza
            : Ajusta algoritmos de entrega
    Fase 4 : Posible implementación global
            : O el experimento termina sin cambios
            : O se convierte en una política permanente
```
...
<CodeGroup>
<CodeGroupItem title="Estrategia de reactivación">
```
...
<Columns cols="2">
<Card title="Etiquetas recomendadas">
...
<Card title="Automatización con etiquetas">
