...
<Card title="Beneficios Clave de la Bandeja Compartida">
...
<Steps>
<Step title="El agente actual identifica la necesidad de transferencia">
...
<Step title="El agente actual informa al cliente">
...
<Step title="El nuevo agente localiza la conversación">
...
<Step title="El nuevo agente hace clic en 'Unirse al Chat'">
...
<Step title="El panel se recarga automáticamente">
...
<Step title="Se envía el Mensaje de Firma (opcional)">
...
<Step title="El agente anterior puede abandonar el chat">
...
<Expandable title="Cliente solicita hablar con otro miembro del equipo">
...
<Expandable title="Cliente frustrado que necesita una nueva perspectiva">
...
<Expandable title="Escalación a un agente especializado">
...
<Expandable title="Cambio de turno entre agentes">
...
<Expandable title="Manejo de múltiples canales simultáneamente">
...
<Expandable title="Manejo de picos de demanda estacionales">
...
<Card title="Toque Personalizado">
...
<Card title="Reducción de Ansiedad">
...
<Step title="Habilita los Mensajes de Firma">
...
<Step title="Define el mensaje por defecto del equipo">
...
<Step title="Personaliza la firma por cada agente (opcional)">
...
<Step title="Configura el Indicador de Escritura (opcional)">
...
<Step title="Configura el control de respuestas del bot">
...
<Steps>
<Step title="Inicia sesión con dos cuentas de agente">
...
<Step title="El agente A inicia una conversación">
...
<Step title="El agente B localiza la conversación">
...
<Step title="El agente B se une al chat con firma">
...
<Step title="Verifica el mensaje de firma">
...
<Card title="Seguimiento Posterior">
...
<Columns cols="2">
<Card title="🛒 Tienda de E-commerce - Gestión de Pedidos">
...
<Card title="🏥 Clínica Médica - Atención al Paciente">
...
<Columns cols="2">
<Card title="🏢 Empresa de Software - Soporte Técnico Especializado">
...
<Card title="🎓 Institución Educativa - Admisiones y Matrícula">
...
<Expandable title="¿Se puede usar Unirse al Chat en todos los planes de E-SMART360?">
...
<Expandable title="¿Qué sucede si dos agentes intentan unirse al mismo chat simultáneamente?">
...
<Expandable title="¿Puedo configurar diferentes Mensajes de Firma para diferentes canales?">
...
<Expandable title="¿Los mensajes de firma cuentan para los límites de la ventana de 24 horas de WhatsApp?">
...
<Expandable title="¿Puedo desactivar la función de Mensaje de Firma sin afectar Unirse al Chat?">
...
<Expandable title="¿Cómo afecta el Mensaje de Firma a la experiencia en el Chat Web?">
...
<Expandable title="¿Se pueden programar transferencias automáticas basadas en reglas?">
...
<Expandable title="¿El historial de transferencias se puede exportar?">
...
<Update title="Actualización: Indicadores de Escritura en WhatsApp Cloud API" date="2025-06-19">
