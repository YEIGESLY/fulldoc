...
<Update title="Actualización importante de Meta" date="2025-06-19">
...
<Callout type="info" title="Novedad importante de Meta">
...
<Callout type="tip" title="Cambio de juego">
...
<Callout type="info" title="Beneficio clave">
...
<Steps>
  <Step title="Navega a la Integración de WhatsApp en E-SMART360">
  ...
  <Step title="Inicia el Flujo de Embedded Signup de WhatsApp">
    ...
    <Callout type="warning" title="Importante sobre el nombre de perfil">
  ...
  <Step title="Habilita WhatsApp Cloud API para Marketing">
...
<Callout type="alert" title="Importante: ventana de 24 horas">
...
<Steps>
  ...
  <Step title="Configura los datos de tu negocio">
...
<Expandable title="Puntos clave sobre Business Manager">
...
<Expandable title="Puntos clave sobre WABA">
...
<Expandable title="Puntos clave sobre números de teléfono">
...
<Callout type="success" title="Sin recargos adicionales">
...
<Steps>
  <Step title="Accede a la Configuración de Meta Business">
  ...
  <Step title="Navega a Cuentas de WhatsApp">
  ...
  <Step title="Accede a la Configuración de Pago">
  ...
  <Step title="Agrega información empresarial faltante">
...
<Columns cols="2">
  ...
  <Card title="Connected Phone Numbers">
...
<Expandable title="Pasos para verificar tu negocio en Meta">
...
<Expandable title="¿Cómo solicitar el Green Tick de WhatsApp?">
...
<Steps>
  ...
  <Step title="Actualiza la foto de perfil">
  ...
  <Step title="Configura la descripción y sitio web">
  ...
  <Step title="Configura el horario de atención">
...
<Callout type="warning" title="Precaución al eliminar el número">
...
<Expandable title="Si envío un mensaje desde la app móvil de WhatsApp Business, ¿estará disponible en la bandeja de entrada de E-SMART360?">
...
<Expandable title="Cuando conecto mi número de WhatsApp Business a E-SMART360, ¿se sincronizarán mis contactos antiguos y el historial de chat?">
...
<Expandable title="¿Puedo responder mensajes tanto desde la bandeja de entrada de E-SMART360 como desde la app móvil de WhatsApp Business?">
...
<Expandable title="Si desinstalo la app de WhatsApp Business de mi teléfono, ¿E-SMART360 seguirá funcionando?">
...
<Expandable title="¿Mi chatbot gestionará todos los mensajes automáticamente?">
...
<Expandable title="¿Puedo programar mensajes o enviar campañas masivas con E-SMART360?">
...
<Expandable title="¿Recibiré notificaciones de nuevos mensajes en E-SMART360?">
...
<Expandable title="¿Necesito un teléfono nuevo para este proceso?">
...
<Expandable title="¿Cuál es la diferencia entre una Business Account y una Official Business Account (OBA)?">
...
<Expandable title="¿Cómo puedo aumentar el límite de números de teléfono en mi cuenta de WhatsApp Business?">
...
<Expandable title="¿Qué hago si mi solicitud de verificación empresarial fue rechazada?">
...
<Expandable title="¿Es posible tener múltiples números en diferentes WABA?">
...
<Expandable title="¿Cómo contacto a Meta para problemas con la API de WhatsApp?">
...
<Columns cols="2">
  <Card title="Tienda de E-commerce: Automatización de Ventas">
  ...
  <Card title="Agencia de Marketing: Gestión Multi-cuenta">
...
<Columns cols="2">
  ...
  <Card title="Restaurante: Pedidos y Reservas">
...
<Columns cols="3">
  <Card title="Integración sin Código">
  ...
  <Card title="Campañas y Notificaciones">
  ...
  <Card title="Usa WhatsApp en tu Móvil">
  ...
  <Card title="Panel de Control Intuitivo">
...
<Callout type="tip" title="Limitaciones por país">
...
<Steps>
  <Step title="Verifica la elegibilidad del número">
  ...
  <Step title="Prepara una copia de seguridad">
  ...
  <Step title="Inicia el proceso de Embedded Signup desde E-SMART360">
  ...
  <Step title="Configura la coexistencia">
...
<Expandable title="Tipos de plantillas de mensajes">
...
<Expandable title="Límites de caracteres para plantillas con medios">
...
<Columns cols="2">
  ...
  <Card title="Monitoreo de Actividad">
  ...
  <Card title="Cumplimiento de Políticas">
...
<Callout type="danger" title="Advertencia sobre spam y bloqueos">
