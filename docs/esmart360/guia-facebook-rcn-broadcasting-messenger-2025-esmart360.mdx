...
<Update title="Actualización 2026" date="19 Feb 2026">
...
<Step title="Configura el postback RCN">
...
<Steps>
<Step title="Accede al flujo del bot">
...
<Step title="Configura el título y la etiqueta">
...
<Step title="Añade el elemento RCN">
...
<Step title="Configura el nuevo elemento RCN">
...
<Step title="Añade un mensaje de confirmación">
...
<Steps>
<Step title="El usuario activa el flujo">
...
<Step title="Confirmación de suscripción">
...
<Step title="Diseña el mensaje del broadcast">
...
<Columns cols="3">
<Card title="🧩 Constructor visual de flujos">
...
<Card title="🤖 Bots y postbacks ilimitados">
...
<Card title="🏷️ Segmentación por etiquetas">
...
<Card title="📊 Analíticas en tiempo real">
...
<Expandable title="¿Qué industrias se benefician más del broadcasting con RCN?">
...
<Expandable title="¿Cada cuánto tiempo puedo subir de nivel?">
...
<Step title="Mapea los datos del suscriptor">
...
<Step title="Configura la plantilla">
...
<Step title="Guarda y verifica la aprobación">
...
<Step title="Configura los parámetros básicos">
...
<Step title="Selecciona la plantilla personalizada">
...
<Step title="Define la audiencia objetivo">
...
<Expandable title="¿Qué es exactamente el broadcasting de Facebook?">
...
<Expandable title="¿Puedo cambiar la frecuencia de notificación después de la suscripción?">
...
<Expandable title="¿Qué sucede después de 6 meses?">
...
<Expandable title="¿Puedo enviar mensajes broadcast de Facebook a todos mis suscriptores?">
...
<Expandable title="¿El broadcasting de Facebook ayuda a generar leads?">
...
<Expandable title="¿Cómo funciona RCN dentro de E-SMART360 en resumen?">
...
<Expandable title="¿Puedo usar RCN en varios canales simultáneamente?">
...
<Expandable title="¿Cuál es la mejor manera de crear un RCN?">
...
<Expandable title="¿Puedo enviar mensajes sin una plantilla aprobada?">
...
<Columns cols="2">
<Card title="🛍️ Ejemplo 1: Tienda de Ropa Online">
...
<Card title="📚 Ejemplo 2: Plataforma Educativa Online">
...
<Columns cols="2">
<Card title="🍕 Ejemplo 3: Restaurante Local con Delivery">
...
<Card title="💼 Ejemplo 4: Agencia Inmobiliaria">
