...
<Step title="Configuración Principal y Duración">
...
<Step title="Conexión con Google Calendar">
...
<Step title="Reglas de Agendamiento Profesional">
...
<Step title="Horarios Específicos">
...
<Step title="Seleccionar Pasarela de Pago">
...
<Step title="Política de Reembolsos">
...
<CodeGroup>
<CodeGroupItem title="Ejemplo de mensaje de confirmación">
...
<CodeGroupItem title="Ejemplo de recordatorio">
...
<Columns cols="3">
<Card title="Consultores y Coaches">
...
<Card title="Profesionales de la Salud">
...
<Card title="Servicios de Belleza y Bienestar">
...
<Columns cols="3">
<Card title="Educación y Tutorías">
...
<Card title="Servicios Técnicos y Reparaciones">
...
<Expandable title="¿Qué pasa si un cliente no se presenta a la cita (no-show)?">
...
<Expandable title="¿Puedo tener diferentes tipos de cita con diferentes precios y duraciones?">
...
<Expandable title="¿Cómo se manejan las zonas horarias cuando el cliente está en otro país?">
...
<Expandable title="¿Puedo integrar el sistema de citas con otras herramientas como Shopify o WooCommerce?">
...
<Expandable title="¿Qué sucede si necesito bloquear un día específico por vacaciones o emergencia?">
...
<Expandable title="¿Cuántos tipos de cita puedo crear?">
...
<Expandable title="¿Puedo limitar las citas por cliente para evitar abusos?">
