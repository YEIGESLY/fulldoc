...
<Columns cols="2">
  <Card title="Tienda pequeña (100 pedidos/mes)">
  ...
  <Card title="Tienda mediana (500 pedidos/mes)">
...
<Steps>
  ...
  <Step title="Selecciona Shopify como plataforma">
  ...
  <Step title="Obtén el token de acceso de administrador en Shopify">
...
<Expandable title="Error: Token de acceso no válido">
...
<Expandable title="Error: No se encuentran pedidos o carritos">
...
<Expandable title="Problemas con webhooks de Shopify">
...
<Tabs>
  <Tab title="Crear plantillas predeterminadas">
  ...
  <Tab title="Crear plantilla personalizada">
...
<Expandable title="Plantillas de utilidad">
...
<Expandable title="Plantillas de marketing">
...
<Steps>
  <Step title="Accede a la automatización WC/Shopify">
...
<Tabs>
  <Tab title="Secuencia recomendada de 3 pasos">
    <Steps>
      <Step title="Paso 1: Recordatorio amigable (30 min)">
      ...
      <Step title="Paso 2: Urgencia (4 horas)">
      ...
      <Step title="Paso 3: Oferta especial (24 horas)">
  ...
  <Tab title="Secuencia rápida (2 pasos)">
  ...
  <Tab title="Secuencia para alto valor">
...
<CodeGroup>
<CodeGroupItem title="Ejemplo de etiquetas útiles">
```
...
<Expandable title="¿Cómo se calcula la calificación de calidad?">
...
<Columns cols="2">
  <Card title="Momento óptimo de envío">
  ...
  <Card title="Personalización del mensaje">
...
<Columns cols="2">
  <Card title="Ejemplo 1: Tienda de moda">
  ...
  <Card title="Ejemplo 2: Tienda de electrónica">
...
<Expandable title="¿Qué sucede si el cliente ya compró los productos en otro momento?">
...
<Expandable title="¿Puedo enviar más de un mensaje de recuperación?">
...
<Expandable title="¿El cliente puede optar por no recibir estos mensajes?">
...
<Expandable title="¿Qué hago si mi plantilla de mensaje es rechazada por WhatsApp?">
...
<Expandable title="¿Puedo usar esta función con WooCommerce en lugar de Shopify?">
...
<Expandable title="¿Qué costo tiene cada mensaje de recuperación enviado?">
...
<Expandable title="¿Los mensajes de carrito abandonado se envían como utilidad o marketing?">
...
<Expandable title="¿Qué pasa si el cliente tiene mi número guardado pero no ha optado por recibir mensajes?">
...
<Expandable title="¿Puedo programar los mensajes solo en horario laboral?">
...
<Expandable title="Mi tienda Shopify no aparece en el listado de APIs">
...
<Expandable title="El mensaje no se envía aunque la campaña está activa">
Posibles causas:
...
<Expandable title="El enlace del carrito no funciona o lleva a una página vacía">
Posibles soluciones:
...
<Expandable title="Error 130472: El número de teléfono es parte de un experimento">
