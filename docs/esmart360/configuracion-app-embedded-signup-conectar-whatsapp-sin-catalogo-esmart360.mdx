...
<Steps>
  <Step title="Cuenta de Desarrollador de Facebook">
  ...
  <Step title="Aplicación de Facebook Creada">
  ...
  <Step title="Facebook Login for Business Configurado">
  ...
  <Step title="Cuenta de Business Manager">
  ...
  <Step title="Panel de E-SMART360">
...
<Steps>
  <Step title="Nombre de la Configuración">
  ...
  <Step title="Variación de Inicio de Sesión (Login Variation)">
  ...
  <Step title="Token de Acceso (Access Token)">
  ...
  <Step title="Selección de Activo (Asset)">
...
<Tabs>
  ...
  <Tab title="Permisos Adicionales">
...
<Columns cols="2">
  <Card title="Conexión Sin Catálogo">
  ...
  <Card title="Conexión Con Catálogo">
...
<Steps>
  <Step title="Crea tu Aplicación en Facebook Developers">
  ...
  <Step title="Configura Facebook Login for Business">
  ...
  <Step title="Crea la Configuración de Embedded Signup">
  ...
  <Step title="Copia el ID de Configuración">
    Copia el ID de configuración generado. Este ID es único para tu aplicación.
  </Step>
  <Step title="Configúralo en tu Panel Whitelabel">
...
<Expandable title="La opción de Embedded Signup no aparece en mi aplicación">
...
<Expandable title="El usuario ve un error al intentar conectar su número">
...
<Expandable title="El usuario no tiene Business Manager de Facebook">
...
<Expandable title="¿Puedo cambiar de sin catálogo a con catálogo después?">
...
<Expandable title="El ID de configuración no se guarda en E-SMART360">
...
<Expandable title="¿Qué hago si el botón 'Create Configuration' no funciona?">
...
<Columns cols="2">
  ...
  <Card title="Prueba Siempre Antes de Publicar">
  ...
  <Card title="Documenta tu Configuración">
  ...
  <Card title="Mantén tus Aplicaciones Actualizadas">
...
<Expandable title="Error: 'App Not Configured for Facebook Login'">
...
<Expandable title="Error: 'Invalid Configuration ID'">
...
<Expandable title="Error: 'Permissions Not Granted'">
...
<Expandable title="Error: 'Phone Number Already Registered'">
...
<Expandable title="Error: 'Maximum Number of WABAs Reached'">
...
<Expandable title="La Ventana Emergente se Cierra Inmediatamente">
...
<Columns cols="2">
  <Card title="Business Manager vs WABA">
...
<Columns cols="2">
  <Card title="Números Compatibles">
  ...
  <Card title="Números NO Compatibles">
...
<Steps>
  <Step title="Nombre de la Cuenta de Negocio (Business Account Name)">
  ...
  <Step title="Nombre de Visualización (Display Name)">
  ...
  <Step title="Categoría del Negocio">
...
<Steps>
  ...
  <Step title="Proporciona Documentación">
...
<Tabs>
  <Tab title="Costos de Conversación">
...
<Steps>
  ...
  <Step title="Verificación del Número">
    Ingresa su número de teléfono, recibe un OTP por SMS o llamada, y lo verifica.
  </Step>
  <Step title="Selección de Catálogo (Opcional)">
...
<Columns cols="2">
  <Card title="Configuración de la API de Facebook">
  ...
  <Card title="Guía Whitelabel Completa">
...
<Expandable title="¿Qué es exactamente Embedded Signup?">
...
<Expandable title="¿Necesito una cuenta de desarrollador de Facebook para esto?">
...
<Expandable title="¿Cuánto tiempo toma configurar Embedded Signup?">
...
<Expandable title="¿Puedo usar la misma configuración para varios números telefónicos?">
...
<Expandable title="¿Qué diferencia hay entre Embedded Signup y la conexión manual?">
...
<Expandable title="¿Los usuarios necesitan conocimientos técnicos para conectar su número?">
...
<Expandable title="¿Puedo tener configuraciones separadas para clientes con y sin catálogo?">
...
<Expandable title="¿Qué pasa si Meta cambia los requisitos de Embedded Signup?">
