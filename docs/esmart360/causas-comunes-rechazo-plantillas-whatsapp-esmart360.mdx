...
<Expandable title="¿Qué productos están restringidos en WhatsApp?">
...
<Expandable title="¿Cómo evitar crear plantillas duplicadas?">
...
<Steps>
<Step title="Verifica el método de pago en Meta WhatsApp Manager">
...
<Step title="Confirma que los mensajes puedan enviarse">
...
<Expandable title="Límites de caracteres para plantillas de WhatsApp">
...
<Steps>
<Step title="Ubica la plantilla rechazada">
...
<Step title="Realiza las correcciones necesarias">
...
<Step title="Cambia el nombre de la plantilla">
...
<Columns cols="2">
<Card title="Antes de crear la plantilla">
...
<Card title="Durante la creación">
...
<Update title="Última actualización: Guía de plantillas de WhatsApp" date="2026-05-06">
...
<Expandable title="¿Cuánto tiempo tarda la aprobación de una plantilla de WhatsApp?">
...
<Expandable title="¿Puedo usar la misma plantilla para marketing y utilidad?">
...
<Expandable title="¿Qué hago si mi plantilla sigue siendo rechazada después de corregir los errores?">
...
<Expandable title="¿Afecta el rechazo de plantillas a mi calidad de cuenta de WhatsApp?">
...
<Expandable title="¿Puedo enviar plantillas sin variables?">
...
<Expandable title="¿Qué son los botones de CTA y cómo ayudan a evitar rechazos?">
...
<Expandable title="¿Cómo se calculan los costos de las conversaciones con plantillas?">
...
<Expandable title="¿Puedo crear plantillas con imágenes o videos?">
...
<Expandable title="¿Qué pasa si mi cuenta de WhatsApp Business no está verificada?">
...
<Step title="Agrega el encabezado y pie de página (opcional)">
...
<Step title="Configura los botones (opcional)">
...
<Step title="Define las variables de plantilla">
...
<Step title="Revisa y envía para aprobación">
Antes de enviar:
...
<Card title="Caso 2: Agencia de servicios">
...
<Card title="Caso 3: Restaurante con recordatorios">
