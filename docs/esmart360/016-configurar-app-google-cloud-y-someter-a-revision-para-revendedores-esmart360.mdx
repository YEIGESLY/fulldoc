...
<Update title="Actualización importante sobre verificación de Apps de Google" date="2026-02-03">
...
<Columns cols="2">
<Card title="Sincronización de Contactos">
...
<Card title="Automatización con Sheets">
...
<Steps>
<Step title="Acceder a Google Cloud Console">
...
<Step title="Seleccionar el proyecto creado">
...
<Steps>
<Step title="Ir a APIs y Servicios">
...
<Step title="Buscar y habilitar Google Drive API">
...
<Step title="Buscar y habilitar Google Sheets API">
...
<Step title="Buscar y habilitar Google People API">
1. Vuelve a la **Biblioteca**.
...
<Step title="Habilitar Google Calendar API (opcional)">
1. Vuelve a la **Biblioteca**.
...
<Step title="Configurar pantalla de consentimiento">
...
<Step title="Seleccionar tipo de usuario">
...
<Step title="Configurar URIs de redireccionamiento">
...
<Step title="Guardar credenciales de forma segura">
...
<Columns cols="2">
<Card title="Consecuencias de NO verificar">
...
<Card title="Beneficios de la verificación">
...
<Step title="Agregar URLs de políticas">
...
<Steps>
<Step title="Ir a Acceso a Datos">
...
<Step title="Agregar los alcances requeridos">
...
<Step title="Justificar cada alcance">
...
<Step title="Proporcionar el enlace">
...
<Steps>
<Step title="Ir al centro de verificación">
...
<Step title="Responder el cuestionario">
Preguntas típicas:
...
<Steps>
<Step title="Automatizaciones con Google Sheets">
...
<Step title="Integración de Calendario">
...
<Step title="Producción sin restricciones">
...
<Steps>
<Step title="Iniciar sesión en E-SMART360">
El usuario inicia sesión y va a **Configuración → Integración de Google Sheets**.
</Step>

<Step title="Conectar cuenta de Google">
...
<Step title="Crear o seleccionar una hoja">
Pueden:
...
<Step title="Configurar campos personalizados">
...
<Step title="Usar datos en automatizaciones">
...
<Card title="Notificaciones de pedidos automatizadas">
...
<Card title="Encuestas post-venta con registro en Sheets">
...
<Expandable title="Error: redirect_uri_mismatch">
...
<Expandable title="Error: Aplicación no verificada">
...
<Expandable title="Error: Alcance sensible no aprobado">
...
<Expandable title="Error: Se necesita cuenta de facturación">
...
<Expandable title="Error: Video de demostración rechazado">
...
<Expandable title="Error: No puedo publicar la aplicación - botón gris">
...
<Expandable title="Mi aplicación fue rechazada, ¿qué hago?">
...
<Expandable title="¿Puedo usar la aplicación predeterminada de E-SMART360?">
...
<Expandable title="¿Qué APIs de Google debo habilitar obligatoriamente?">
...
<Expandable title="¿Qué tipo de aplicación OAuth debo seleccionar?">
...
<Expandable title="¿Dónde encuentro la URI de redireccionamiento OAuth en E-SMART360?">
...
<Expandable title="¿Cuánto tarda la verificación de Google normalmente?">
...
<Expandable title="¿Puedo conectar varias cuentas de Google?">
...
<Expandable title="¿Necesito crear una aplicación diferente para cada cliente?">
...
<Expandable title="¿Qué formato deben tener los números de teléfono en Google Sheets?">
...
<Expandable title="¿Puedo usar Google Sheets como base de datos en tiempo real para mi chatbot?">
...
<Expandable title="¿Cómo revoco el acceso de un usuario a mi aplicación de Google?">
...
<Expandable title="¿Qué hago si Google cambia sus políticas de verificación?">
...
<Update title="Historial de cambios" date="2026-05-06">
