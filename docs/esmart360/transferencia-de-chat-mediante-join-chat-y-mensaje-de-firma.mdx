---
title: "Transferencia de Chat mediante Join Chat y Mensaje de Firma"
description: "Aprende a usar las funciones Join Chat y Mensaje de Firma en la bandeja de entrada compartida de E-SMART360 para realizar transferencias de conversaciones entre agentes de forma profesional, transparente y eficiente en WhatsApp, Facebook, Instagram y Telegram."
---
...
<Step title="Identifica la conversación a tomar">
...
<Step title="Revisa el contexto de la conversación">
...
<Step title="Haz clic en el botón Join Chat">
...
<Step title="Espera la recarga automática del panel">
...
<Step title="Selecciona el envío del Mensaje de Firma (recomendado)">
...
<Step title="Comienza a atender al cliente">
...
<Expandable title="Solicitud del cliente de hablar con otra persona">
...
<Expandable title="Manejo de situaciones delicadas o clientes frustrados">
...
<Expandable title="Escalamiento de problemas complejos o técnicos">
...
<Expandable title="Cobertura por cambios de turno">
...
<Columns cols="2">
  <Card title="🤝 Ejemplo: Escalamiento a soporte técnico">
  ...
  <Card title="💼 Ejemplo: Transferencia por cambio de turno">
...
```mermaid
flowchart TD
    A[Cliente inicia conversación] --> B[Agente A atiende]
    B --> C{¿Necesita transferencia?}
    C -->|No| D[Agente A resuelve y cierra]
    C -->|Sí| E[Agente A identifica motivo]
    E --> F[Agente B localiza conversación]
    F --> G[Agente B revisa historial]
    G --> H[Agente B hace clic en Join Chat]
    H --> I[Panel se recarga automáticamente]
    I --> J[Agente B activa Mensaje de Firma]
    J --> K[Cliente recibe notificación de cambio]
    K --> L[Agente B continúa atención]
    L --> M[Problema resuelto satisfactoriamente]
...
<Steps>
<Step title="Accede a la configuración del Bot Manager">
...
<Step title="Localiza la opción del Mensaje de Firma">
...
<Step title="Redacta el mensaje usando la variable de nombre">
...
<Step title="Define el tono y estilo del mensaje">
...
<Step title="Guarda los cambios y prueba la configuración">
...
<Tab title="Gerencia / Supervisión">
```
...
<Columns cols="3">
  <Card title="⚡ Mayor velocidad de resolución">
  ...
  <Card title="🔍 Transparencia total con el cliente">
  ...
  <Card title="📊 Trazabilidad y rendición de cuentas">
...
<Expandable title="Colaboración fluida entre agentes">
...
<Expandable title="Profesionalismo en cada interacción">
...
<Expandable title="Reducción del estrés y la presión del agente">
...
<Expandable title="Personalización a escala para cada equipo">
...
<Expandable title="Mejora en los indicadores clave de servicio (KPIs)">
...
<Expandable title="¿Por qué es importante la transferencia de conversaciones en la atención al cliente?">
...
<Expandable title="¿El administrador puede rastrear quién realizó una transferencia?">
...
<Expandable title="¿Se puede desactivar el Mensaje de Firma si no es necesario?">
...
<Expandable title="¿El Mensaje de Firma se envía automáticamente o el agente debe activarlo manualmente?">
...
<Expandable title="¿Join Chat funciona en todos los canales de la bandeja compartida?">
...
<Expandable title="¿Qué sucede si dos agentes intentan tomar la misma conversación al mismo tiempo?">
...
<Expandable title="¿Se puede incluir más de una variable en el Mensaje de Firma?">
...
<Expandable title="¿Join Chat funciona también para chats grupales o solo conversaciones uno a uno?">
...
<Expandable title="¿Existe un límite de cuántas veces se puede transferir una misma conversación?">
...
<Expandable title="¿Puedo usar Join Chat sin tener activo el Mensaje de Firma?">
...
<Columns cols="2">
  <Card title="🏢 Agencia de marketing digital con múltiples clientes">
  ...
  <Card title="🏪 Tienda de comercio electrónico con carritos abandonados">
...
<Columns cols="2">
  <Card title="🌐 Soporte multicanal para empresa de SaaS">
  ...
  <Card title="🏨 Cadena hotelera con múltiples propiedades">
...
```mermaid
flowchart LR
    A[Nivel 1: Agente de atención general] --> B{¿Puede resolver?}
    B -->|Sí| C[Resuelve y cierra]
    B -->|No| D[Nivel 2: Especialista]
    D --> E{¿Requiere más expertise?}
    E -->|No| F[Resuelve y documenta]
    E -->|Sí| G[Nivel 3: Ingeniero / Supervisor]
    G --> H[Resuelve y registra en base de conocimiento]
...
<Expandable title="Descripción del protocolo de escalamiento por niveles">
...
<Columns cols="3">
  <Card title="📝 Documentación de contexto">
  ...
  <Card title="🎯 Capacitación del equipo">
  ...
  <Card title="📊 Monitoreo de calidad">
...
<Tabs>
<Tab title="Mensaje con nombre y cargo">
```
...
<Tab title="Mensaje con agradecimiento al agente anterior">
```
...
<Tab title="Mensaje con disculpa y compromiso">
```
...
<Tab title="Mensaje breve y directo">
```
Hola, soy #User-Name# de E-SMART360.
...
<Expandable title="El botón Join Chat no aparece para algunos agentes">
...
<Expandable title="El Mensaje de Firma no se envía aunque seleccioné la opción">
...
<Expandable title="La recarga del panel tarda más de lo normal">
...
<Expandable title="El agente anterior sigue viendo la conversación como activa">
...
<Expandable title="El cliente no recibe el mensaje de presentación en el canal esperado">
...
<Update title="Actualizaciones del artículo" date="6 de mayo de 2026">
...
<Expandable title="Términos clave de la transferencia de chat">
| Término | Definición |
|---|---|
