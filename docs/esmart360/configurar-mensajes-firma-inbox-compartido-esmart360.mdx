---
title: "Configurar Mensajes de Firma en la Bandeja de Entrada Compartida"
description: "Aprende a configurar mensajes de firma personalizados en la bandeja de entrada compartida de E-SMART360 para mantener una comunicación profesional, consistente y con un toque humano en cada interacción con tus clientes a través de WhatsApp, Facebook, Instagram, Telegram y Chat Web."
---
...
<Steps>
<Step title="Comprender cómo funciona la activación">
...
<Step title="Habilitar los mensajes de firma">
...
<Step title="Agregar un mensaje de firma predeterminado">
...
<Step title="Personalizar la firma de cada agente">
...
<Step title="Configurar el indicador de escritura">
...
<Step title="Guardar los cambios y verificar">
...
<Tabs>
<Tab title="Campos Dinámicos Disponibles">
...
<Tab title="Ejemplos de Uso Avanzados">
**Firma completa:**
```
...
<Steps>
<Step title="Unirse a un chat como agente">
...
<Step title="Verificar en múltiples canales">
...
<Step title="Confirmar con otro agente">
...
<Step title="Probar la transferencia entre agentes">
...
<Columns cols="2">
<Card title="📞 Cuándo transferir un chat">
...
<Card title="✅ Beneficios de la transferencia estructurada">
...
```mermaid
graph TD
    A[Cliente escribe] --> B{Bandeja Compartida}
    B --> C[Agente Ventas]
    B --> D[Agente Soporte]
    B --> E[Agente Facturación]
    C --> F[Firma: Nombre + Asesor de Ventas]
    D --> G[Firma: Nombre + Soporte Técnico]
    E --> H[Firma: Nombre + Facturación]
    F --> I[Cliente sabe que habla con Ventas]
    G --> J[Cliente sabe que habla con Soporte]
    H --> K[Cliente sabe que habla con Facturación]
```
...
<Expandable title="¿Qué sucede cuando se habilita la función de Mensaje de Firma?">
...
<Expandable title="¿Puedo deshabilitar el bot cuando los agentes están activos?">
...
<Expandable title="¿Se puede usar el mensaje de firma sin activar Unirse al Chat?">
...
<Expandable title="¿Qué pasa si un agente tiene su firma personalizada vacía?">
...
<Expandable title="¿Puedo incluir emojis en los mensajes de firma?">
...
<Expandable title="¿Cuántos caracteres puede tener un mensaje de firma?">
...
<Columns cols="2">
<Card title="🛒 Ejemplo 1: Tienda de E-commerce con equipo de soporte multicanal">
...
<Card title="🏢 Ejemplo 2: Empresa de Servicios con múltiples niveles de soporte">
...
<Update title="Actualización: Nuevas opciones de personalización de firmas" date="2025-06-19">
...
<Update title="Novedad: Variables de firma mejoradas" date="2025-05-01">
