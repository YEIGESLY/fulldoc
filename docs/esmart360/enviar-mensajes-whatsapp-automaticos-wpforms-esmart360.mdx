...
<Columns cols="2">
<Card title="Requisitos Técnicos">
...
<Card title="Conocimientos Previos">
...
<Steps>
<Step title="Accede a los complementos de WPForms">
...
<Step title="Instala y activa Webhooks Addon">
...
<Step title="Configura los detalles de la plantilla">
...
<Step title="Obtén la URL de callback">
...
<Tabs>
<Tab title="Formato de la URL de Callback">
```
...
<Tab title="Estructura del Payload">
```json
{
  "name": "Juan Pérez",
...
<Steps>
<Step title="Crea un nuevo formulario">
...
<Step title="Agrega los campos necesarios">
...
<Step title="Guarda el formulario">
...
<Steps>
<Step title="Completa el formulario de prueba">
...
<Step title="Captura la respuesta en E-SMART360">
...
<Step title="Mapea el número de teléfono">
...
<Step title="Mapea las demás variables">
...
<Columns cols="3">
<Card title="Confirmación de Contacto">
...
<Card title="Notificación de Registro">
...
<Expandable title="No sé si la versión gratuita de WPForms funciona para esto">
...
<Expandable title="Mi plantilla de mensaje fue rechazada por Meta">
...
<Expandable title="El webhook no envía datos a E-SMART360">
...
<Expandable title="¿Puedo usar variables en el mensaje?">
...
<Expandable title="¿Puedo enviar mensajes a números internacionales?">
...
<Expandable title="¿Cuánto tiempo tarda en llegar el mensaje después del envío del formulario?">
...
<Expandable title="¿Necesito WPForms Pro para usar webhooks?">
...
<Expandable title="¿Puedo enviar imágenes o archivos en el mensaje automático?">
...
<Card title="Timing y Frecuencia">
...
<Expandable title="Optimiza tus plantillas para mejorar la tasa de apertura">
...
<Expandable title="Mide el rendimiento de tus campañas">
