...
<Tabs>
<Tab title="Cuenta WhatsApp Business">
...
<Step title="Configura el Nombre y Categoría">
...
<Step title="Diseña el Cuerpo del Mensaje">
...
<Step title="Agrega las Tarjetas del Carrusel">
...
<Step title="Añade Botones a las Tarjetas">
...
<Step title="Vincula la Plantilla al Bot">
...
<Steps>
<Step title="Integra tu Tienda en Línea">
...
<Step title="Crea la Plantilla de Productos">
...
<Step title="Selecciona los Productos">
...
<Step title="Activa el Flujo del Bot">
...
<Update title="Integración de Shopify y WooCommerce" date="2026-04-15">
...
<Steps>
<Step title="Crea un Flujo de Bot">
...
<Step title="Personaliza el Botón">
...
<Card title="Imágenes de Alta Calidad">
...
<Card title="Segmentación por Horario">
...
<Columns cols="2">
<Card title="🛍️ Tienda de Ropa - Colección de Temporada">
...
<Card title="🍕 Restaurante - Menú Digital Interactivo">
...
<Columns cols="2">
<Card title="🏨 Agencia de Viajes - Paquetes Turísticos">
...
<Card title="💻 Tienda de Tecnología - Lanzamiento de Productos">
...
<Expandable title="¿Por qué no se guarda mi plantilla de carrusel?">
...
<Expandable title="¿Cuánto tarda la aprobación de la plantilla?">
...
<Expandable title="¿Puedo enviar plantillas de carrusel en transmisiones masivas?">
...
<Expandable title="¿Puedo agregar videos en lugar de imágenes en el carrusel?">
...
<Expandable title="¿Necesito una tienda en línea para usar plantillas de carrusel?">
...
<Expandable title="Mi plantilla no fue aprobada. ¿Qué hago?">
...
<Expandable title="Los botones de mi carrusel no funcionan">
...
<Expandable title="El contenido multimedia no se muestra correctamente">
...
<Expandable title="¿Qué hago si mi plantilla de carrusel es rechazada exactamente por el orden de botones?">
...
<Expandable title="¿Puedo usar un mismo carrusel para marketing y post-venta?">
...
<Expandable title="¿Cómo puedo incluir más de 10 productos si el carrusel máximo es 10 tarjetas?">
...
<Expandable title="¿Qué tipos de archivos multimedia son compatibles con WhatsApp para el carrusel?">
...
<Expandable title="¿Cómo manejar el seguimiento de clics en múltiples carruseles de una misma campaña?">
...
<Expandable title="¿Cuántas tarjetas puede tener un carrusel?">
...
<Expandable title="¿Puedo usar emojis en las plantillas de carrusel?">
...
<Expandable title="¿Las plantillas de carrusel funcionan en todos los dispositivos?">
...
<Expandable title="¿Puedo editar una plantilla de carrusel después de aprobada?">
...
<Expandable title="¿Cómo puedo medir el rendimiento de mis plantillas de carrusel?">
