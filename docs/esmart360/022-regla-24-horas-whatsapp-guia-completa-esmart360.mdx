---
title: "Regla de las 24 Horas en WhatsApp: Guía Completa para Cumplirla Efectivamente"
description: "Descubre cómo funciona la regla de las 24 horas de WhatsApp, qué ocurre cuando vence la ventana de conversación y cómo E-SMART360 te ayuda a gestionar plantillas, temporizadores y reenganche de clientes de forma automática y conforme a las políticas de Meta."
---
...
<Update title="Actualización sobre la regla de 24 horas" date="2026-02-13">
...
<Expandable title="Plantilla 1: Disculpas por demora en la respuesta">
...
<Expandable title="Plantilla 2: Contacto fuera de horario laboral">
...
<Expandable title="Plantilla 3: Seguimiento multicanal">
...
<Expandable title="Plantilla 4: Recordatorio post-compra">
...
<Step title="Personaliza los elementos interactivos">
...
<Step title="Monitorea el estado">
...
<Step title="Actívala en tus flujos">
...
<Tabs>
<Tab title="Conversaciones iniciadas por el usuario">
...
<Tab title="Conversaciones iniciadas por la empresa">
...
<Steps>
<Step title="Responde al instante">
...
<Step title="Segmenta a tus usuarios">
...
<Step title="Ofrece valor en cada interacción">
...
<Step title="Diseña flujos conversacionales atractivos">
...
<Step title="Monitorea las métricas en tiempo real">
...
<Columns cols="2">
<Card title="Caso real: Tienda de e-commerce">
...
<Card title="Caso real: Clínica dental">
...
<Columns cols="2">
<Card title="Botones de llamada a la acción">
...
```mermaid
flowchart TD
    A[Usuario envía mensaje] --> B[Se inicia ventana de 24h]
    B --> C{¿Usuario interactúa de nuevo?}
    C -->|Sí| D[Se reinicia ventana de 24h]
    C -->|No| E[Ventana sigue su curso]
    D --> C
    E --> F{¿Ventana expiró?}
    F -->|No| G[Puedes enviar mensajes de formato libre]
    G --> C
    F -->|Sí| H[Debes usar plantilla aprobada]
    H --> I[E-SMART360 selecciona plantilla según reglas configuradas]
    I --> J[Envío automático de plantilla]
    J --> K{¿Usuario responde?}
    K -->|Sí| B
    K -->|No| L[Conversación en espera - programar reenganche futuro]
    L --> M{¿Han pasado 30 días?}
    M -->|Sí| N[Conversación cerrada - requiere nuevo opt-in]
    M -->|No| O[Esperar nueva interacción del usuario]
```
...
<Expandable title="¿Qué cuenta exactamente como 'interacción' del usuario para iniciar la ventana de 24h?">
...
<Expandable title="¿Puedo enviar mensajes promocionales después de la ventana de 24h?">
...
<Expandable title="¿Las plantillas necesitan aprobación?">
...
<Expandable title="¿Qué sucede si tengo una conversación con múltiples agentes? ¿El temporizador se reinicia?">
...
<Expandable title="¿La regla de 24 horas aplica igual en todos los países?">
...
<Expandable title="¿Qué pasa si envío un mensaje justo cuando expira la ventana?">
...
<Expandable title="¿Puedo tener múltiples ventanas de 24 horas con el mismo usuario?">
...
<Columns cols="3">
<Card title="Ejemplo 1: Restaurante">
...
<Card title="Ejemplo 2: Tienda de ropa">
...
<Card title="Ejemplo 3: Servicio técnico">
...
<Step title="Activa la gestión automática">
...
<Step title="Configura las alertas">
...
<Step title="Selecciona las plantillas predeterminadas">
...
<Step title="Define reglas de excepción">
...
<Expandable title="¿Puedo usar imágenes y videos dentro de la ventana de 24 horas?">
...
<Expandable title="¿Cómo manejar usuarios que escriben desde diferentes husos horarios?">
...
<Expandable title="¿Qué métricas puedo monitorear en E-SMART360 sobre la regla de 24 horas?">
