...
<Expandable title="¿Qué es Meta Business Manager y por qué lo necesito?">
...
<Expandable title="¿Cuál es la diferencia entre una cuenta Business y una Official Business Account (OBA)?">
**Business Account:**
...
<Step title="Agregar un método de pago">
...
<Step title="Agregar y verificar un número de teléfono">
...
<Step title="Obtener un token de acceso permanente">
...
<Step title="Cambiar el modo a Live">
...
<Step title="Conectar a E-SMART360">
...
<Expandable title="¿Qué hago si Meta me pide información comercial faltante?">
...
<Expandable title="Consejos para la aprobación de plantillas">
...
<Tab title="Migración con nuevo número">
...
<Expandable title="¿Qué es WhatsApp Cloud API y por qué la necesito para E-SMART360?">
...
<Expandable title="¿Necesito un número de teléfono nuevo para crear una cuenta de WhatsApp Cloud API?">
...
<Expandable title="¿Cuál es la diferencia entre el token temporal y el token permanente?">
...
<Expandable title="¿Por qué necesito configurar webhooks?">
...
<Expandable title="¿Dónde obtengo la URL de Callback y el Token de Verificación?">
...
<Expandable title="¿Cómo genero un token de acceso permanente?">
...
<Expandable title="¿Puedo enviar mensajes sin agregar un método de pago?">
...
<Expandable title="¿Qué hago si la conexión falla con error bad signature?">
...
<Update title="Versión inicial de la guía" date="Febrero 2026">
...
<Expandable title="¿Qué afecta la calidad de mi cuenta?">
...
<Expandable title="¿Cómo enviar imágenes y videos en campañas?">
...
<Expandable title="Error: Bad signature al conectar">
...
<Expandable title="El botón de verificación está gris o no visible">
...
<Expandable title="Mi plantilla de mensaje fue rechazada">
...
<Expandable title="Mis mensajes no se están enviando">
...
<Expandable title="Error al verificar el número de teléfono">
...
<Expandable title="¿Qué hago si mi solicitud de verificación es rechazada?">
...
<Expandable title="¿Puedo usar el mismo número en múltiples plataformas?">
...
<Expandable title="¿Qué hago si mi cuenta de WhatsApp se desactiva?">
...
<Expandable title="¿Cómo funciona el período de prueba gratuito?">
...
<Expandable title="¿Puedo migrar mi número de un BSP a E-SMART360?">
...
<Tabs>
<Tab title="Enviar mensaje de texto">
```bash
