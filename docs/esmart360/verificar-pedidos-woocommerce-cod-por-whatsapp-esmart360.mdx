...
<Steps>
  ...
  <Step title="Configurar el postback de cancelación">
...
<Steps>
  <Step title="Acceder a las automatizaciones">
...
<Steps>
  ...
  <Step title="Crear API para cancelación">
  ...
  <Step title="Asignar APIs a los botones">
...
<Steps>
  <Step title="Crear un pedido de prueba">
  ...
  <Step title="Esperar el retardo configurado">
  ...
  <Step title="Probar la confirmación">
  ...
  <Step title="Probar la cancelación">
...
<Steps>
  <Step title="Crear un Webhook Workflow">
  ...
  <Step title="Configurar el Webhook en WooCommerce">
  ...
  <Step title="Capturar datos del webhook">
  ...
  <Step title="Configurar el mapeo de campos">
...
<Expandable title="¿Qué hacer si la plantilla es rechazada?">
...
<Columns cols="2">
  <Card title="🛒 Tienda de electrodomésticos">
...
<Steps>
  <Step title="Conectar Google Sheets">
    En E-SMART360, ve a Integraciones y conecta tu cuenta de Google Sheets.
  </Step>
  
  <Step title="Crear workflow de registro">
...
<Columns cols="3">
  <Card title="⏱ Retardo del mensaje">
...
<Expandable title="Estrategia recomendada">
...
<Expandable title="¿Qué formato debe tener el número de teléfono en WooCommerce?">
...
<Expandable title="¿Funciona para pedidos prepagados?">
...
<Expandable title="¿Qué pasa si el cliente escribe texto en vez de usar botones?">
...
<Expandable title="¿Cuenta contra mi límite de mensajería?">
...
<Expandable title="¿Funciona con múltiples tiendas o números?">
...
<Expandable title="¿Qué significa el estado de calidad de WhatsApp?">
...
<Expandable title="¿Cómo afecta la regla de 24 horas de WhatsApp?">
