...
<Steps>
  ...
  <Step title="Configurar el nombre y la categoría">
  ...
  <Step title="Diseñar el cuerpo del mensaje">
  ...
  <Step title="Agregar tarjetas multimedia">
  ...
  <Step title="Configurar botones por tarjeta">
...
<Steps>
  <Step title="Integrar tu tienda en línea">
  ...
  <Step title="Agregar productos a tu catálogo">
...
<Tabs>
  ...
  <Tab title="Inscribir en Secuencia">
...
<Columns cols="2">
  <Card title="Botón de Respuesta Rápida">
...
<Expandable title="La plantilla no se guarda por inconsistencia en botones">
...
<Expandable title="Plantilla rechazada por contenido publicitario engañoso">
...
<Expandable title="Los botones no funcionan correctamente">
...
<Expandable title="El contenido multimedia no se muestra">
...
<Expandable title="El carrusel no se envía en el flujo del bot">
...
<Expandable title="¿Cuánto tarda la aprobación de una plantilla?">
...
<Expandable title="¿Los carruseles funcionan en todas las versiones de WhatsApp?">
...
<Expandable title="¿Puedo editar una plantilla de carrusel después de creada?">
...
<Expandable title="¿Qué hago si mi cuenta tiene baja calificación de calidad?">
...
<Columns cols="2">
  <Card title="Caso de Uso: E-commerce">
  ...
  <Card title="Caso de Uso: Servicios Profesionales">
...
<Columns cols="3">
  ...
  <Card title="🎯 Llamada a la Acción">
...
<Update title="Nuevos límites de caracteres para plantillas multimedia" date="2025-06-23">
...
<Update title="Soporte mejorado para videos en carrusel" date="2025-03-15">
...
<Update title="Nueva integración de catálogo dinámico" date="2025-01-10">
