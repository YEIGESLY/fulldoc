...
<Update title="Actualización" date="2026-01-28">
...
<Steps>
<Step title="Empresa verificada en Facebook/Meta">
...
<Step title="Crear WhatsApp Cloud API">
...
<Expandable title="¿Qué es la ventana de 24 horas en WhatsApp?">
...
<Steps>
<Step title="Acceder al sitio">
Visita el sitio web de E-SMART360.
</Step>
<Step title="Completar el registro">
...
<Expandable title="Tipos de coincidencia de palabras clave">
...
<Tabs>
<Tab title="Componentes de entrada">
...
<Tab title="Componentes de acción">
...
<Tab title="Componentes de control">
...
<Columns cols="2">
<Card title="Ejemplo: Bot de atención al cliente">
```text
...
<Card title="Ejemplo: Bot de generación de leads">
```text
...
<Expandable title="¿Cómo funciona el seguimiento con etiquetas?">
...
<Columns cols="3">
<Card title="Flujo de seguimiento">
...
<Card title="Programación de seguimientos">
...
<Card title="Métricas de seguimiento">
...
<Expandable title="¿Puedo tener múltiples palabras clave para activar mi chatbot?">
...
<Expandable title="¿Qué hago si mi chatbot de WhatsApp no responde correctamente?">
...
<Expandable title="¿Puedo transferir una conversación del chatbot a un agente humano?">
...
<Expandable title="¿Necesito plantillas de mensaje de WhatsApp para los mensajes en secuencia?">
...
<Expandable title="¿Cómo puedo personalizar los mensajes de mi chatbot?">
...
<Expandable title="¿Los mensajes de secuencia pueden activarse por acciones del usuario?">
...
<Tab title="Hotelería y restaurantes">
...
<CodeGroup>
<CodeGroupItem title="Ejemplo de flujo condicional">
```mermaid
graph TD
...
<Expandable title="Mi chatbot no se activa con la palabra clave que configuré">
...
<Expandable title="Los botones interactivos no aparecen en WhatsApp">
**Posibles causas y soluciones:**
...
<Expandable title="WhatsApp marca mi mensaje como no entregado">
**Posibles causas y soluciones:**
...
<Expandable title="Mi flujo de secuencia no envía los mensajes programados">
**Posibles causas y soluciones:**
...
<Expandable title="¿Cuánto tiempo toma construir un chatbot completo?">
...
<Expandable title="¿Qué sucede si el chatbot no entiende la consulta del usuario?">
...
<Expandable title="¿E-SMART360 soporta mensajes multimedia en los chatbots?">
