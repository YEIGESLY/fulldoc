...
<Step title="Acceso a WhatsApp Cloud API (opcional)">
...
<Step title="Contenido del mensaje definido">
...
<Expandable title="¿Qué pasa si mi plantilla tiene contenido mixto?">
...
<Step title="Crea las variables de la plantilla (si las necesitas)">
...
<Step title="Completa el formulario de la plantilla">
...
<Step title="Espera la aprobación de WhatsApp">
...
<Step title="Utiliza la plantilla en tus comunicaciones">
...
<Expandable title="Ejemplo completo: Notificación de envío">
...
<Expandable title="Formato recomendado para imágenes">
...
<Expandable title="Lista de verificación antes de enviar una plantilla">
...
<Card title="Confirmación de cita con opciones">
...
<Expandable title="¿Puedo usar la misma plantilla para múltiples campañas?">
...
<Expandable title="¿Qué sucede si una plantilla aprobada es desaprobada después?">
...
<Expandable title="¿Puedo enviar plantillas a usuarios que no me han escrito primero?">
...
<Expandable title="¿Cuál es la diferencia entre crear la plantilla en E-SMART360 vs. WhatsApp Manager?">
...
<Expandable title="¿Qué hago si mi plantilla es rechazada por segunda vez?">
...
<Step title="Configura los destinatarios">
...
<Step title="Asigna los valores de las variables">
...
<Expandable title="¿Qué hacer si el botón 'Iniciar verificación' de Facebook aparece atenuado?">
...
<Update title="Nuevos límites de caracteres para plantillas de medios" date="Febrero 2025">
...
<Update title="Clasificación automática de plantillas mixtas" date="Enero 2025">
...
<Update title="Soporte para botones de acción dinámicos" date="Diciembre 2024">
