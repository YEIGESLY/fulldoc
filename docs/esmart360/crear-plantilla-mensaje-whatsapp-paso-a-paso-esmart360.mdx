...
<Steps>
<Step title="Cuenta de WhatsApp Business conectada">
...
<Step title="Acceso a WhatsApp Cloud API">
...
<Step title="Contenido claro del mensaje">
...
<Tab title="Buenas prácticas para nombres">
...
<Step title="Texto del pie de página (opcional)">
...
<Card title="Botones de Número de Teléfono">
...
<Expandable title="Ejemplos de plantillas de utilidad">
...
<Expandable title="Ejemplos de plantillas de marketing">
...
<Tabs>
<Tab title="Transmisiones (Broadcasting)">
...
<Tab title="Integraciones (Shopify y WooCommerce)">
...
<Tab title="Flujos de bot automatizados">
...
<Expandable title="Ejemplo de plantilla con variables múltiples">
```
...
<Steps>
<Step title="Crear en WhatsApp Manager">
...
<Step title="Sincronizar con E-SMART360">
...
<Expandable title="¿Cuánto tiempo tarda en aprobarse una plantilla?">
...
<Expandable title="¿Puedo editar una plantilla después de aprobada?">
...
<Expandable title="¿Puedo usar plantillas para WhatsApp Flows?">
...
<Expandable title="Error: La plantilla no se entrega a los clientes">
...
<Expandable title="Error código 130472: El número está en un experimento">
...
<Steps>
<Step title="Configurar respuesta fuera de horario">
...
<Step title="Seleccionar plantilla adecuada">
...
<Step title="Asignar recordatorio al agente">
...
<Expandable title="Ejemplo: Envío masivo con datos de Google Sheets">
...
<Expandable title="¿Puedo usar emojis en las plantillas de mensaje?">
...
<Expandable title="¿Cómo puedo hacer seguimiento al rendimiento de mis plantillas?">
...
<Expandable title="¿Las plantillas funcionan con WhatsApp Business App (no API)?">
...
<Expandable title="¿Qué costo tiene cada envío de plantilla?">
