...
<Steps>
  ...
  <Step title="Haz clic en Sincronizar">
  ...
  <Step title="Verifica las plantillas sincronizadas">
...
<Tabs>
  <Tab title="Variables existentes">
...
<Columns cols="2">
  <Card title="Pie de página (Footer)">
    - Hasta **60** caracteres
...
<Columns cols="3">
  ...
  <Card title="Mayor Tasa de Entrega">
...
<Expandable title="Variables sin contexto">
...
<Expandable title="Nombre de plantilla poco claro">
...
<Expandable title="Contenido que no explica el uso de la plantilla">
...
<Expandable title="Texto usado dentro de variables incorrectamente">
...
<Expandable title="Errores de sintaxis en variables">
...
<Expandable title="Líneas vacías en el contenido">
...
<Expandable title="Errores ortográficos o jerga informal">
...
<Expandable title="Error: La plantilla no aparece después de sincronizar">
...
<Expandable title="Error: Variables no mapeadas correctamente">
...
<Expandable title="Error: El botón no funciona en el mensaje enviado">
...
<CodeGroup>
<CodeGroupItem title="Ejemplo de plantilla de bienvenida">
```
Hola {{1}},
...
<CodeGroupItem title="Ejemplo de plantilla de pedido">
```
Hola {{1}},
...
<Columns cols="2">
  <Card title="Confirmación de Pedido Automatizada">
  ...
  <Card title="Recordatorio de Citas con Variables Dinámicas">
...
<Expandable title="¿Puedo tener múltiples versiones de la misma plantilla?">
...
<Expandable title="¿Cuánto tarda WhatsApp en aprobar una plantilla actualizada?">
...
<Expandable title="¿Qué pasa si uso una plantilla rechazada después de haber sido aprobada?">
...
<Expandable title="¿Puedo eliminar una plantilla desvinculada de E-SMART360?">
...
<Expandable title="¿Las plantillas actualizadas afectan campañas de broadcast en curso?">
...
<Update title="Última actualización" date="7 de mayo de 2026">
