...
<Update title="Actualización importante" date="2026-05-08">
...
<Callout type="warning" title="¿Tu bot de WhatsApp dejó de responder?">
...
<Columns cols="2">
<Card title="🔗 Problemas de conexión">
...
<Card title="💳 Problemas de facturación">
...
<Columns cols="2">
<Card title="📊 Problemas de límites">
...
<Card title="⚙️ Problemas de configuración">
...
<Steps>
<Step title="Inicia sesión en Meta Developers">
...
<Callout type="tip" title="¿No encuentras tu app?">
...
<Step title="Navega a WhatsApp Configuration">
...
<Steps>
<Step title="Obtén tu URL de webhook desde E-SMART360">
...
<Callout type="warning" title="URL correcta">
...
<Step title="Copia la URL en Meta Developers">
...
<Step title="Ingresa el token de verificación">
...
<Callout type="danger" title="El token debe coincidir EXACTAMENTE">
...
<Step title="Haz clic en Verify and Save">
...
<Expandable title="Error: URL not reachable">
...
<Expandable title="Error: Verify token does not match">
...
<Callout type="warning" title="Este paso es el más olvidado">
...
<Card title="Eventos para sincronización">
...
<Callout type="success" title="Verificación final">
...
<Expandable title="Explicación detallada de cada evento">
...
<Callout type="tip" title="Acceso directo">
...
<Step title="Encuentra tu WhatsApp Business Account">
...
<Step title="Revisa si hay método de pago">
...
<Step title="Completa ambos pasos de configuración">
...
<Callout type="warning" title="Ambos pasos son obligatorios">
...
<Callout type="info" title="Documentos aceptados por Meta">
...
<Callout type="warning" title="Cuenta suspendida">
...
<Steps>
<Step title="Identifica un número fallido">
...
<Step title="Confirma el número emisor">
...
<Step title="Busca el mensaje específico">
...
<Card title="Errores de plantilla">
...
<Steps>
<Step title="Crea un usuario del sistema">
...
<Callout type="warning" title="La calidad importa">
...
<Expandable title="Cómo revisar la calidad de mi cuenta">
...
<Columns cols="2">
<Card title="Conversaciones de Marketing">
...
<Card title="Conversaciones de Utilidad">
- **Iniciadas por**: El negocio
...
<Columns cols="2">
<Card title="Conversaciones de Servicio">
...
<Card title="Conversaciones de Autenticación">
- **Iniciadas por**: El negocio
...
<Callout type="tip" title="Optimiza tus costos">
...
<Callout type="info" title="Prueba de conectividad">
...
<Expandable title="Soluciones para respuestas duplicadas">
...
<Expandable title="Cómo resolver error 131005">
...
<Callout type="warning" title="Error 131026">
...
<Expandable title="Razones comunes de rechazo de plantillas">
...
<Card title="Caso 2: Agencia de marketing">
...
<Columns cols="2">
<Card title="Caso 3: Restaurante local">
...
<Card title="Caso 4: Empresa de servicios financieros">
...
<Expandable title="¿Por qué mi bot de WhatsApp dejó de funcionar de repente si antes funcionaba bien?">
...
<Expandable title="¿Cuánto tiempo tarda en reflejarse un cambio en la configuración del webhook?">
...
<Expandable title="¿Qué hago si mi bot responde pero con mucho retraso (más de 10 segundos)?">
...
<Expandable title="¿Puedo usar el mismo webhook para varias cuentas de WhatsApp?">
...
<Expandable title="¿Qué significa el error Account suspended y cómo lo resuelvo?">
...
<Expandable title="¿Cómo calcula Meta las tarifas de conversación?">
...
<Callout type="success" title="¿Todo en orden?">
