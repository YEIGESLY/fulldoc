...
<Steps>
<Step title="Accede a tu cuenta de desarrollador de Facebook">
...
<Step title="Selecciona o crea la aplicación principal">
...
<Step title="Agrega números de teléfono adicionales">
...
<Step title="Configura un solo webhook">
...
<Step title="Verifica la recepción de mensajes">
...
<Expandable title="Ejemplo de integración problemática">
...
<Columns cols="2">
<Card title="Mantenimiento Semanal">
...
<Card title="Mantenimiento Mensual">
...
<Expandable title="Guía rápida: Cómo verificar tu Business Manager">
...
<Expandable title="¿Puedo tener el mismo webhook en dos aplicaciones de Facebook diferentes si uso diferentes números de teléfono?">
...
<Expandable title="¿Cuántos números de teléfono puedo agregar a una sola aplicación de Facebook?">
...
<Expandable title="¿El problema de duplicación puede ocurrir incluso con una sola aplicación de Facebook?">
...
<Expandable title="¿Cómo puedo verificar si mi webhook se está activando múltiples veces?">
...
<Expandable title="¿Quitar el webhook de una aplicación de Facebook afecta otros servicios?">
...
<Expandable title="¿Qué hago si mi cuenta de WhatsApp Business tiene calificación baja y eso causa problemas de entrega?">
...
<Expandable title="¿Puedo usar una misma URL de webhook para servicios diferentes como WhatsApp y Messenger?">
...
<Expandable title="¿Cómo sé si mi problema es por múltiples aplicaciones o por superposición de reglas?">
...
<Expandable title="¿El problema de duplicación también afecta a las plantillas de mensajes?">
...
<Expandable title="¿E-SMART360 tiene protección contra respuestas duplicadas?">
...
<Card title="Optimización de Reglas del Bot">
...
<Columns cols="2">
<Card title="Gestión de Múltiples Números">
...
<Card title="Mantenimiento y Monitoreo Proactivo">
