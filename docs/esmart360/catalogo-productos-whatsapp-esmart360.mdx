...
<Steps>
<Step title="Cuenta de Negocio en Facebook Business Manager">
...
<Step title="Número de WhatsApp Business API">
...
<Step title="Productos definidos y preparados">
...
<Expandable title="Diferencias entre WhatsApp Business App y WhatsApp Business API">
...
<Expandable title="Consejos para imágenes de productos en WhatsApp">
...
<Step title="Verifica la sincronización">
...
<Columns cols="3">
<Card title="🔍 Navegación intuitiva">
...
<Card title="📱 Experiencia móvil nativa">
...
<Step title="Conecta el catálogo al chatbot">
...
<Step title="Configura respuestas inteligentes">
...
<Step title="Activa el flujo de ventas">
...
<Expandable title="Ejemplo: Flujo de ventas automatizado para una tienda de ropa">
...
<Columns cols="2">
<Card title="📦 Tienda de Electrónica - Caso de Éxito">
...
<Card title="🛍️ Tienda de Ropa - Caso de Éxito">
...
<Expandable title="¿Cómo creo un catálogo de productos en WhatsApp paso a paso?">
...
<Expandable title="¿Hay un límite en la cantidad de productos que puedo agregar?">
...
<Expandable title="¿Qué tipos de productos puedo incluir en el catálogo?">
...
<Expandable title="¿Necesito conocimientos técnicos para usar E-SMART360 con mi catálogo?">
...
<Expandable title="¿Puedo conectar mi tienda WooCommerce o Shopify al catálogo?">
...
<Expandable title="¿Puedo tener múltiples catálogos para diferentes líneas de productos?">
...
<Expandable title="¿Cómo se comparte el catálogo en una conversación de WhatsApp?">
...
<Expandable title="¿Qué sucede si un cliente quiere comprar pero no tengo sistema de pago integrado?">
...
<Update title="Actualización de la guía de catálogo de productos" date="2025-03-06">
