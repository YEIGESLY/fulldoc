...
<Update title="Novedades en esta guía" date="Mayo 2026">
...
<Tabs>
<Tab title="Ejemplo: Plantilla de Confirmación">
```
Cuerpo del mensaje:
...
<Tab title="Ejemplo: Plantilla de Notificación de Pedido">
```
Cuerpo del mensaje:
...
<Tab title="Ejemplo: Plantilla de Cita Agendada">
```
Cuerpo del mensaje:
...
<Expandable title="¿Qué es un webhook y cómo funciona en este contexto?">
...
<Columns cols="2">
<Card title="📋 Lista de Verificación">
...
<Card title="🛠️ Ejemplo: Formulario de Contacto">
...
<Tabs>
<Tab title="Configuración HTTP API">
...
<Columns cols="2">
<Card title="📞 Solicitud de Contacto">
...
<Card title="🛒 Solicitud de Compra">
...
<Expandable title="El webhook no recibe datos de WPForms">
...
<Expandable title="Meta rechazó mi plantilla de mensaje">
**Causas frecuentes:**
...
<Expandable title="El mensaje de WhatsApp no llega al destinatario">
**Posibles causas:**
...
<Expandable title="Error 130472: El número forma parte de un experimento">
...
<Expandable title="El mapeo de campos no funciona correctamente">
**Causas y soluciones:**
...
<Columns cols="2">
<Card title="🏢 Negocio de Servicios Profesionales">
...
<Card title="🛍️ Tienda en Línea (E-commerce)">
...
<Columns cols="2">
<Card title="🏥 Clínica o Consultorio Médico">
...
<Card title="🎓 Plataforma Educativa">
...
<Expandable title="¿Necesito la versión Pro de WPForms obligatoriamente?">
...
<Expandable title="¿Puedo enviar mensajes de WhatsApp sin usar una plantilla aprobada?">
...
<Expandable title="¿Qué sucede si el webhook falla por algún motivo?">
...
<Expandable title="¿Puedo integrar otros plugins de formularios además de WPForms?">
...
<Expandable title="¿Puedo enviar mensajes con imágenes o videos adjuntos?">
...
<Expandable title="¿Cómo puedo ver el historial de mensajes enviados por esta automatización?">
...
<Expandable title="¿Esta integración funciona para formularios en otros idiomas?">
...
<Steps>
<Step title="Exporta tus plantillas de mensaje">
...
<Step title="Monitorea los primeros días">
