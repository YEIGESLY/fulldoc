---
title: "Cómo configurar el menú persistente en el chatbot de tu sitio web"
description: "Guía completa para implementar un menú persistente en el chatbot de tu sitio web con E-SMART360. Aprende a mejorar la navegación, la experiencia de usuario y la accesibilidad de tu chat web con opciones configurables, soporte multi-idioma y personalización avanzada."
---
...
<Tabs>
<Tab title="Opciones configurables">
...
<Tab title="Personalización visual">
...
<Tab title="Comportamiento avanzado">
...
<Steps>
<Step title="Accede al WebChat Bot Manager">
...
<Step title="Crea un nuevo menú persistente">
...
<Step title="Configura las opciones del menú">
...
<Step title="Personaliza la experiencia del usuario (opcional)">
...
<Step title="Configura opciones multi-idioma">
...
<Step title="Guarda, publica y prueba">
...
<Columns cols="3">
<Card title="Accesibilidad mejorada">
...
<Card title="Navegación optimizada">
...
<Card title="Soporte multi-idioma nativo">
...
<Expandable title="El chatbot no aparece en mi sitio web después de la integración">
...
<Expandable title="Las opciones del menú persistente no se actualizan en el sitio">
...
<Card title="Funcionalidades del chat">
...
```mermaid
flowchart TD
    A[Visitante llega al sitio web] --> B[Se abre el chat widget]
    B --> C[Mensaje de bienvenida automático]
    C --> D[Menú persistente visible con opciones]
    D --> E{Usuario selecciona una opción}

    E -->|"🔍 Ver productos"| F[URL: Catálogo de productos]
    E -->|"💬 Preguntar al bot"| G[Postback: El bot pregunta qué necesita]
    E -->|"📞 Hablar con agente"| H[Derivación a soporte humano]
    E -->|"❓ Ayuda o FAQ"| I[Postback: Muestra preguntas frecuentes]
    E -->|Escribe manualmente| J[IA procesa el mensaje]

    F --> K[Usuario navega productos en tienda]
    G --> L[Flujo de preguntas guiadas del bot]
    H --> M[Agente humano toma el control del chat]
    I --> N[Despliega lista de preguntas frecuentes]
    J --> O{Bot puede responder la consulta?}

    L --> P[Se capturan datos del usuario en el sistema]
    P --> Q[Los datos se almacenan automáticamente en CRM]

    O -->|Sí| R[Respuesta automática generada por IA]
    O -->|No| S[Derivación inteligente a agente humano]

    K --> T{¿El usuario regresa al chat?}
    M --> T
    N --> T
    R --> T
    S --> T

    T -->|Sí| U[Menú persistente sigue disponible para el usuario]
    T -->|No| V[Fin de la sesión de chat]
    U --> D
```
...
<Columns cols="2">
<Card title="📋 Estructura del menú">
...
<Card title="🎯 Optimización de conversión">
...
<Expandable title="¿Qué es un menú persistente en un chatbot de IA para sitios web?">
...
<Expandable title="¿Cómo configuro el menú persistente en mi chatbot web paso a paso?">
...
<Expandable title="¿Por qué necesito un menú persistente para mi chatbot de IA?">
...
<Expandable title="¿Cómo beneficia un menú persistente a un chatbot de comercio electrónico?">
...
<Expandable title="¿Se puede crear un chatbot que incluya menú persistente en el sitio web?">
...
<Expandable title="¿Qué opciones debería incluir en el menú persistente de mi chatbot?">
...
<Expandable title="¿Qué es un chatbot de sitio web y cómo funciona?">
...
<Expandable title="¿Por qué debería usar un chatbot de IA en mi sitio web?">
...
<Expandable title="¿Cómo personalizo un chatbot para manejar múltiples idiomas?">
...
<Expandable title="¿Hay plugins de chat gratuitos para sitios web?">
...
<Expandable title="¿Puedo configurar un plugin de chat de WhatsApp para mi sitio web?">
...
<Expandable title="¿Puedo enviar y recibir mensajes a través del chat en vivo del sitio web?">
...
<Update title="Mejora en la personalización visual del menú persistente" date="24 Jun 2025">
...
<Update title="Soporte multi-idioma en menú persistente" date="15 May 2025">
...
<Update title="Nueva función de desactivación de entrada de texto" date="10 Abr 2025">
...
<Update title="Analíticas integradas para el menú persistente" date="20 Mar 2025">
...
```mermaid
flowchart LR
    A[Visitante] --> B[Menú Persistente]
    B --> C[Opción seleccionada]
    C --> D{¿Es postback o URL?}
    D -->|Postback| E[IA procesa la intención]
    D -->|URL| F[Redirección a página]
    E --> G[Base de conocimiento]
    E --> H[Respuesta personalizada]
    H --> I{¿Respuesta satisfactoria?}
    I -->|Sí| J[Fin de la interacción]
    I -->|No| K[Derivación a agente humano]
```
...
<Columns cols="3">
<Card title="🟢 WordPress + Elementor">
...
<Expandable title="El menú persistente no se muestra en dispositivos móviles">
Verifica los siguientes puntos:
...
<Expandable title="Los postbacks del menú persistente no ejecutan respuestas automáticas">
...
<Expandable title="¿Cómo puedo restablecer el menú persistente a su configuración predeterminada?">
...
<Expandable title="¿El menú persistente afecta el rendimiento de carga de mi sitio web?">
