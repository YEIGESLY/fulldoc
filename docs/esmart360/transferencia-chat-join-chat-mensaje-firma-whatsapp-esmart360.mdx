...
<Steps>
  ...
  <Step title="Presiona el Botón Unirse al Chat">
  ...
  <Step title="La Bandeja se Recarga Automáticamente">
...
<Columns cols="3">
  ...
  <Card title="🔧 Escalamiento Técnico">
...
<Columns cols="2">
  <Card title="🙋‍♂️ Solicitud del Cliente">
  ...
  <Card title="🤝 Colaboración Interna">
...
<Steps>
  <Step title="Inicia sesión y accede al Bot Manager">
  ...
  <Step title="Ve a la Configuración">
  ...
  <Step title="Encuentra la Sección de Mensaje de Firma">
  ...
  <Step title="Redacta tu Mensaje Predeterminado">
  ...
  <Step title="Usa Variables Dinámicas">
  ...
  <Step title="Personalización por Agente (Opcional)">
...
<Columns cols="3">
  ...
  <Card title="🤖 Bot prepara respuesta">
...
<Expandable title="Ver más detalles sobre Abandonar Chat">
...
<Steps>
  <Step title="Únete a un Chat de Prueba">
  ...
  <Step title="Verifica desde la Perspectiva del Cliente">
  ...
  <Step title="Ajusta si es Necesario">
...
<Columns cols="2">
  <Card title="👁️ Visualización de Conversaciones Activas">
  ...
  <Card title="🏷️ Etiquetas y Filtros">
  ...
  <Card title="🔔 Notificaciones en Tiempo Real">
...
<Expandable title="1. Establece Horarios de Atención y Mensajes Automáticos Fuera de Horario">
...
<Expandable title="2. Usa Respuestas Rápidas y Plantillas">
...
<Expandable title="3. Prioriza por Urgencia y Tipo de Consulta">
...
<Expandable title="4. Capacita a tu Equipo en el Protocolo de Transferencias">
...
<Expandable title="5. Monitorea las Métricas de Desempeño">
...
<Expandable title="¿Por qué es importante la transferencia de conversaciones?">
...
<Expandable title="¿Qué es la Bandeja Compartida de E-SMART360?">
...
<Expandable title="¿Cómo ayuda la función 'Unirse al Chat' en la colaboración del equipo?">
...
<Expandable title="¿Puede el administrador rastrear las transferencias de conversaciones?">
...
<Expandable title="¿Cuáles son los beneficios de usar el Mensaje de Firma?">
...
<Expandable title="¿Qué sucede cuando se presiona el botón 'Unirse al Chat'?">
...
<Expandable title="¿Puedo desactivar la función de Mensaje de Firma?">
...
<Expandable title="¿Puedo personalizar el Mensaje de Firma para cada agente?">
...
<Expandable title="¿Qué es un Mensaje de Firma (Signature Message)?">
...
<Expandable title="¿Se puede actualizar la firma después de configurarla?">
...
<Expandable title="¿Qué sucede cuando el Mensaje de Firma está habilitado y un bot intenta responder?">
...
<Expandable title="¿Puede un agente abandonar el chat si ya no es necesario?">
...
<Steps>
  <Step title="Activa Join Chat desde el Día 1">
  ...
  <Step title="Configura un Mensaje de Firma General">
  ...
  <Step title="Cada Agente Personaliza su Firma">
  ...
  <Step title="Programa una Capacitación de 15 Minutos">
...
<Columns cols="2">
  <Card title="📌 Marcar Conversación">
  ...
  <Card title="⏰ Recordatorio de Seguimiento">
  ...
  <Card title="📎 Compartir Archivos Adjuntos">
  ...
  <Card title="🎵 Audio y Video Incrustados">
...
<Columns cols="2">
  <Card title="🔗 Integración con Google Sheets">
  ...
  <Card title="⚡ Integración con Webhooks">
  ...
  <Card title="📊 Reportes y Analytics">
...
<Expandable title="¿Qué hacer si los mensajes no se envían?">
...
<Expandable title="¿Puedo reasignar conversaciones a diferentes agentes?">
...
<Expandable title="¿Cómo recuperar una conversación archivada?">
...
<Expandable title="¿Cómo gestionar mensajes de spam?">
...
<Columns cols="2">
  <Card title="✅ Organización Diaria">
