...
<Step title="Edita el botón de acciones">
...
<Steps>
<Step title="Accede a la configuración del número">
...
<Expandable title="Ejemplo de mensaje de bienvenida efectivo">
...
<Steps>
<Step title="Accede a la configuración de WhatsApp Cloud API">
Ve al panel de **WhatsApp Manager** y selecciona el número de teléfono de tu bot.
</Step>
<Step title="Agrega preguntas de rompehielos">
...
<Step title="Crea los bots con las preguntas como palabras clave">
...
<Step title="Crea los bots asociados a cada comando">
...
<Step title="Configura las respuestas de cada comando">
...
<Expandable title="Comandos recomendados para negocios">
| Comando | Descripción |
|---------|-------------|
...
<Columns cols="2">
<Card title="Flujo: Envío por zona">
...
<Card title="Flujo: Sucursal más cercana">
...
<Step title="Selecciona No Match Reply">
...
<Columns cols="2">
<Card title="Secuencia: Bienvenida para nuevos leads">
...
<Card title="Secuencia: Recuperación de carrito">
...
<Expandable title="¿Puedo tener diferentes mensajes de bienvenida para diferentes canales?">
...
<Expandable title="¿Los mensajes de bienvenida cuentan dentro de la ventana de 24 horas?">
...
<Expandable title="¿Puedo desactivar el mensaje de bienvenida sin perder la configuración?">
...
<Expandable title="¿Cuántos rompehielos o comandos puedo tener?">
...
<Expandable title="¿Puedo usar variables personalizadas en los mensajes de bienvenida?">
...
<Expandable title="¿Qué hago si el botón de ubicación no aparece para algunos usuarios?">
...
<Expandable title="¿Los comandos distinguen entre mayúsculas y minúsculas?">
...
<Card title="Rompehielos y comandos">
...
<Expandable title="Recomendaciones adicionales para optimizar tu chatbot">
...
<Expandable title="Términos clave de la guía">
