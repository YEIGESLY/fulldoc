...
<Update title="Última actualización de esta guía" date="6 de mayo de 2026">
...
<Steps>
<Step title="Tener una cuenta activa en E-SMART360">
...
<Step title="Tener WooCommerce instalado y funcionando">
...
<Step title="Contar con una plantilla de mensaje de WhatsApp aprobada por Meta">
...
<Step title="Navegador actualizado">
...
<Steps>
<Step title="Accede al panel de Bot Manager">
...
<Step title="Localiza la sección de variables de plantilla">
...
<Step title="Crea la primera variable">
...
<Step title="Crea las variables restantes">
...
<Steps>
<Step title="Abre el creador de plantillas">
...
<Step title="Completa los campos del formulario">
...
<Step title="Ejemplo de cuerpo del mensaje">
```
¡Hola {{1}}!
...
<Step title="Verifica el estado de aprobación">
...
<Tabs>
<Tab title="Plantilla con botón CTA">
...
<Columns cols="2">
<Card title="📝 Recomendaciones de contenido">
...
<Steps>
<Step title="Accede al módulo Webhook Workflow">
...
<Step title="Configura el workflow">
...
<Step title="Guarda y obtén la URL del webhook">
...
<Step title="Ve a la configuración de WooCommerce">
...
<Step title="Añade un nuevo webhook">
...
<Step title="Ignora los datos de muestra iniciales">
...
<Step title="Genera un pedido real en WooCommerce">
...
<Step title="Recupera los datos reales en E-SMART360">
...
<Steps>
<Step title="Configura el campo de número de teléfono">
...
<Step title="Crea un formateador para eliminar el signo +">
...
<Step title="Configura la lista de productos">
...
<Step title="Configura el precio total">
...
<Step title="Configura la fecha de entrega">
...
<Steps>
<Step title="Realiza un pedido de prueba">
...
<Step title="Revisa el Webhook Report">
...
<Step title="Comprueba la llegada del mensaje">
...
<Columns cols="2">
<Card title="📱 Ejemplo de notificación">
...
<Card title="🛒 Otros eventos útiles">
...
<Expandable title="¿Cómo solucionar el error de método de pago (Código 131042)?">
...
<Expandable title="El webhook no captura la respuesta del pedido">
...
<Expandable title="¿Por qué Meta rechazó mi plantilla?">
...
<Expandable title="Los datos aparecen con formato incorrecto en el mensaje">
...
<Expandable title="El número de teléfono no se encuentra en los datos">
...
<Expandable title="La cuenta de WhatsApp no está vinculada a E-SMART360">
**Solución:**
...
<Expandable title="Los mensajes de notificación están siendo marcados como spam">
...
<Expandable title="No encuentro la opción de Webhooks en WooCommerce">
...
<Expandable title="¿Por qué debería enviar notificaciones de pedidos por WhatsApp?">
...
<Expandable title="¿Qué variables debería usar en la plantilla?">
...
<Expandable title="¿Puedo probar el webhook antes de ponerlo en producción?">
...
<Expandable title="¿Cuánto tiempo tarda en llegar la notificación de WhatsApp?">
...
<Expandable title="¿Puedo enviar notificaciones cuando el pedido cambia de estado?">
...
<Expandable title="¿Qué hago si mi plantilla no se aprueba?">
...
<Expandable title="¿Puedo personalizar el mensaje para cada cliente?">
...
<Expandable title="¿Qué pasa si el número de teléfono del cliente tiene el formato incorrecto?">
...
<Expandable title="¿Puedo usar esta misma configuración para Shopify?">
...
<Update title="Historial de actualizaciones" date="6 de mayo de 2026">
