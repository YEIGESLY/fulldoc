...
<Card title="🖼️ Contenido Multimedia Preparado">
...
<Card title="🛒 Tienda en Línea (Opcional)">
...
<Card title="🔑 Acceso al Panel de Control">
...
<Step title="Inicia la creación de una nueva plantilla">
...
<Step title="Configura los datos generales de la plantilla">
...
<Step title="Agrega y configura las tarjetas del carrusel">
...
<Step title="Configura los detalles de cada botón">
...
<Step title="Envía la plantilla para aprobación de WhatsApp">
...
<Step title="Configura el bot para usar la plantilla aprobada">
...
<Step title="Prueba el funcionamiento completo del carrusel">
...
<Steps>
<Step title="Integra tu tienda en línea con E-SMART360">
...
<Step title="Crea la plantilla de carrusel de productos">
...
<Step title="Configura los botones de acción para los productos">
...
<Step title="Envía a aprobación e integra en tu bot">
...
<Steps>
<Step title="Crea un flujo de bot con botón CTA">
...
<Step title="Personaliza el botón CTA URL">
...
<Step title="Envía el botón CTA desde el chat en vivo (opcional)">
...
<Columns cols="2">
<Card title="🔘 Tipos de Botones Disponibles">
...
<Card title="🎯 Acciones que Pueden Desencadenar los Botones">
...
<Card title="🖼️ Imágenes de Alta Calidad">
...
<Card title="✍️ Texto Conciso y Enfocado">
...
<Card title="🧪 Prueba Antes de Publicar">
...
<Card title="📊 Analiza el Rendimiento">
...
<Columns cols="2">
<Card title="🛍️ Tienda de Ropa y Moda">
...
<Card title="🍕 Restaurante con Menú Digital">
...
<Update title="Novedad: Integración mejorada con catálogos de e-commerce" date="2025-06-15">
...
<Expandable title="¿Por qué mi plantilla de carrusel no se guarda?">
...
<Expandable title="¿Cuánto tiempo tarda la aprobación de una plantilla por WhatsApp?">
...
<Expandable title="¿Puedo enviar plantillas de carrusel en transmisiones masivas (broadcasts)?">
...
<Expandable title="¿Puedo mezclar imágenes y videos en un mismo carrusel?">
...
<Expandable title="¿Necesito tener una tienda en línea para usar la plantilla de carrusel de productos?">
...
<Expandable title="¿Cuántas tarjetas puedo incluir en un carrusel y cuál es el número recomendado?">
...
<Expandable title="¿Qué hago si mi plantilla fue rechazada?">
...
<Expandable title="¿Los placeholders funcionan en las plantillas de carrusel?">
...
<Callout type="danger" title="La plantilla no se envía">
...
<Callout type="danger" title="Los botones del carrusel no funcionan">
**Posibles causas y sus soluciones:**
...
<Callout type="danger" title="El contenido multimedia no se muestra en el carrusel">
**Posibles causas y sus soluciones:**
...
<Card title="📚 Artículos Relacionados">
...
<Columns cols="2">
<Card title="✅ Contenido Permitido">
...
<Card title="❌ Contenido Prohibido">
...
<Update title="Próximamente: Carrusel con productos recomendados por IA" date="2025-07-01">
