...
<Step title="Tienda WooCommerce activa con webhooks habilitados">
...
<Step title="Número de WhatsApp Business conectado">
...
<Step title="Plantilla de mensaje WhatsApp aprobada">
...
<Steps>
<Step title="Configurar botones en la plantilla">
...
<Step title="Verificar estado de aprobación">
...
<CodeGroup>
<CodeGroupItem title="Ejemplo de URL">
```
...
<Columns cols="2">
<Card title="Escenario 1: Pedido con tarjeta de crédito">
...
<Card title="Escenario 2: Pedido COD sin botones">
...
<Tabs>
<Tab title="Descuento por Porcentaje">
...
<Columns cols="2">
<Card title="Ejemplo 1: Tienda de Ropa">
...
<Card title="Ejemplo 2: Tienda de Electrónicos">
...
<Steps>
<Step title="Crear plantilla con botones de confirmación">
...
<Step title="Mapear precio total">
...
<Step title="Configurar Callback API de confirmación">
...
<Expandable title="Error: El webhook no captura datos reales">
...
<Expandable title="Error: El mensaje de WhatsApp no se envía">
...
<Expandable title="Error 131042: Problema con el método de pago de WhatsApp">
...
<Expandable title="Error: El número de teléfono contiene signo +">
...
<Expandable title="Error: Los productos no aparecen en el mensaje">
...
<Expandable title="¿Qué es el Webhook Workflow de E-SMART360?">
...
<Expandable title="¿Cómo convierte E-SMART360 los pedidos COD en prepagados?">
...
<Expandable title="¿Qué plataformas se usan en esta integración?">
...
<Expandable title="¿Necesito plantillas de mensaje de WhatsApp?">
...
<Expandable title="¿Cómo identifica E-SMART360 los pedidos COD?">
...
<Expandable title="¿Puedo incluir los detalles de los productos en el mensaje de WhatsApp?">
...
<Expandable title="¿Este flujo de trabajo es completamente automático?">
...
<Expandable title="¿Qué límites de mensajería debo considerar?">
...
<Expandable title="Plantilla marcada como 'Contenido promocional excesivo'">
...
<Expandable title="Plantilla rechazada por 'Formato de URL incorrecto'">
...
<Expandable title="Plantilla rechazada por 'Variables incorrectas'">
...
<Expandable title="Plantilla rechazada por 'Sin propósito claro'">
...
<Steps>
<Step title="Crear un Flow en E-SMART360">
...
<Step title="Asociar el Flow a la plantilla">
...
<Step title="Configurar el webhook del Flow">
...
<Card title="Notificaciones de Estado de Pedido">
...
<Card title="Verificación de Pedidos COD con Confirmación">
