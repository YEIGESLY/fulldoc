...
<Expandable title="Ver más ejemplos de plantillas de utilidad">
...
<Expandable title="Ver directrices completas para plantillas de utilidad">
  **✅ Aceptado (Utilidad):**
...
<Steps>
  <Step title="Accede al módulo de plantillas">
  ...
  <Step title="Haz clic en 'Nueva Plantilla'">
  ...
  <Step title="Diseña el contenido de la plantilla">
  ...
  <Step title="Agrega variables si es necesario">
  ...
  <Step title="Revisa y envía a aprobación">
...
<Steps>
  <Step title="Crea la plantilla en el Administrador de WhatsApp">
  ...
  <Step title="Espera la aprobación en Meta">
...
<Expandable title="Más razones de rechazo y cómo solucionarlas">
...
<Steps>
  ...
  <Step title="Actualización o eliminación">
...
<Update title="Política de actualización de plantillas" date="2026-04-15">
...
<Expandable title="¿Qué hago si mi plantilla es rechazada por 'categoría incorrecta'?">
...
<Expandable title="¿Puedo usar plantillas en varios idiomas?">
...
<Expandable title="¿Qué sucede si una plantilla tiene baja calidad o genera muchos bloqueos?">
...
<Columns cols="2">
  <Card title="📚 Recursos relacionados">
