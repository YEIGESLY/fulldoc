...
<Columns cols="2">
<Card title="Notificaciones instantáneas">
...
<Card title="Verificación de COD">
...
<Step title="Crear una nueva integración">
Haz clic en **Nuevo** y selecciona **WooCommerce**.
</Step>
<Step title="Completar el formulario de conexión">
...
<Steps>
<Step title="Ir a la configuración de API">
...
<Step title="Configurar la clave">
...
<Step title="Pegar las claves en E-SMART360">
...
<Expandable title="Ejemplos de integración con Webhook Workflow">
...
<Steps>
<Step title="Ir al Gestor de Plantillas">
...
<Step title="Añadir botones de respuesta rápida">
...
<Step title="Guardar y sincronizar">
...
<Steps>
<Step title="Ir a Flujo de Trabajo Webhook">
...
<Step title="Añadir el webhook en WooCommerce">
...
<Step title="Capturar datos de respuesta">
...
<Step title="Configurar formateador para lista de productos">
...
<Step title="Configurar postbacks para los botones">
...
<Step title="Crear APIs de Callback">
...
<Step title="Añadir regla para pedidos COD">
...
<Step title="Probar la respuesta del cliente">
...
<Expandable title="Configurar la recuperación de carritos abandonados paso a paso">
...
<Expandable title="¿Qué permisos necesitan las claves de API de WooCommerce?">
...
<Expandable title="¿Qué debo ingresar como URL de Tienda en E-SMART360?">
Usa la URL exacta del sitio WordPress donde está instalado WooCommerce, incluyendo `https://`. Por ejemplo: `https://tutienda.com`.
</Expandable>

<Expandable title="¿E-SMART360 puede enviar actualizaciones de pedidos automáticamente?">
...
<Expandable title="¿Qué hago si el mensaje de WhatsApp no se envía?">
...
<Expandable title="¿Cuánto tiempo toma la configuración completa?">
...
<Expandable title="¿Puedo usar varias cuentas de WhatsApp para diferentes tiendas?">
...
<Card title="Caso 2: Tienda de electrónica">
...
<CodeGroup>
<CodeGroupItem title="Plantilla de pedido">
```
¡Hola {{1}}! 🎉
...
<Columns cols="3">
<Card title="Confirmación en 2 pasos">
...
<Card title="Incentivo al prepago">
...
<Card title="Recordatorio de entrega">
...
<Expandable title="¿Puedo usar E-SMART360 con múltiples tiendas WooCommerce?">
...
<Expandable title="¿E-SMART360 soporta pedidos con múltiples productos?">
...
<Expandable title="¿Cómo manejo los reembolsos automáticos?">
...
<Expandable title="¿Qué pasa si el cliente no responde al mensaje de verificación COD?">
...
<Columns cols="2">
<Card title="Nuevos compradores (1ra compra)">
...
<Card title="Compradores recurrentes (+3 compras)">
...
<Tab title="Contra reembolso (COD)">
...
<Expandable title="¿Qué pasa si WooCommerce no tiene un carrito abandonado nativo?">
...
<Expandable title="¿Cómo evito que los clientes reciban mensajes duplicados?">
...
<Expandable title="¿E-SMART360 puede manejar pedidos en múltiples monedas?">
...
<Expandable title="¿Qué hago si se me olvidó el Consumer Key o Consumer Secret?">
...
<Expandable title="¿Puedo probar la integración sin enviar mensajes reales?">
...
<Expandable title="¿E-SMART360 maneja cupones y descuentos de WooCommerce?">
