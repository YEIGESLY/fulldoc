---
title: "Configuración del Perfil de WhatsApp Business para la API de WhatsApp Cloud"
description: "Guía completa para configurar y personalizar el perfil de tu negocio en WhatsApp Cloud API desde E-SMART360. Aprende a cambiar foto, descripción, sitio web, dirección y mucho más para mantener una imagen profesional ante tus clientes."
---
...
<Steps>
  <Step title="Ingresa al panel de E-SMART360">
  ...
  <Step title="Ve a la sección de cuentas conectadas">
  ...
  <Step title="Selecciona el número deseado">
  ...
  <Step title="Haz clic en 'Ajustes de Perfil'">
...
<Steps>
  ...
  <Step title="Ve a Números de Teléfono">
...
```mermaid
graph TD
    A[Cuenta E-SMART360] --> B[Número Ventas]
    A --> C[Número Soporte]
    A --> D[Número Marketing]
    B --> B1[Perfil: Equipo Comercial]
    B --> B2[Foto: Logo Ventas]
    B --> B3[Descripción: Ofertas y promociones]
    C --> C1[Perfil: Soporte Técnico]
    C --> C2[Foto: Logo Soporte]
    C --> C3[Descripción: Ayuda y asistencia]
    D --> D1[Perfil: Marketing]
    D --> D2[Foto: Logo Corporativo]
    D --> D3[Descripción: Novedades y contenido]
```
...
<Tabs>
  ...
  <Tab title="Activar/Desactivar por Paquete">
...
<Columns cols="2">
  ...
  <Card title="Desde WhatsApp Manager (Meta)">
...
<Expandable title="¿Puedo cambiar la foto de perfil desde la aplicación móvil de WhatsApp si uso Cloud API?">
...
<Expandable title="¿Cuánto tiempo tardan en reflejarse los cambios en el perfil?">
...
<Expandable title="¿Qué tamaño y formato debe tener la foto de perfil?">
...
<Expandable title="¿La descripción del negocio tiene límite de caracteres?">
...
<Expandable title="¿Puedo tener diferentes perfiles para diferentes números de WhatsApp?">
...
<Expandable title="¿Qué es la categoría 'Vertical' y cómo elegir la correcta?">
...
<Columns cols="2">
  ...
  <Card title="Ejemplo 2: Consultoría Profesional">
...
<Tabs>
  ...
  <Tab title="Consistencia de Marca">
  ...
  <Tab title="Optimización para Conversión">
...
<Expandable title="Los cambios no se reflejan después de guardarlos">
...
<Expandable title="No veo la opción 'Ajustes de Perfil' en mi panel">
...
<Expandable title="¿Puedo usar emojis en la descripción del negocio?">
...
<Columns cols="2">
  <Card title="Cambios desde E-SMART360">
  ...
  <Card title="Cambios desde WhatsApp Manager">
...
<Steps>
  <Step title="Completitud del perfil">
  ...
  <Step title="Consistencia de la información">
  ...
  <Step title="Cumplimiento de políticas">
...
<Expandable title="¿Puedo tener una dirección diferente para cada número de WhatsApp?">
...
<Expandable title="¿Qué hago si mi perfil muestra información desactualizada?">
...
<Expandable title="¿Los cambios en el perfil afectan a los mensajes que ya tengo enviados?">
...
<Expandable title="¿Puedo usar el perfil de WhatsApp Cloud API en varios dispositivos simultáneamente?">
...
<Expandable title="¿Existe alguna restricción sobre la frecuencia con la que puedo cambiar la foto de perfil?">
