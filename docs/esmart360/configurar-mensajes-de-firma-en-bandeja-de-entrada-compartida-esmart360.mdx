...
description: "Aprende a configurar mensajes de firma personalizados en la bandeja de entrada compartida de E-SMART360. Garantiza comunicación profesional, consistente y personalizada en todos los canales: WhatsApp, Facebook, Instagram, Telegram y chat web."
---
...
<Steps>
  <Step title="Accede al Gestor del Bot">
  ...
  <Step title="Selecciona Configuración">
...
<Steps>
  <Step title="Localiza la sección de firma">
...
<Steps>
  <Step title="Ve a Configuración del Miembro">
  ...
  <Step title="Edita tu firma personal">
  ...
  <Step title="Añade datos de contacto opcionales">
...
<Expandable title="¿Por qué es importante el indicador de escritura?">
...
<Steps>
  ...
  <Step title="Prueba la transferencia entre agentes">
  ...
  <Step title="Revisa desde la perspectiva del cliente">
...
graph TD
    ...
    B -->|Sí| C[Bot responde con información general]
    B -->|No| D[Mensaje llega a bandeja compartida]
    C --> E[Cliente solicita agente humano]
    D --> F[Agente 1 se une al chat]
    E --> F
    F --> G[Agente 1 responde con su firma]
    G --> H{¿Puede resolver el caso?}
    H -->|Sí| I[Agente 1 resuelve y cierra]
    H -->|No, necesita transferencia| J[Agente 1 abandona el chat]
    J --> K[Agente 2 se une al chat]
    K --> L[Agente 2 responde con su firma]
    L --> M[Agente 2 resuelve el caso]
    I --> N[Conversación cerrada]
    M --> N
```
...
<Expandable title="¿Puedo actualizar la firma más adelante?">
...
<Expandable title="¿Qué sucede cuando activo el Mensaje de Firma?">
...
<Expandable title="¿Se pueden programar firmas diferentes según el horario?">
...
<Expandable title="¿Qué pasa si un agente no tiene configurada una firma personalizada?">
...
<Columns cols="2">
  <Card title="Ejemplo 1: Transferencia de soporte básico a técnico">
  ...
  <Card title="Ejemplo 2: Atención multicanal con firma unificada">
...
<Columns cols="2">
  <Card title="Ejemplo 3: Gestión de crisis con transferencia rápida">
  ...
  <Card title="Ejemplo 4: Atención postventa con firma informativa">
...
<Expandable title="¿Puedo usar emojis en los mensajes de firma?">
...
<Expandable title="¿Hay un límite de caracteres para la firma?">
...
<Expandable title="¿Puedo tener firmas diferentes según el idioma del cliente?">
...
<Expandable title="¿Los mensajes de firma afectan el rendimiento del chat?">
...
<Expandable title="¿Puedo desactivar la firma para conversaciones específicas?">
...
<Expandable title="¿Cómo afecta la firma al tiempo de respuesta del agente?">
...
<Update title="Nuevo: Indicador de Escritura en WhatsApp Cloud API" date="2025-06-15">
...
<Update title="Mejora: Variables dinámicas expandidas" date="2025-04-20">
...
<Expandable title="Cuantos agentes pueden trabajar simultaneamente en la bandeja compartida?">
...
<Expandable title="Se puede usar la bandeja compartida sin mensajes de firma?">
...
<Expandable title="Como se manejan las conversaciones fuera del horario laboral?">
...
<Expandable title="Los mensajes de firma aparecen en las notificaciones push?">
...
<Expandable title="Puedo exportar el historial de conversaciones con las firmas incluidas?">
