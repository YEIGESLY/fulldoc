...
<Tab title="Pie de página (Footer)">
- Hasta **60** caracteres
</Tab>
<Tab title="Botones">
...
<Tabs>
<Tab title="Paso 1: Localiza la plantilla">
...
<Tab title="Paso 4: Reenvía para aprobación">
...
<Steps>
<Step title="Crea la plantilla en WhatsApp Manager">
...
<Expandable title="¿Puedo editar una plantilla después de ser aprobada?">
...
<Expandable title="¿Qué pasa si mi plantilla está rechazada pero necesito usarla urgentemente?">
...
<Expandable title="¿Puedo usar el mismo nombre de plantilla para diferentes idiomas?">
...
<Expandable title="¿Las plantillas de utilidad tienen menos restricciones que las de marketing?">
...
<Expandable title="¿Qué hago si mi plantilla fue marcada como spam?">
...
<Expandable title="¿Las plantillas caducan o necesitan renovación periódica?">
...
<Columns cols="2">
<Card title="📦 Actualización de Plantilla de Confirmación de Pedido">
...
<Card title="📊 Campaña de Marketing con Ofertas Temporales">
