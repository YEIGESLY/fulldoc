...
<Update title="Actualización: Políticas de revisión de Meta" date="2025-06-18">
...
<Tab title="Desde WhatsApp Business Manager">
  <Steps>
    <Step title="Crea la plantilla en Meta">
...
<Columns cols="2">
<Card title="Problemas de Formato">
...
<Card title="Problemas de Contenido">
...
<Expandable title="1. Variables faltantes o llaves desbalanceadas">
...
<Expandable title="2. Caracteres especiales en variables">
...
<Expandable title="3. Variables no secuenciales">
...
<Expandable title="4. Espacios en blanco en el contenido">
...
<Columns cols="2">
<Card title="Utilidad: Confirmación de Pedido">
  **Categoría:** Utilidad
...
<Card title="Marketing: Oferta Especial">
  **Categoría:** Marketing
...
<Expandable title="¿Cuánto tiempo tarda Meta en aprobar una plantilla?">
...
<Expandable title="¿Puedo usar variables en el encabezado de la plantilla?">
...
<Expandable title="¿Qué ocurre si envío una plantilla con la categoría incorrecta?">
...
<Expandable title="¿Las plantillas aprobadas caducan o deben renovarse?">
...
<Expandable title="¿Puedo usar el mismo ID de plantilla después de un rechazo?">
...
<Expandable title="¿Cómo afecta el rechazo de plantillas a la calidad de mi cuenta?">
...
<Card title="Plantillas Multimedia">
...
<Card title="Plantillas con Botones">
...
<Expandable title="Uso de mayúsculas excesivas">
...
<Expandable title="Solicitar acciones imposibles">
...
<Expandable title="Exceso de signos de puntuación">
...
<Update title="Documentación actualizada" date="2025-06-18">
