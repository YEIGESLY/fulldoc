...
<Expandable title="¿Dónde encuentro mi Business Account ID y Access Token?">
...
<Steps>
  ...
  <Step title="Repetir para más botones">
...
<Expandable title="¿Cómo integrar un AI Agent en tu chatbot?">
...
<Columns cols="2">
  <Card title="🛒 Chatbot para tienda online">
  ...
  <Card title="🏨 Chatbot para hotel o restaurante">
...
<Steps>
  <Step title="Detectar el carrito abandonado">
  ...
  <Step title="Enviar mensaje de recordatorio">
  ...
  <Step title="Aplicar etiquetas para seguimiento">
  ...
  <Step title="Verificar compra y cerrar el ciclo">
...
<Expandable title="¿Realmente es posible crear un chatbot de WhatsApp gratis?">
...
<Expandable title="¿Se requiere conocimiento de programación para construir un chatbot de WhatsApp?">
...
<Expandable title="¿Puedo transferir una conversación del bot a un agente humano?">
...
<Expandable title="¿Puedo programar el envío de mensajes en diferido?">
...
<Expandable title="¿Cómo sé si mi chatbot está funcionando correctamente?">
