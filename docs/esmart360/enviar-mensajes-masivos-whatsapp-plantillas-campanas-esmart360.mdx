---
title: "Cómo enviar mensajes masivos por WhatsApp usando plantillas de mensaje"
description: "Guía completa para crear campañas de broadcasting en WhatsApp usando plantillas de mensaje aprobadas por Meta. Aprende a importar suscriptores, crear plantillas, lanzar campañas y rastrear resultados sin riesgo de bloqueo."
---
...
<Steps>
  ...
  <Step title="Agrega columnas personalizadas">
...
<Tabs>
  ...
  <Tab title="Ventana gratuita de 72 horas">
...
<Steps>
  <Step title="Accede a la sección de plantillas">
  ...
  <Step title="Añade variables personalizadas">
  ...
  <Step title="Añade pie de página y botones">
  ...
  <Step title="Guarda y espera aprobación">
...
<Steps>
  ...
  <Step title="Configura el flujo y guarda">
...
<Steps>
  <Step title="Selecciona la opción de 24 horas">
  ...
  <Step title="Configura el flujo del bot">
...
<Expandable title="¿Cómo crear campos personalizados para variables?">
...
<Expandable title="¿Cómo afecta la calificación de calidad a tus broadcasts?">
...
<Tabs>
  <Tab title="Nivel de Prueba (Trial)">
...
<Expandable title="Consejos profesionales para una progresión suave">
...
<Columns cols="2">
  <Card title="Recordatorios automatizados">
  ...
  <Card title="Actualizaciones de eventos">
  ...
  <Card title="Confirmaciones de pedido">
  ...
  <Card title="Recuperación de carritos abandonados">
...
<p>Dirigirse a los destinatarios por su nombre y compartir información relevante aumenta las tasas de respuesta hasta un 70%.</p>
</div>
<div class="border rounded-lg p-4 bg-green-50">
<h4 class="font-bold text-green-800">😊 Mejor Experiencia del Cliente</h4>
<p>La personalización hace que las interacciones se sientan más humanas y centradas en el cliente.</p>
</div>
<div class="border rounded-lg p-4 bg-purple-50">
<h4 class="font-bold text-purple-800">💰 Mejores Tasas de Conversión</h4>
<p>Los mensajes dirigidos generan resultados de marketing más efectivos y un mayor retorno de inversión.</p>
</div>
</div>

```mermaid
graph TD
    A[Preparar Lista de Contactos] --> B[Importar a E-SMART360]
    B --> C{¿Usuarios activos?}
    C -->|Sí: dentro 24h| D[Crear mensaje libre]
    C -->|No: fuera 24h| E[Crear Plantilla de Mensaje]
    E --> F[Esperar aprobación Meta]
    F --> G[Crear Campaña Broadcast]
    D --> G
    G --> H[Seleccionar Audiencia]
    H --> I[Programar o Enviar Ahora]
    I --> J[Rastrear Resultados]
    J --> K[Optimizar para próxima campaña]
```
...
<Expandable title="¿Los clientes necesitan guardar mi número para recibir un mensaje broadcast?">
...
<Expandable title="¿Puedo programar broadcasts para que salgan en una hora posterior?">
...
<Expandable title="¿Tengo que pagar a Meta por cada mensaje broadcast enviado?">
...
<Expandable title="¿Puedo agregar botones con clic a mis mensajes broadcast?">
...
<Expandable title="¿Qué hago si mi plantilla es rechazada?">
...
<Tabs>
  <Tab title="Conversaciones de Marketing">
  ...
  <Tab title="Conversaciones de Utilidad">
  ...
  <Tab title="Conversaciones de Autenticación">
  ...
  <Tab title="Conversaciones de Servicio">
...
<Expandable title="¿Cómo configurar la respuesta No Match en E-SMART360?">
...
<Steps>
  <Step title="Conecta tu Google Sheets">
  ...
  <Step title="Crea variables personalizadas">
...
<Expandable title="Ejemplo práctico: campaña segmentada por ubicación">
...
<Steps>
  ...
  <Step title="Crea una plantilla de carrito abandonado">
  ...
  <Step title="Configura el disparador automático">
  ...
  <Step title="Programa un recordatorio">
...
<Columns cols="2">
  <Card title="❌ No segmentar la audiencia">
  ...
  <Card title="❌ Ignorar la frecuencia de envío">
  ...
  <Card title="❌ No probar las plantillas antes de enviar">
  ...
  <Card title="❌ Enviar a números no verificados">
...
```mermaid
graph LR
    A[Planificar Campaña] --> B[Segmentar Audiencia]
    B --> C[Crear Plantilla]
    C --> D[Obtener Aprobación Meta]
    D --> E[Programar Envío]
    E --> F[Monitorear Resultados]
    F --> G{Resultados OK?}
    G -->|Sí| H[Escalar Campaña]
    G -->|No| I[Ajustar Estrategia]
    I --> B
    H --> J[Analizar y Documentar]
    J --> A
```
...
<Columns cols="2">
  <Card title="Día 1: Mensaje de bienvenida">
    **Plantilla:** Marketing
  ...
  <Card title="Día 3: Mensaje educativo">
    **Plantilla:** Marketing
  ...
  <Card title="Día 7: Oferta especial">
    **Plantilla:** Marketing
...
<Steps>
  ...
  <Step title="Crea una oferta irresistible">
...
<Expandable title="Configuración rápida de CTWA">
...
<Steps>
  <Step title="Crea una cuenta de Meta Business">
  ...
  <Step title="Configura tu número de WhatsApp Business">
...
<Columns cols="2">
  ...
  <Card title="E-SMART360 (WhatsApp API)">
...
<Expandable title="¿Cómo crear un campo personalizado paso a paso?">
...
<Expandable title="¿Cómo crear y asignar etiquetas?">
  1. Ve al **Gestor de Suscriptores** de WhatsApp
...
<Steps>
  <Step title="Revisa el informe de campaña">
  ...
  <Step title="Filtra los reenviables">
  ...
  <Step title="Haz clic en Reenviar">
...
<Columns cols="2">
  <Card title="Mi plantilla no se aprueba">
    **Posibles causas:**
  ...
  <Card title="Mis mensajes no se entregan">
    **Posibles causas:**
  ...
  <Card title="No puedo importar mi archivo CSV">
    **Posibles causas:**
  ...
  <Card title="Las variables no se reemplazan en mi mensaje">
    **Posibles causas:**
