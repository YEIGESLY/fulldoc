...
<Update title="Actualización importante" date="27 Mayo 2025">
...
<Steps>
<Step title="Accede a las cuentas conectadas">
...
<Step title="Selecciona Configuración de Perfil">
...
<Tabs>
<Tab title="Desde el Panel General">
...
<Tab title="Configuración por Paquete">
...
<Step title="Selecciona el número a configurar">
...
<Step title="Actualiza la descripción del negocio">
...
<Step title="Agrega o actualiza el sitio web">
...
<Step title="Edita información adicional">
...
<Card title="Ejemplos de Formato">
| Correcto ✓ | Incorrecto ✗ |
|------------|-------------|
...
<Expandable title="Visibilidad del nombre según el tipo de cuenta">
...
<Expandable title="La foto de perfil no se actualiza en WhatsApp">
...
<Expandable title="El estado (About) no se guarda">
...
<Expandable title="El nombre del negocio fue rechazado por Meta">
...
<Expandable title="La descripción se ve cortada o incompleta">
...
<Expandable title="Error: 'Profile update failed due to invalid parameters'">
...
<Card title="Campañas de Secuencia">
...
<Card title="Webhooks y Automatización">
...
<Expandable title="¿Puedo cambiar el nombre de mi negocio después de haberlo configurado?">
...
<Expandable title="¿Qué hago si mi descripción no se guarda en el panel de E-SMART360?">
...
<Expandable title="¿La foto de perfil se actualiza automáticamente en todos los chats?">
...
<Expandable title="¿Puedo tener diferentes perfiles para diferentes números?">
...
<Expandable title="¿Qué requisitos necesita mi nombre para obtener el Green Tick?">
...
<Expandable title="¿Cuánto tardan en aplicarse los cambios?">
...
<Expandable title="¿Puedo usar emojis en el estado (About)?">
Sí, están permitidos y recomendados. Máximo 2-3 emojis. No uses emojis en el nombre comercial ni en la descripción.
</Expandable>

<Expandable title="¿E-SMART360 notifica a mis clientes cuando cambio el perfil?">
...
<Expandable title="¿Cómo afecta el perfil a la calificación de calidad de mi número?">
...
<Expandable title="¿Qué hago si mi perfil fue desactivado?">
...
<Expandable title="¿Puedo usar el mismo número para perfil personal y empresarial?">
...
<Card title="Caso 2: Agencia White Label">
...
<Card title="Caso 4: Consultoría Profesional">
