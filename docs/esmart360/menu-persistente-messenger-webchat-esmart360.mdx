...
<Update title="Actualización reciente" date="Febrero 2026">
...
<Steps>
  <Step title="Haz clic en Administrador de Bots de Facebook">
  ...
  <Step title="Desplázate hasta Menú Persistente">
...
<Steps>
  ...
  <Step title="Configura el idioma y el nombre">
  ...
  <Step title="Elige el tipo de acción">
...
<Steps>
  <Step title="Ve al Administrador de WebChat">
  ...
  <Step title="Agrega opciones al menú">
  ...
  <Step title="Deshabilita la entrada de usuario (opcional)">
...
<Steps>
  ...
  <Step title="Configura la apariencia del chat">
  ...
  <Step title="Pega el código en tu sitio web con Elementor">
...
<Steps>
  ...
  <Step title="Selecciona tu chatbot">
    Selecciona tu chatbot y navega hasta **Input Flow** (Flujo de Entrada).
  </Step>

  <Step title="Crea y diseña el flujo">
  ...
  <Step title="Revisa los datos recopilados">
...
<Columns cols="2">
  ...
  <Card title="Asistencia en ecommerce">
...
<Expandable title="¿Qué es el menú persistente de Facebook Messenger?">
...
<Expandable title="¿Cómo configurar un menú persistente en Messenger?">
...
<Expandable title="¿Cómo elimino un menú persistente de Messenger?">
...
<Expandable title="¿Cómo se relaciona el botón 'Get Started' con el menú persistente?">
...
<Expandable title="¿Cómo configurar respuestas rápidas en Facebook Messenger?">
...
<Expandable title="¿Cómo eliminar el botón 'Get Started' de Facebook Messenger?">
...
<Expandable title="¿Qué es el menú persistente en Instagram?">
...
<Expandable title="¿Cuál es el propósito del botón de Messenger?">
...
<Expandable title="¿Qué es un menú persistente en un chatbot con IA para sitios web?">
...
<Expandable title="¿Cómo configurar un menú persistente en un chatbot web?">
...
<Expandable title="¿Por qué necesito un menú persistente para mi chatbot con IA?">
...
<Expandable title="¿Cómo puede beneficiar un menú persistente a un chatbot de comercio electrónico?">
...
<Expandable title="¿Se puede crear un chatbot gratuito con menú persistente en un sitio web?">
...
<Expandable title="¿Qué elementos incluir en el menú persistente de un chatbot en un sitio web?">
...
<Expandable title="¿Qué es un chatbot de sitio web?">
...
<Expandable title="¿Por qué debería usar un chatbot con IA en mi sitio web?">
...
<Expandable title="¿Cómo puedo crear un chatbot para mi sitio web?">
...
<Expandable title="¿Qué hace al mejor chatbot con IA en un sitio web?">
...
<Expandable title="¿Qué importancia tiene tener un chatbot para sitios web de comercio electrónico?">
...
<Expandable title="¿Existen chatbots gratuitos para sitios web?">
...
<Expandable title="¿Cuáles son los beneficios de tener un chatbot en un sitio web?">
...
<Expandable title="¿Cómo personalizar un chatbot para manejar múltiples idiomas?">
...
<Expandable title="¿Cómo puede un chatbot personalizado mejorar las interacciones con los clientes en un sitio web?">
...
<Expandable title="¿Hay algún plugin de chat gratuito para sitios web?">
...
<Expandable title="¿Cómo ayuda un plugin de chat en vivo a un negocio de comercio electrónico?">
...
<Expandable title="¿Cuál es el mejor plugin de chat para sitios web?">
...
<Expandable title="¿Cómo puedo implementar el plugin de chat de Facebook en mi sitio web?">
...
<Expandable title="¿Podré enviar mensajes a través del chat en vivo en el sitio web de forma gratuita?">
...
<Expandable title="¿Puedo usar este chatbot en sitios web que no son WordPress?">
...
<Expandable title="¿Necesito Elementor para agregar el chatbot a mi sitio?">
...
<Expandable title="¿Puedo personalizar la apariencia del chatbot?">
...
<Steps>
  ...
  <Step title="Configura la detección de idioma en el bot">
  ...
  <Step title="Asigna el menú según el idioma">
...
<Expandable title="El menú persistente no aparece en Messenger">
  **Causas posibles:**
...
<Expandable title="El chatbot web no aparece en mi sitio">
  **Causas posibles:**
...
<Expandable title="El menú persistente del WebChat no se muestra">
  **Causas posibles:**
...
<Expandable title="Los botones CTA no funcionan correctamente">
  **Causas posibles:**
