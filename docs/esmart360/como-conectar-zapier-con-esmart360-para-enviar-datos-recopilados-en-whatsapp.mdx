...
<Update title="Actualización de integración Zapier" date="2026-05-05">
...
<Steps>
  <Step title="Componentes del editor">
  ...
  <Step title="Conexión automática">
...
<Steps>
  <Step title="Campo Question (Pregunta)">
  ...
  <Step title="Campo Reply Type (Tipo de Respuesta)">
...
<Columns cols="2">
  <Card title="📧 Marketing por Correo Electrónico">
  ...
  <Card title="📊 Gestión de Clientes en CRM">
...
<Columns cols="2">
  <Card title="📋 Hojas de Cálculo Automatizadas">
  ...
  <Card title="📅 Gestión de Citas y Calendarios">
...
<Columns cols="2">
  ...
  <Card title="🛒 Automatización de E-commerce">
...
<Expandable title="¿Qué es un User Input Flow (Flujo de Entrada de Usuario) en E-SMART360?">
...
<Expandable title="¿Qué disparador (trigger) de Zapier debo usar para esta integración?">
...
<Expandable title="¿La integración está limitada solo a Zapier?">
...
<Expandable title="¿Qué hago si Zapier no está disponible en mi país?">
...
<Columns cols="2">
  <Card title="🎯 Captura de Leads Cualificados">
  ...
  <Card title="📝 Encuestas con Seguimiento Automático">
...
<Columns cols="2">
  <Card title="🔄 Sincronización Multiaplicación">
  ...
  <Card title="📱 Notificaciones de Pedidos en Tiempo Real">
...
<Expandable title="El bot no responde en WhatsApp">
...
<Expandable title="Zapier no detecta los datos enviados desde E-SMART360">
  **Sigue estos pasos:**
...
<Expandable title="El correo electrónico de prueba no llega">
  **Posibles causas:**
...
<Expandable title="El webhook saliente no aparece o no se guarda">
  **Solución:**
...
<Expandable title="¿Puedo usar varias URLs de webhook (varios destinos)?">
...
<Expandable title="¿Zapier cobra por usar esta integración?">
...
<Expandable title="¿Qué alternativas a Zapier existen?">
...
<Expandable title="¿Cuánto tiempo tarda en propagarse un cambio en el flujo de entrada?">
...
<Expandable title="¿Puedo crear flujos de entrada con múltiples preguntas?">
...
<Expandable title="¿Puedo personalizar el mensaje de la URL del webhook en caso de error?">
...
<CodeGroup>
<CodeGroupItem title="Estrategia de segmentación">
...
<CodeGroup>
<CodeGroupItem title="Payload con múltiples respuestas">
...
<Expandable title="¿Puedo usar un solo flujo de entrada para activar múltiples webhooks?">
...
<Expandable title="¿Qué sucede si la URL del webhook de Zapier cambia?">
...
<Expandable title="¿E-SMART360 guarda un registro de los datos enviados por webhook?">
...
<Expandable title="¿Puedo enviar datos a Zapier solo cuando se cumpla una condición específica?">
...
<Expandable title="¿Puedo usar E-SMART360 con otras herramientas de automatización además de Zapier?">
...
<Expandable title="¿Cuántos datos puedo enviar en cada llamada al webhook?">
...
<Expandable title="¿Qué formato de datos usa el webhook?">
...
<Columns cols="3">
  <Card title="📖 Documentación de Zapier">
