...
<Update title="Actualización" date="6 Marzo 2025">
...
<Columns cols="2">
  <Card title="📱 Experiencia de compra sin fricciones">
  ...
  <Card title="📈 Incremento comprobado en ventas">
  ...
  <Card title="🤖 Automatización inteligente con chatbots">
  ...
  <Card title="🌐 Alcance global en tu mercado objetivo">
  ...
  <Card title="🔄 Gestión centralizada desde un solo panel">
  ...
  <Card title="📊 Datos y métricas para optimizar ventas">
...
<Columns cols="2">
  <Card title="✅ Cuenta de WhatsApp Business API">
  ...
  <Card title="✅ Meta Business Manager">
  ...
  <Card title="✅ Productos listados y preparados">
  ...
  <Card title="✅ Cuenta activa en E-SMART360">
...
<Steps>
  ...
  <Step title="Configura el tipo de catálogo">
  ...
  <Step title="Elige el método de carga y completa la configuración">
  ...
  <Step title="Agrega productos al catálogo">
...
<Steps>
  ...
  <Step title="Encuentra la opción Catalog en Account Tools">
  ...
  <Step title="Selecciona tu catálogo de la lista disponible">
  ...
  <Step title="Conecta el catálogo a tu cuenta de WhatsApp">
...
<Steps>
  ...
  <Step title="Conecta y sincroniza tu número de WhatsApp">
  ...
  <Step title="Verifica la información de los productos">
  ...
  <Step title="Configura las opciones de visualización del catálogo">
...
<Steps>
  <Step title="Planifica la experiencia del cliente">
  ...
  <Step title="Construye el flujo en el Bot Builder">
  ...
  <Step title="Configura las reglas de negocio y comportamiento">
  ...
  <Step title="Prueba y activa el chatbot">
...
<Tabs>
  <Tab title="🛒 Tienda de Ropa y Accesorios">
  ...
  <Tab title="🍕 Restaurante y Delivery">
  ...
  <Tab title="💻 Agencia de Servicios Profesionales">
...
<Columns cols="2">
  <Card title="⚡ Compromiso Inmediato sin Esfuerzo Manual">
  ...
  <Card title="🎯 Recomendaciones Hiper-Personalizadas">
  ...
  <Card title="🕐 Disponibilidad Absoluta 24/7/365">
  ...
  <Card title="📈 Conversión de Ventas Significativamente Mayor">
  ...
  <Card title="👥 Escalabilidad Ilimitada sin Costos Adicionales">
  ...
  <Card title="🔄 Actualización Automática en Tiempo Real sin Esfuerzo">
...
<Expandable title="¿Qué es exactamente un catálogo de productos en WhatsApp?">
...
<Expandable title="¿Por qué debería integrar un catálogo de productos en WhatsApp para mi negocio?">
...
<Expandable title="¿Cuál es el proceso paso a paso para crear un catálogo en WhatsApp?">
...
<Expandable title="¿Puedo modificar o actualizar mi catálogo después de haberlo creado?">
...
<Expandable title="¿Existe un límite de productos que puedo tener en mi catálogo de WhatsApp?">
...
<Expandable title="¿Qué tipos de productos o servicios puedo incluir en el catálogo?">
...
<Expandable title="¿Necesito conocimientos de programación o técnicos para usar el catálogo?">
...
<Expandable title="¿Puedo recibir pagos directamente desde el catálogo de WhatsApp?">
...
<Expandable title="¿Cómo ve el cliente los productos del catálogo en su WhatsApp?">
...
<Expandable title="¿Funciona igual en WhatsApp Business App y en WhatsApp API?">
...
<Expandable title="¿Puedo tener varios catálogos separados por tipo de producto?">
...
<Expandable title="¿Cómo se manejan las variantes como talla, color o material?">
...
<Expandable title="¿Los cambios en mi tienda online se sincronizan automáticamente con el catálogo?">
...
<Expandable title="¿Qué hago si mi catálogo no se sincroniza o tengo problemas técnicos?">
...
<Expandable title="¿Cuánto tiempo toma tener el catálogo funcionando desde cero?">
...
<Expandable title="El catálogo no aparece visible en WhatsApp después de conectarlo">
...
<Expandable title="Los productos se sincronizan incorrectamente o incompletos en E-SMART360">
...
<Expandable title="El chatbot no muestra los productos del catálogo en las conversaciones">
...
<Expandable title="Los precios aparecen en formato incorrecto o moneda equivocada">
...
<Columns cols="3">
  ...
  <Card title="🍕 Pizzería Bella Napoli">
...
<Expandable title="Caso completo: TechStore - Electrónica de consumo">
