...
<Steps>
<Step title="Accede al Gestor de Suscriptores de WhatsApp">
...
<Step title="Descarga la plantilla CSV">
...
<Step title="Revisa los datos importados">
...
<Step title="Selecciona la hoja de cálculo">
...
<Step title="Configura la sincronización">
...
<Step title="Verifica los campos personalizados">
...
<Steps>
<Step title="Accede al Gestor de Bots de WhatsApp">
...
<Step title="Configura los datos de la plantilla">
...
<Step title="Incorpora las variables personalizadas">
...
<Step title="Configura el encabezado y pie de página">
...
<Step title="Guarda y verifica el estado">
...
<Expandable title="🔴 Principales causas de rechazo">
...
<Tabs>
<Tab title="Ejemplo: Plantilla Marketing">
```
Hola {{1}} 👋
...
<Tab title="Ejemplo: Plantilla Utilidad">
```
Hola {{1}},
...
<Steps>
<Step title="Accede a la sección de Broadcasting">
...
<Step title="Selecciona la plantilla de mensaje">
Elige la plantilla de mensaje que creaste y aprobaste en el **Paso 3**.
</Step>

<Step title="Selecciona la etiqueta de suscriptores">
...
<Step title="Verifica el alcance">
...
<Step title="Finaliza el flujo del bot">
...
<Expandable title="📊 ¿Cómo monitorear estas señales?">
...
<Card title="Mayores tasas de conversión">
...
<Expandable title="📊 Estadísticas de personalización en WhatsApp">
...
<Step title="Crea una campaña de obtención de datos">
...
<Step title="Mapea los datos de la hoja de cálculo">
...
<Expandable title="🔄 Ejemplos de automatización con Google Sheets + WhatsApp">
...
<Step title="Verifica la personalización">
...
<Step title="Verifica el formato en diferentes dispositivos">
...
<Expandable title="¿Qué es el broadcasting de WhatsApp en E-SMART360?">
...
<Expandable title="¿Cómo puedo personalizar los mensajes en un broadcast?">
...
<Expandable title="¿Hay un límite en la cantidad de destinatarios en un broadcast?">
...
<Expandable title="¿Qué métricas de análisis ofrece E-SMART360 para rastrear broadcasts?">
...
<Expandable title="¿Puedo probar mis broadcasts antes de enviarlos?">
...
<Expandable title="¿Qué causa una caída en la calificación de calidad de mi número?">
...
<Expandable title="¿Cuántos botones puedo incluir en una plantilla de broadcasting?">
...
<Expandable title="¿Puedo usar el mismo número para WhatsApp Business App y WhatsApp Business API?">
...
<Expandable title="¿Cuánto tiempo toma la aprobación de una plantilla por parte de Meta?">
...
<Expandable title="¿Qué tipos de plantillas de medios puedo usar en mis broadcasts?">
...
<Expandable title="¿Puedo programar un broadcast para una fecha futura?">
...
<Expandable title="¿Qué sucede si un suscriptor responde a mi mensaje broadcast?">
...
<Expandable title="¿Cómo maneja E-SMART360 los números de teléfono inválidos en mi lista?">
...
<Expandable title="💡 Consejo: Automatiza el envío en fechas especiales">
...
<Columns cols="2">
<Card title="¿Qué es una plantilla carrusel?">
...
<Card title="¿Cuándo usar carruseles?">
...
<Columns cols="2">
<Card title="Segmenta por comportamiento">
...
<Card title="Segmenta por ciclo de vida">
...
<Steps>
<Step title="☑️ Prepara tus datos">
...
<Step title="☑️ Crea campos personalizados">
...
<Step title="☑️ Lanza y monitorea">
