...
<Update title="Comparativa actualizada" date="2026-02-07">
...
<Expandable title="Medidas que implementamos para garantizar la estabilidad de la plataforma">
...
<Columns cols="2">
<Card title="Modelo basado en capacidad (ChatRace)">
...
<Card title="Modelo basado en uso — PPU (E-SMART360)">
...
<Expandable title="Impacto financiero: Capacidad vs Uso a lo largo del tiempo — Caso real">
...
<Tab title="Plan PPU White Label">
...
<Expandable title="Comparativa detallada de precios por volumen de mensajes">
...
<Steps>
<Step title="Campañas de temporada alta">
...
<Step title="Clientes con grandes bases de datos históricas">
...
<Step title="Crecimiento mes a mes sostenido">
...
<Step title="Múltiples cuentas de negocio para un mismo cliente">
...
<Step title="Acumulación de leads históricos">
...
<Steps>
<Step title="Automatización avanzada con Webhooks">
...
<Step title="Automatizaciones completas para E-commerce">
...
<Step title="Sistema de Confirmación de Citas y Reservas">
...
<Step title="Alertas Inteligentes de Formularios Web">
...
<Step title="Asistente de IA Avanzado y Entrenable">
...
<Step title="Control Total con API y Lógica Personalizada">
...
<Step title="WhatsApp Flows — Formularios Interactivos Nativos">
...
<Step title="Pagos Directamente en el Chat">
...
<Columns cols="2">
<Card title="Caso práctico: Agencia de marketing digital con 12 clientes">
...
<Card title="Caso práctico: Tienda e-commerce en crecimiento acelerado">
...
<Expandable title="Casos de automatización avanzada — 15 ejemplos adicionales">
...
<Expandable title="Características exclusivas de E-SMART360 que ChatRace no ofrece actualmente">
...
<Expandable title="Cómo calcular el costo real mensual para tu agencia">
...
<Expandable title="¿Cuál es el costo mínimo mensual de ChatRace?">
...
<Expandable title="¿Cuál es el costo mínimo mensual de E-SMART360?">
...
<Expandable title="¿E-SMART360 tiene límites de contactos?">
...
<Expandable title="¿Por qué E-SMART360 es más económico que ChatRace?">
...
<Expandable title="¿Es ChatRace una buena plataforma de chatbots?">
...
<Expandable title="¿Qué hace diferente a E-SMART360 de otras plataformas de chatbots?">
...
<Expandable title="¿Qué plataforma es mejor para agencias white label?">
...
<Expandable title="¿E-SMART360 permite migrar desde ChatRace u otras plataformas?">
  Sí, E-SMART360 ofrece asistencia gratuita para migrar desde cualquier plataforma, incluyendo ChatRace, Wati, Gallabox y otras. El equipo de soporte guía el proceso paso a paso para garantizar una transición sin pérdida de datos ni interrupción del servicio.
</Expandable>

<Expandable title="¿Puedo probar E-SMART360 antes de comprar la licencia white label?">
...
<Columns cols="2">
<Card title="Agencia de bienes raíces con 20,000 leads">
...
<Card title="Clínica dental con sistema de citas">
...
<Columns cols="2">
<Card title="Tienda de ropa online con carritos abandonados">
...
<Card title="Restaurante con programa de fidelidad">
...
<Steps>
<Step title="Evalúa tu volumen actual">
...
<Step title="Conecta tus números de WhatsApp">
...
<Step title="Recrea tus flujos de chatbot">
...
<Step title="Cancela tu plan de ChatRace">
...
<Steps>
<Step title="Paso 1: Calcula tu costo actual con ChatRace">
...
<Step title="Paso 2: Identifica tu volumen real de mensajes">
...
<Step title="Paso 3: Calcula tu costo con E-SMART360">
...
<Step title="Paso 4: Proyecta tu ahorro anual">
...
<Expandable title="¿E-SMART360 ofrece créditos de mensajes ilimitados?">
...
<Expandable title="¿Qué son las conversaciones de entrada gratuita en WhatsApp?">
...
<Expandable title="¿Cómo funcionan las categorías de conversación en WhatsApp?">
...
<Expandable title="¿E-SMART360 es compatible con Click-to-WhatsApp Ads?">
...
<Expandable title="¿Qué integraciones nativas ofrece E-SMART360?">
...
<Expandable title="¿ChatRace cobra margen adicional sobre la API de WhatsApp?">
...
<Expandable title="¿Puedo personalizar completamente la marca blanca con E-SMART360?">
