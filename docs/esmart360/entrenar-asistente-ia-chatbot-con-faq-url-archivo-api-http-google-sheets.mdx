...
<Card title="Archivos y Documentos">
...
<Columns cols="2">
<Card title="APIs HTTP en Tiempo Real">
...
<Steps>
<Step title="Accede al panel de entrenamiento">
...
<Step title="Configura el mensaje de inicio">
...
<CodeGroup>
<CodeGroupItem title="Ejemplo: Extraer por ID">
```html
...
<CodeGroupItem title="Ejemplo: Extraer por Clase">
```html
...
<Step title="Excluye contenido no deseado (opcional)">
...
<Steps>
<Step title="Accede a la sección de archivos">
...
<Steps>
<Step title="Accede a la integración HTTP API">
...
<Step title="Configura el cuerpo de la solicitud (opcional)">
...
<Step title="Guarda y verifica la conexión">
...
<Step title="Crea campos personalizados (opcional)">
...
<Step title="Usa los datos en tus respuestas">
...
<Step title="Configura la respuesta AI">
...
<Step title="Activa la respuesta Sin Coincidencia">
...
<Step title="Elige el modo de operación">
...
<Card title="🧠 Entrenamiento Inteligente">
...
<Card title="🎯 Interacciones Personalizadas">
...
<Card title="🚀 Productividad Mejorada">
...
<Expandable title="¿Cómo funciona el precio de los Tokens de IA?">
...
<Expandable title="¿Cuál es el propósito de un chatbot de IA para comercio electrónico?">
...
<Expandable title="¿Por qué elegir un chatbot de IA en lugar del método tradicional?">
...
<Expandable title="¿Puedo personalizar un chatbot para mi tienda de comercio electrónico?">
...
<Expandable title="¿Cómo puedo crear un chatbot de IA gratis?">
...
<Expandable title="¿Cómo mejora un chatbot de IA la atención al cliente?">
...
<Expandable title="¿Qué características debe tener un chatbot de atención al cliente?">
...
<Expandable title="¿Cuál es el mejor chatbot de IA gratuito?">
...
<Steps>
<Step title="Revisa el historial de conversaciones">
...
<Step title="Analiza las respuestas fallidas">
...
<Step title="Actualiza los datos de entrenamiento">
...
<Step title="Prueba después de cada actualización">
...
<Card title="🏢 Empresa de Servicios B2B">
...
<Card title="🏦 Institución Financiera">
...
<Steps>
<Step title="Verifica la conexión de la fuente de datos">
...
<Step title="Revisa el mensaje de instrucción">
...
<Step title="Verifica la campaña de entrenamiento seleccionada">
...
<Step title="Prueba con consultas de ejemplo">
...
<Steps>
<Step title="Configura un postback básico">
...
<Step title="Vincula el postback a un botón">
...
<Step title="Combina postbacks con IA">
...
<Columns cols="2">
<Card title="🔄 Programa de Revendedor">
...
<Card title="🤝 Programa de Afiliado">
...
<Step title="Reconstruye tus flujos">
...
<Step title="Entrena tu Agente de IA">
...
<Columns cols="3">
<Card title="⭐ Tienda de Moda Online">
