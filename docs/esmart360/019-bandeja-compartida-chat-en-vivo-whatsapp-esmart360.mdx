---
title: "Chat en Vivo: Bandeja Compartida de WhatsApp para Atención al Cliente en E-SMART360"
description: "Gestiona todas las conversaciones de WhatsApp, Facebook Messenger, Instagram DM, Telegram y Chat Web de tu equipo desde una sola bandeja compartida. Incluye chat en vivo con transferencia entre agentes, mensajes de firma, recordatorios de seguimiento, traducción en línea, respuestas predefinidas y análisis detallados para optimizar la atención al cliente multicanal."
---

import { Callout, Steps, Step, Expandable, Columns, Card, Tabs, Tab, CodeGroup, CodeGroupItem, Update } from '/src/components/mdx';

<Update title="Actualización: Bandeja Compartida y Chat en Vivo" date="2026-05-06">
...
<Steps>
  ...
  <Step title="Activa los mensajes de firma">
  ...
  <Step title="Configura el mensaje predeterminado">
  ...
  <Step title="Personaliza firmas individuales">
  ...
  <Step title="Activa el indicador de escritura">
...
<Steps>
  <Step title="Suscribir / Dar de baja">
...
<Columns cols="2">
  <Card title="Atención al Cliente">
...
<Steps>
  <Step title="Conecta tu WhatsApp Business API">
  ...
  <Step title="Configura etiquetas predefinidas">
...
```mermaid
graph TD
    A[Cliente envía mensaje WhatsApp] --> B{¿Dentro de ventana 24h?}
    B -->|Sí| C[ChatBot responde automáticamente]
    B -->|No| D[Usar plantilla de mensaje aprobada]
    D --> E[Cliente responde -> Se abre ventana 24h]
    E --> C
    C --> F{¿Necesita atención humana?}
    F -->|No| G[ChatBot resuelve consulta]
    G --> H[Marcar como resuelto]
    F -->|Sí| I[Agente se une al chat]
    I --> J[Activar mensaje de firma]
    J --> K[Resolver consulta]
    K --> L{¿Requiere seguimiento?}
    L -->|Sí| M[Programar recordatorio]
    M --> N[Reanudar cuando llegue el recordatorio]
    N --> K
    L -->|No| O[Marcar como resuelto]
    O --> P{¿Archivar?}
    P -->|Sí| Q[Archivar conversación]
    P -->|No| R[Mantener en chats activos]
```
...
<Expandable title="¿Cómo ayuda el Chat en Vivo a reducir el abandono de carrito?">
...
<Expandable title="¿Puedo usar firmas diferentes para distintos agentes?">
...
<Expandable title="¿Los mensajes de firma funcionan en todos los canales?">
...
<Expandable title="¿Qué pasa si un agente abandona el chat? ¿Puede retomarlo otro?">
...
<Expandable title="¿Cómo sé qué agente está respondiendo en cada momento?">
...
<Expandable title="¿Se pueden personalizar las etiquetas para organizar clientes?">
...
<Expandable title="¿Qué sucede si no respondo dentro de la ventana de 24 horas?">
...
<Expandable title="¿Existe una prueba gratuita disponible?">
...
<Expandable title="¿Puedo integrar la bandeja compartida con otras herramientas?">
...
<Expandable title="No puedo ver todos los chats en la lista">
...
<Expandable title="El mensaje de firma no se envía al unirme al chat">
...
<Expandable title="El bot no se pausa cuando intento tomar control manual">
...
<Expandable title="Un cliente está enviando mensajes de spam">
...
<Expandable title="¿Cómo recupero un chat archivado?">
...
<Expandable title="El indicador de escritura no aparece en WhatsApp del cliente">
...
<Expandable title="¿Pueden dos agentes atender el mismo chat simultáneamente?">
...
<Expandable title="¿Qué hago si el temporizador de 24 horas está por expirar?">
...
<Steps>
  <Step title="Identifica el mensaje como spam">
...
<Steps>
  <Step title="Recepción del mensaje">
  ...
  <Step title="Respuesta automática del chatbot">
  ...
  <Step title="Solicitud de atención humana">
    Roberto responde: "Sí, por favor. Quiero saber si hay descuentos por pago anual."
  </Step>
  <Step title="Asignación al agente de ventas">
  ...
  <Step title="Carlos se une al chat con firma">
  ...
  <Step title="Resolución de la consulta">
  ...
  <Step title="Seguimiento programado">
  ...
  <Step title="Reactivación del bot">
  ...
  <Step title="Seguimiento exitoso">
...
<Expandable title="¿Qué son las conversaciones de Marketing, Utilidad y Servicio en WhatsApp?">
...
<Expandable title="¿Cómo afectan los tipos de conversación a mi facturación?">
...
<Expandable title="¿Puedo ver el tipo de conversación en la bandeja compartida?">
...
<Expandable title="¿Qué hago si un cliente me escribe en un idioma que no entiendo?">
...
<Expandable title="¿Puedo usar la bandeja compartida en dispositivos móviles?">
...
<Expandable title="¿Se pueden programar respuestas automáticas fuera del horario laboral?">
...
<Expandable title="¿Hay un límite de agentes que puedo añadir a la bandeja compartida?">
...
<Expandable title="¿Cómo gestiono las conversaciones después del horario laboral?">
...
<Expandable title="¿Qué beneficios tiene usar la bandeja compartida vs. WhatsApp Business en el teléfono?">
...
<Expandable title="¿Cómo configuro los roles y permisos de los agentes?">
...
<Expandable title="¿Puedo migrar mis contactos existentes de WhatsApp a la bandeja compartida?">
