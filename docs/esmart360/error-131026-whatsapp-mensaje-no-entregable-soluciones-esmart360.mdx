...
<Step title="Revisa el informe de la campaña">
...
<Step title="Identifica el número de origen">
...
<Step title="Busca el mensaje fallido por número">
...
<Step title="Verifica el estado de entrega">
...
<Step title="Consulta el directorio oficial de errores de Meta">
...
<Expandable title="Error 131042: Problema con el método de pago">
...
<Expandable title="Error 130472: Número de teléfono parte de un experimento">
...
<Expandable title="Error por superación de límite de mensajería">
...
<Expandable title="Error 131015: Estructura de mensaje no compatible">
...
<Expandable title="Error 131037: Interactividad no soportada">
...
<CodeGroup>
<CodeGroupItem title="Plantilla de verificación">
...
<Expandable title="¿El error 131026 afecta mi calificación de calidad en WhatsApp?">
...
<Expandable title="¿Puedo reenviar el mismo mensaje a un número que falló con error 131026?">
...
<Expandable title="¿Cómo sé si un número está registrado en WhatsApp antes de enviarle un mensaje?">
...
<Callout type="tip">La verificación automática por API más la confirmación del usuario es el método más fiable para garantizar números activos.</Callout>
</Expandable>

<Expandable title="¿Qué pasa si muchos mensajes fallan? ¿Puedo ser bloqueado?">
...
<Expandable title="¿La versión de WhatsApp puede causar otros errores además del 131026?">
...
<Expandable title="¿Cómo configuro alertas automáticas para tasa de error alta?">
...
<Expandable title="¿Qué diferencia hay entre error 131026 y 131029?">
...
<Card title="📊 Campaña ecommerce con 5.000 contactos">
...
<Card title="🏥 Clínica dental con recordatorios de citas">
...
<Card title="📱 Agencia inmobiliaria con alertas de propiedades">
...
<Expandable title="¿Qué hacer si una plantilla de mensaje es rechazada por Meta?">
