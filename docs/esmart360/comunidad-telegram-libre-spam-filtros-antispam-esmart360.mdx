...
<Update title="Nueva guía antispam para Telegram" date="2026-05-07">
...
<Steps>
  <Step title="Eliminar mensajes con comandos de bot">
  ...
  <Step title="Eliminar mensajes con imágenes y grabaciones de voz">
  ...
  <Step title="Eliminar stickers, GIFs y dados de miembros">
    ...
    <Expandable title="¿Por qué bloquear los dados de Telegram?">
  ...
  <Step title="Eliminar mensajes que contengan enlaces">
    ...
    <Tabs>
      ...
      <Tab title="Whitelist de dominios">
...
<Columns cols="2">
  <Card title="Cuándo eliminar solo reenvíos con enlaces">
  ...
  <Card title="Cuándo eliminar todos los reenvíos">
...
<Expandable title="¿Cómo configuro las palabras clave bloqueadas?">
...
<Steps>
  <Step title="Configurar niveles de severidad">
  ...
  <Step title="Crear listas blancas de excepciones">
  ...
  <Step title="Programar horarios de vigilancia">
...
<Steps>
  <Step title="Configurar límite de mensajes en el panel">
  ...
  <Step title="Personalizar la duración del silencio">
  ...
  <Step title="Configurar mensaje de advertencia automática">
...
<Expandable title="¿Qué sucede cuando bloqueas un usuario en E-SMART360?">
...
<Steps>
  <Step title="Identificar el contacto spam">
  ...
  <Step title="Bloquear mensajes entrantes">
  ...
  <Step title="Verificar el bloqueo">
...
<Columns cols="3">
  <Card title="🏢 Grupo corporativo / atención al cliente">
  ...
  <Card title="👨‍💻 Comunidad de tecnología / desarrolladores">
    <strong>Configuración:</strong>
  ...
  <Card title="🛒 Grupo de ventas / ofertas / ecommerce">
    <strong>Configuración:</strong>
...
<Columns cols="3">
  <Card title="🎓 Grupo educativo / académico">
    <strong>Configuración:</strong>
  ...
  <Card title="🌐 Comunidad regional / vecinal">
    <strong>Configuración:</strong>
  ...
  <Card title="🤖 Comunidad de gaming / entretenimiento">
    <strong>Configuración:</strong>
...
<Expandable title="¿Los usuarios bloqueados en WhatsApp pueden ver mis transmisiones (broadcasts)?">
...
<Expandable title="¿El bloqueo de usuarios en WhatsApp es permanente?">
...
<Expandable title="¿Puedo configurar diferentes niveles de filtrado para diferentes roles en Telegram?">
...
<Expandable title="¿El límite de mensajes aplica también a los administradores?">
...
<Expandable title="¿Cómo maneja E-SMART360 los enlaces de afiliados legítimos y el contenido promocional autorizado?">
...
<Expandable title="¿Qué pasa si un miembro envía spam en múltiples grupos que administro?">
...
<Expandable title="¿Cómo puedo ver el historial de acciones de moderación?">
...
<Expandable title="¿El sistema de filtros afecta el rendimiento del grupo o retrasa los mensajes?">
...
<Expandable title="¿Cómo interpretar las estadísticas de moderación?">
