...
<Step title="Editar el mensaje Get Started">
...
<Step title="Activar el mensaje de bienvenida desde WhatsApp Cloud API">
...
<Expandable title="Ejemplo completo de mensaje de bienvenida para un e-commerce">
Texto de ejemplo:
...
<Expandable title="¿Puedo tener diferentes mensajes de bienvenida para distintos escenarios?">
...
<Expandable title="El mensaje de bienvenida no se envía automáticamente">
...
<Expandable title="El mensaje se ve diferente en dispositivos móviles">
...
<Steps>
<Step title="Crear las preguntas rompehielos en WhatsApp Cloud API">
...
<Step title="Crear un bot para cada pregunta rompehielos">
...
<Expandable title="¿Cuántas preguntas rompehielos puedo agregar?">
...
<Expandable title="¿Los rompehielos aparecen siempre que el usuario abre el chat?">
...
<Card title="Soporte técnico / SaaS">
...
<Steps>
<Step title="Crear los comandos en WhatsApp Cloud API">
1. Accede al Administrador de números de WhatsApp.
...
<Step title="Crear bots para cada comando en E-SMART360">
...
<Tabs>
<Tab title="Comandos básicos (cualquier negocio)">
...
<Tab title="Comandos para e-commerce">
...
<Tab title="Comandos para servicios / SaaS">
...
<Steps>
<Step title="Añadir el componente de ubicación al flujo del bot">
...
<Step title="Probar el botón de ubicación">
...
<Columns cols="2">
<Card title="Comercio local / Retail">
...
<Card title="Servicios a domicilio">
...
<Card title="Restaurantes y comida">
...
<Expandable title="¿Qué hago si el botón de ubicación no aparece en el chat del usuario?">
Verifica los siguientes puntos:
...
<Expandable title="¿La ubicación se almacena permanentemente?">
...
<Steps>
<Step title="Acceder a la configuración de no-coincidencia">
...
<Step title="Diseñar la respuesta">
...
<Step title="Configurar la frecuencia de envío">
...
<Expandable title="¿Qué debería decir exactamente el mensaje de no-coincidencia?">
...
<Expandable title="¿Cómo saber si un mensaje de no-coincidencia está funcionando?">
...
<Steps>
<Step title="Iniciar un nuevo bot">
...
<Step title="Configurar la palabra clave y el tipo de coincidencia">
...
<Step title="Agregar un componente de respuesta">
...
<Step title="Añadir botones interactivos">
...
<Step title="Configurar el mensaje final y guardar">
...
<Expandable title="¿Cuál es la diferencia entre un comando y un rompehielos?">
...
<Expandable title="¿Cuántos rompehielos puedo tener como máximo?">
...
<Expandable title="¿El botón de ubicación funciona en WhatsApp Web?">
...
<Expandable title="¿Puedo editar el mensaje de bienvenida después de activarlo?">
...
<Expandable title="¿Qué hago si mi mensaje de no-coincidencia se envía demasiadas veces?">
...
<Expandable title="¿Cómo puedo ver qué comandos ha usado un suscriptor?">
...
<Expandable title="¿Es necesario tener conocimientos técnicos para configurar estas funcionalidades?">
...
<Card title="Ejemplo 2: Restaurante de comida rápida">
