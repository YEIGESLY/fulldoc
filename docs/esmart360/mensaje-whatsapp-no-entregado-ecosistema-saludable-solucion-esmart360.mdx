...
<Callout type="info" title="Códigos de error asociados">
...
<Columns cols="2">
  <Card title="Mejorar tasas de lectura">
  ...
  <Card title="Mejorar la percepción del usuario">
  ...
  <Card title="Contenido valioso y relevante">
  ...
  <Card title="Proteger el ecosistema">
...
<Callout type="tip" title="Datos de WhatsApp">
...
<Columns cols="3">
  ...
  <Card title="🟡 Amarillo: Calidad Media">
...
<Expandable title="¿Qué acciones afectan tu calificación de calidad?">
...
<Steps>
  <Step title="Pausa las transmisiones temporalmente">
  ...
  <Step title="Revisa el contenido de tus mensajes">
  ...
  <Step title="Segmenta y depura tu lista de contactos">
  ...
  <Step title="Reanuda gradualmente">
  ...
  <Step title="Mantén la constancia">
...
<Callout type="success" title="Tiempo de recuperación">
...
<Expandable title="Ejemplo de segmentación efectiva">
...
<Columns cols="2">
  ...
  <Card title="Tier 4 — Potencial Ilimitado">
...
<Expandable title="Reglas clave que debes conocer sobre los niveles de mensajería">
...
<Steps>
  <Step title="Responde rápidamente">
  ...
  <Step title="Involucra al cliente con contenido de valor">
  ...
  <Step title="Planifica seguimientos con plantillas">
...
<Expandable title="Ejemplos prácticos de la regla de 24 horas">
  **Atención al cliente:**
...
<Columns cols="2">
  <Card title="Obtén consentimiento explícito">
  ...
  <Card title="Crea contenido no promocional">
  ...
  <Card title="Ofrece opciones de baja fáciles">
  ...
  <Card title="Monitorea el rendimiento">
    Revisa regularmente:
...
<Expandable title="Cómo buscar números fallidos en E-SMART360">
...
<Expandable title="¿Puedo enviar mensajes con una calificación de calidad roja?">
...
<Expandable title="¿Cuánto tiempo tarda en mejorar la calificación de calidad?">
...
<Expandable title="¿Qué sucede si los usuarios bloquean mi número?">
...
<Expandable title="¿Los mensajes de servicio al cliente cuentan para el límite de marketing?">
...
<Expandable title="¿Cómo sé cuál es mi límite actual de mensajes por usuario?">
...
<Expandable title="¿El opt-in garantiza la entrega del mensaje?">
...
<Callout type="tip" title="Consejo rápido">
...
<Steps>
  ...
  <Step title="Estrategia escalonada">
...
<Callout type="info" title="WhatsApp Business API vs. WhatsApp normal">
...
<Callout type="success" title="¿Necesitas ayuda con tus campañas de WhatsApp?">
