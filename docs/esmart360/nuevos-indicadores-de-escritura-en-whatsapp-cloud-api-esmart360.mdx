...
<Steps>
  ...
  <Step title="Configura el tiempo de espera (retardo)">
...
<Steps>
  <Step title="Accede al Chat en Vivo">
    Ve a **Bandeja de entrada → Chat en Vivo** desde el panel principal.
  </Step>
  <Step title="Verifica la configuración de indicadores">
  ...
  <Step title="Configura el tiempo de respuesta sugerido">
...
<Tabs>
  <Tab title="Respuestas automáticas">
  ...
  <Tab title="Respuestas informativas">
  ...
  <Tab title="Respuestas transaccionales">
...
<Columns cols="2">
  <Card title="🛒 Atención al cliente en ecommerce">
  ...
  <Card title="🏥 Consultas médicas automatizadas">
  ...
  <Card title="🏨 Soporte hotelero en tiempo real">
...
<Steps>
  <Step title="Crea una respuesta automática para consultas de pedidos">
  ...
  <Step title="Configura un fallback (Smart Delay)">
...
<Columns cols="2">
  ...
  <Card title="Messenger + Instagram DM">
...
<Expandable title="¿El indicador de escritura funciona con todos los tipos de mensajes?">
...
<Expandable title="¿Puedo personalizar el texto del indicador de escritura?">
...
<Expandable title="¿El indicador de escritura consume más recursos del servidor?">
...
<Expandable title="¿Qué sucede si el bot tarda más de 25 segundos en responder?">
...
<Expandable title="¿Puedo desactivar el indicador de escritura para respuestas específicas?">
...
<Expandable title="¿El indicador de escritura afecta la velocidad de respuesta del bot?">
...
<Expandable title="¿Funciona el indicador con respuestas que contienen imágenes, videos o documentos?">
...
<Expandable title="¿Cómo afecta el indicador de escritura a la ventana de 24 horas de conversación?">
