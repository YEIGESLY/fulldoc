...
<Columns cols="3">
  ...
  <Card title="Compromiso del Usuario">
...
<Steps>
  ...
  <Step title="Cuenta en E-SMART360">
  ...
  <Step title="Conocimientos Básicos (Opcional)">
...
<Steps>
  ...
  <Step title="Guarda tu token de API">
  ...
  <Step title="Configura los comandos (opcional)">
  ...
  <Step title="Establece la descripción">
...
<Columns cols="3">
  <Card title="Automatización Sin Código">
  ...
  <Card title="Paneles de Análisis">
...
<Steps>
  <Step title="Conecta tu token del bot">
  ...
  <Step title="Configura los webhooks (opcional)">
  ...
  <Step title="Ajusta los parámetros de integración">
...
<Steps>
  ...
  <Step title="Entrena el bot con preguntas frecuentes (FAQ)">
  ...
  <Step title="Entrena el bot con URL">
  ...
  <Step title="Entrena el bot con archivos">
  ...
  <Step title="Configura el comportamiento de IA">
...
<Expandable title="Ejemplo práctico: Tienda de ropa online">
...
<Expandable title="¿Crear un bot de Telegram es realmente gratis?">
...
<Expandable title="¿Necesito saber programar para crear un bot de Telegram?">
...
<Expandable title="¿Puedo agregar mi bot de Telegram a un grupo?">
...
<Expandable title="¿Cómo puedo hacer que mi bot entienda preguntas en varios idiomas?">
...
<Expandable title="¿Qué hago si mi bot deja de responder repentinamente?">
...
<Expandable title="¿Puedo conectar un mismo bot a Telegram y WhatsApp?">
...
<Expandable title="¿Cómo puedo medir el rendimiento de mi bot de Telegram?">
...
<Columns cols="2">
  ...
  <Card title="Comunidad de Gaming con Moderación Automática">
...
<Update title="Integración con IA Generativa para respuestas contextuales" date="2026-03-15">
...
<Update title="Nuevo gestor de webhooks visual" date="2026-01-20">
...
<Update title="Analíticas en tiempo real para bots de Telegram" date="2025-11-05">
