...
<Update title="Actualización de plataforma" date="2026-05-06">
...
<Steps>
  ...
  <Step title="Verifica los requisitos previos">
  ...
  <Step title="Configura la integración con Meta">
...
<Steps>
  ...
  <Step title="Explora el lienzo del constructor de flujos">
  ...
  <Step title="Diseña tu primer flujo: saludo de bienvenida">
...
<Steps>
  ...
  <Step title="Configura la palabra clave disparadora">
    ...
    <Tabs>
      ...
      <Tab title="Coincidencia de cadena">
  ...
  <Step title="Configura un mensaje de respuesta interactivo">
  ...
  <Step title="Configura el mensaje final y guarda todo">
...
<Expandable title="¿La palabra clave no activa respuestas?">
...
<Expandable title="¿Los botones no aparecen?">
...
<Expandable title="¿No hay mensaje final después de los botones?">
...
<Steps>
  ...
  <Step title="Estructura tu secuencia con contenido variado">
  ...
  <Step title="Usa plantillas aprobadas para mensajes fuera de 24h">
    <Callout type="warning">
  ...
  <Step title="Finaliza y activa la secuencia">
...
<Steps>
  ...
  <Step title="Programa los mensajes para máximo engagement">
...
<Expandable title="¿Cómo configurar la integración con Google Sheets?">
  <Steps>
    <Step title="Conecta tu cuenta de Google">Desde el panel de integraciones de E-SMART360, vincula tu cuenta de Google Sheets.</Step>
    <Step title="Selecciona la hoja de datos">Elige la hoja de cálculo que contiene la información que deseas consultar (productos, precios, inventario, etc.).</Step>
    <Step title="Configura las variables">Usa las columnas de tu hoja como variables en los mensajes del chatbot. Por ejemplo: {{nombre_producto}}, {{precio}}, {{stock}}.</Step>
    <Step title="Activa el flujo">El bot consultará los datos en tiempo real cuando el usuario active el flujo correspondiente. Si actualizas la hoja, el bot usará los datos más recientes automáticamente.</Step>
  </Steps>
</Expandable>
...
<Expandable title="Ejemplo: Notificación de pedido en WooCommerce">
...
<Expandable title="¿Cuánto tiempo toma configurar un chatbot de WhatsApp completo?">
...
<Expandable title="¿El chatbot de E-SMART360 tiene costo?">
...
<Expandable title="¿Puedo integrar mi catálogo de productos con el chatbot?">
...
<Expandable title="¿Es WhatsApp mejor que Messenger o el email para automatización?">
...
<Expandable title="¿Qué son los límites de mensajería de WhatsApp y cómo funcionan?">
...
<Expandable title="¿Cómo gestiono el equipo de atención al cliente en el chat?">
...
<Expandable title="¿El chatbot funciona con Instagram y Facebook Messenger?">
...
<Expandable title="¿Puedo programar mensajes para enviarlos en una fecha futura?">
...
<Expandable title="¿Cómo puedo medir el rendimiento de mi chatbot?">
...
<Expandable title="¿Puedo personalizar la apariencia del web chat en mi sitio web?">
...
<Columns cols="2">
  <Card title="1. Mantén conversaciones naturales">
  ...
  <Card title="2. Ofrece siempre una salida humana">
...
<Columns cols="2">
  <Card title="3. Prueba exhaustivamente antes de lanzar">
  ...
  <Card title="4. Analiza y optimiza continuamente">
...
<Columns cols="2">
  <Card title="5. Segmenta tus audiencias">
  ...
  <Card title="6. Cumple con las políticas de WhatsApp">
